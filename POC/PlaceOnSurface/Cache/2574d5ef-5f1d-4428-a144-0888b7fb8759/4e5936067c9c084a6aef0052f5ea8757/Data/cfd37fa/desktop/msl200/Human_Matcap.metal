...
//float4 Tweak_N12Size 4160
//float4 Tweak_N12Dims 4176
//float4 Tweak_N12View 4192
//float3x3 Tweak_N12Transform 4208
//float4 Tweak_N12UvMinMax 4256
//float4 Tweak_N12BorderColor 4272
//float4 Port_Input0_N102 4288
//float Port_Import_N130 4304
//float3 Port_Import_N132 4320
//float4 Port_Import_N091 4336
//float Port_Import_N092 4352
//float4 Port_Input1_N094 4368
//float Port_Import_N095 4384
//float Port_Import_N100 4388
//float3 Port_Normal_N000 4400
//float Port_Exponent_N000 4416
//float Port_Intensity_N000 4420
//float depthRef 4424
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N12 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N12 33
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N12 35
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36
//spec_const bool Tweak_N12HasSwappedViews 37
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 70
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 71
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73
//spec_const int Tweak_N12Layout 74
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 [[function_constant(70)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 [[function_constant(72)]];
...
constant int Tweak_N12Layout [[function_constant(74)]];
...
float param=Value_N133;
float3 param_1=Value_N132;
ssGlobals param_3=Globals;
ssGlobals tempGlobals=param_3;
float2 param_2=float2(0.0);
N134_NormalSpace=int(param);
N134_Normal=param_1;
float3 l9_7=N134_Normal;
...
int l9_16=l9_15;
float3 l9_17=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_16][1].xyz;
...
l9_7=l9_20*l9_7;
N134_ReflectionUV=(l9_7.xy*0.5)+float2(0.5);
param_2=N134_ReflectionUV;
ReflectionUV_N134=param_2;
...
int l9_26=l9_21;
int param_4=Tweak_N12Layout_tmp;
int param_5=l9_26;
float2 param_6=ReflectionUV_N134;
bool param_7=(int(SC_USE_UV_TRANSFORM_Tweak_N12_tmp)!=0);
float3x3 param_8=(*sc_set0.UserUniforms).Tweak_N12Transform;
int2 param_9=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12_tmp);
bool param_10=(int(SC_USE_UV_MIN_MAX_Tweak_N12_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).Tweak_N12UvMinMax;
bool param_12=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12_tmp)!=0);
float4 param_13=(*sc_set0.UserUniforms).Tweak_N12BorderColor;
float param_14=0.0;
bool l9_27=param_12&&(!param_10);
float l9_28=1.0;
float l9_29=param_6.x;
int l9_30=param_9.x;
if (l9_30==1)
{
l9_29=fract(l9_29);
...
float l9_41=param_6.x;
float l9_42=param_11.x;
float l9_43=param_11.z;
bool l9_44=l9_40;
float l9_45=l9_28;
...
float l9_50=param_6.y;
float l9_51=param_11.y;
float l9_52=param_11.w;
bool l9_53=l9_49;
float l9_54=l9_28;
...
float2 l9_57=param_6;
bool l9_58=param_7;
float3x3 l9_59=param_8;
if (l9_58)
{
...
float l9_96=l9_88;
float4 l9_97=sc_set0.Tweak_N12.sample(sc_set0.Tweak_N12SmpSC,l9_95,bias(l9_96));
float4 l9_98=l9_97;
float4 l9_99=l9_98;
if (param_12)
{
l9_99=mix(param_13,l9_99,float4(l9_28));
}
float4 l9_100=l9_99;
Color_N135=l9_100;
...
float Rim_N0=0.0;
float3 param_15=(*sc_set0.UserUniforms).Port_Normal_N000;
float param_16=(*sc_set0.UserUniforms).Port_Exponent_N000;
float param_17=(*sc_set0.UserUniforms).Port_Intensity_N000;
...
float l9_101=abs(dot(-param_19.ViewDirWS,param_15));
float param_18=pow(1.0-l9_101,param_16);
...
bool l9_105=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_105)
{
...
float4 l9_106=fast::max(param_21,float4(0.0));
float4 param_22=l9_106;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_109=fast::clamp(l9_108.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_109=fast::clamp(dot(l9_108.xyz,float3(l9_108.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_109=(1.0-dot(l9_108.xyz,float3(0.33333001)))*l9_108.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_109=(1.0-fast::clamp(dot(l9_108.xyz,float3(1.0)),0.0,1.0))*l9_108.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_109=fast::clamp(dot(l9_108.xyz,float3(1.0)),0.0,1.0)*l9_108.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_109=fast::clamp(dot(l9_108.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_109=dot(l9_108.xyz,float3(0.33333001))*l9_108.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_109=1.0-fast::clamp(dot(l9_108.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_110=l9_109;
float l9_111=l9_110;
float l9_112=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_111;
float3 l9_113=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_107.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_114=float4(l9_113.x,l9_113.y,l9_113.z,l9_112);
param_23=l9_114;
}
else
{
...
{
float4 l9_115=param_23;
float4 l9_116=float4(0.0);
float4 l9_117=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_118=out.FragColor0;
float4 l9_119=l9_118;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_119.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_120=l9_119;
l9_117=l9_120;
}
...
int l9_141=l9_136;
float2 l9_142=l9_135;
int l9_143=l9_141;
float2 l9_144=l9_142;
int l9_145=l9_143;
float l9_146=0.0;
...
float l9_159=l9_151;
float4 l9_160=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_158,bias(l9_159));
float4 l9_161=l9_160;
l9_147=l9_161;
float4 l9_162=l9_147;
float4 l9_163=l9_162;
float4 l9_164=l9_163;
l9_117=l9_164;
}
float4 l9_165=l9_117;
float4 l9_166=l9_165;
float3 l9_167=l9_166.xyz;
float3 l9_168=l9_167;
float3 l9_169=l9_115.xyz;
float3 l9_170=definedBlend(l9_168,l9_169,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_116=float4(l9_170.x,l9_170.y,l9_170.z,l9_116.w);
float3 l9_171=mix(l9_167,l9_116.xyz,float3(l9_115.w));
l9_116=float4(l9_171.x,l9_171.y,l9_171.z,l9_116.w);
l9_116.w=1.0;
float4 l9_172=l9_116;
param_23=l9_172;
}
else
{
float4 l9_173=param_23;
float4 l9_174=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_174=float4(mix(float3(1.0),l9_173.xyz,float3(l9_173.w)),l9_173.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_175=l9_173.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_175=fast::clamp(l9_175,0.0,1.0);
}
l9_174=float4(l9_173.xyz*l9_175,l9_175);
}
else
{
l9_174=l9_173;
...
{
l9_178=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_178=float4(0.0);
...
float4 l9_180=param_26;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_180.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_180;
return out;
}
} // FRAGMENT SHADER
