...
//sampler sampler Tweak_N12SmpSC 0:16
...
//texture texture2D Tweak_N12 0:0:0:16
...
uniform vec4 Tweak_N12Size;
uniform vec4 Tweak_N12View;
uniform mat3 Tweak_N12Transform;
uniform vec4 Tweak_N12UvMinMax;
uniform vec4 Tweak_N12BorderColor;
uniform vec4 Port_Input0_N102;
uniform float Port_Import_N130;
uniform vec3 Port_Import_N132;
...
#endif
#ifndef Tweak_N12HasSwappedViews
#define Tweak_N12HasSwappedViews 0
#elif Tweak_N12HasSwappedViews==1
#undef Tweak_N12HasSwappedViews
#define Tweak_N12HasSwappedViews 1
#endif
#ifndef Tweak_N12Layout
#define Tweak_N12Layout 0
#endif
#ifndef sc_DepthOnly
...
#ifndef SC_USE_UV_TRANSFORM_Tweak_N12
#define SC_USE_UV_TRANSFORM_Tweak_N12 0
#elif SC_USE_UV_TRANSFORM_Tweak_N12==1
#undef SC_USE_UV_TRANSFORM_Tweak_N12
#define SC_USE_UV_TRANSFORM_Tweak_N12 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N12
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N12
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N12
#define SC_USE_UV_MIN_MAX_Tweak_N12 0
#elif SC_USE_UV_MIN_MAX_Tweak_N12==1
#undef SC_USE_UV_MIN_MAX_Tweak_N12
#define SC_USE_UV_MIN_MAX_Tweak_N12 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N12
#define SC_USE_CLAMP_TO_BORDER_Tweak_N12 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N12==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N12
#define SC_USE_CLAMP_TO_BORDER_Tweak_N12 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
mat3 l9_2=mat3(l9_1,cross(l9_0,l9_1)*varTangent.w,l9_0);
vec3 l9_3=-normalize(sc_Camera.position-varPos);
vec3 l9_4=normalize(l9_3);
vec3 l9_5=normalize(cross(l9_4,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_6=cross(l9_5,l9_4);
vec2 l9_7=((mat3(vec3(l9_5.x,l9_6.x,l9_4.x),vec3(l9_5.y,l9_6.y,l9_4.y),vec3(l9_5.z,l9_6.z,l9_4.z))*normalize(l9_2*Port_Import_N132)).xy*0.5)+vec2(0.5);
int l9_8;
#if (Tweak_N12HasSwappedViews)
{
...
#endif
float l9_9=l9_7.x;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12).x);
float l9_10=l9_9;
float l9_11=l9_7.y;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12).y);
float l9_12=l9_11;
vec2 l9_13;
float l9_14;
#if (SC_USE_UV_MIN_MAX_Tweak_N12)
{
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N12)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12).x==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0);
}
#endif
float l9_16=l9_10;
float l9_17=1.0;
sc_ClampUV(l9_16,Tweak_N12UvMinMax.x,Tweak_N12UvMinMax.z,l9_15,l9_17);
float l9_18=l9_16;
float l9_19=l9_17;
bool l9_20;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N12)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12).y==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0);
}
#endif
float l9_21=l9_12;
float l9_22=l9_19;
sc_ClampUV(l9_21,Tweak_N12UvMinMax.y,Tweak_N12UvMinMax.w,l9_20,l9_22);
l9_14=l9_22;
...
#endif
vec2 l9_23=sc_TransformUV(l9_13,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform);
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0)),l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0)),l9_27);
float l9_28=l9_27;
vec3 l9_29=sc_SamplingCoordsViewToGlobal(vec2(l9_24,l9_26),Tweak_N12Layout,l9_8);
vec4 l9_30=texture2D(Tweak_N12,l9_29.xy,0.0);
vec4 l9_31;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N12)
{
l9_31=mix(Tweak_N12BorderColor,l9_30,vec4(l9_28));
}
#else
{
l9_31=l9_30;
...
#endif
vec4 l9_32=vec4(Port_Import_N130)*l9_31;
vec4 l9_33=l9_32*vec4(clamp(Port_Import_N092,0.0,5.0));
vec4 l9_34=mix(Port_Input0_N102,mix(vec4(dot(l9_33,Port_Input1_N094)),l9_33,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))+vec4(max(pow(1.0-abs(dot(l9_3,l9_2*Port_Normal_N000)),Port_Exponent_N000),0.0)*Port_Intensity_N000);
float l9_35=l9_34.w;
...
#endif
vec3 l9_59=mix(l9_57.xyz,definedBlend(l9_57.xyz,l9_34.xyz).xyz,vec3(l9_35));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_61=vec4(mix(vec3(1.0),l9_34.xyz,vec3(l9_35)),l9_35);
}
#else
{
vec4 l9_62;
...
#endif
l9_62=vec4(l9_34.xyz*l9_63,l9_63);
}
#else
{
l9_62=l9_34;
