...
//sampler sampler textSmpSC 0:26
...
//texture texture2D text 0:16:0:26
//SG_REFLECTION_END
...
uniform vec4 textView;
uniform mat3 textTransform;
uniform vec4 textUvMinMax;
uniform vec4 textBorderColor;
uniform vec2 textUVScale;
...
#endif
#ifndef textHasSwappedViews
#define textHasSwappedViews 0
#elif textHasSwappedViews==1
#undef textHasSwappedViews
#define textHasSwappedViews 1
#endif
#ifndef textLayout
#define textLayout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_text
#define SC_USE_UV_TRANSFORM_text 0
#elif SC_USE_UV_TRANSFORM_text==1
#undef SC_USE_UV_TRANSFORM_text
#define SC_USE_UV_TRANSFORM_text 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_text
#define SC_SOFTWARE_WRAP_MODE_U_text -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_text
#define SC_SOFTWARE_WRAP_MODE_V_text -1
#endif
#ifndef SC_USE_UV_MIN_MAX_text
#define SC_USE_UV_MIN_MAX_text 0
#elif SC_USE_UV_MIN_MAX_text==1
#undef SC_USE_UV_MIN_MAX_text
#define SC_USE_UV_MIN_MAX_text 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_text
#define SC_USE_CLAMP_TO_BORDER_text 0
#elif SC_USE_CLAMP_TO_BORDER_text==1
#undef SC_USE_CLAMP_TO_BORDER_text
#define SC_USE_CLAMP_TO_BORDER_text 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
#endif
vec2 l9_25=((l9_0-Port_Center_N009)*textUVScale)+Port_Center_N009;
int l9_26;
#if (textHasSwappedViews)
{
...
#endif
float l9_27=l9_25.x;
sc_SoftwareWrapEarly(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_text,SC_SOFTWARE_WRAP_MODE_V_text).x);
float l9_28=l9_27;
float l9_29=l9_25.y;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_text,SC_SOFTWARE_WRAP_MODE_V_text).y);
float l9_30=l9_29;
vec2 l9_31;
float l9_32;
#if (SC_USE_UV_MIN_MAX_text)
{
bool l9_33;
#if (SC_USE_CLAMP_TO_BORDER_text)
{
l9_33=ivec2(SC_SOFTWARE_WRAP_MODE_U_text,SC_SOFTWARE_WRAP_MODE_V_text).x==3;
}
#else
{
l9_33=(int(SC_USE_CLAMP_TO_BORDER_text)!=0);
}
#endif
float l9_34=l9_28;
float l9_35=1.0;
sc_ClampUV(l9_34,textUvMinMax.x,textUvMinMax.z,l9_33,l9_35);
float l9_36=l9_34;
float l9_37=l9_35;
bool l9_38;
#if (SC_USE_CLAMP_TO_BORDER_text)
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_text,SC_SOFTWARE_WRAP_MODE_V_text).y==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_text)!=0);
}
#endif
float l9_39=l9_30;
float l9_40=l9_37;
sc_ClampUV(l9_39,textUvMinMax.y,textUvMinMax.w,l9_38,l9_40);
l9_32=l9_40;
...
#endif
vec2 l9_41=sc_TransformUV(l9_31,(int(SC_USE_UV_TRANSFORM_text)!=0),textTransform);
float l9_42=l9_41.x;
float l9_43=l9_32;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_text,SC_SOFTWARE_WRAP_MODE_V_text).x,(int(SC_USE_CLAMP_TO_BORDER_text)!=0)&&(!(int(SC_USE_UV_MIN_MAX_text)!=0)),l9_43);
float l9_44=l9_41.y;
float l9_45=l9_43;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_text,SC_SOFTWARE_WRAP_MODE_V_text).y,(int(SC_USE_CLAMP_TO_BORDER_text)!=0)&&(!(int(SC_USE_UV_MIN_MAX_text)!=0)),l9_45);
float l9_46=l9_45;
vec3 l9_47=sc_SamplingCoordsViewToGlobal(vec2(l9_42,l9_44),textLayout,l9_26);
vec4 l9_48=texture2D(text,l9_47.xy,0.0);
vec4 l9_49;
#if (SC_USE_CLAMP_TO_BORDER_text)
{
l9_49=mix(textBorderColor,l9_48,vec4(l9_46));
}
#else
{
l9_49=l9_48;
...
#endif
vec3 l9_50=mix(strokeColor.xyz,l9_49.xyz,vec3(l9_49.w));
float l9_51=(clamp(((l9_24.x*((((hover-Port_RangeMinA_N017)/(Port_RangeMaxA_N017-Port_RangeMinA_N017))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017))+l9_49.w)+0.001,Port_Input1_N013+0.001,Port_Input2_N013+0.001)-0.001)*globalOpacity;
vec4 l9_52=vec4(l9_50.x,l9_50.y,l9_50.z,vec4(0.0).w);
l9_52.w=l9_51;
...
{
l9_56=clamp(dot(l9_52.xyz,vec3(l9_51)),0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_58=(1.0-dot(l9_52.xyz,vec3(0.33333001)))*l9_51;
}
#else
{
float l9_59;
...
{
l9_59=(1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0))*l9_51;
}
#else
{
float l9_60;
...
{
l9_60=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_51;
}
#else
{
float l9_61;
#if (sc_BlendMode_Add)
{
l9_61=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_62;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_62=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_51;
}
#else
{
float l9_63;
...
{
l9_63=dot(l9_52.xyz,vec3(0.33333001))*l9_51;
}
#else
{
float l9_64;
#if (sc_BlendMode_Min)
{
l9_64=1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_Max)
{
l9_65=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_65=1.0;
...
#endif
l9_53=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_52.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_54);
}
#else
{
vec4 l9_66;
...
#endif
vec3 l9_76=mix(l9_74.xyz,definedBlend(l9_74.xyz,l9_52.xyz).xyz,vec3(l9_51));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_78=vec4(mix(vec3(1.0),l9_52.xyz,vec3(l9_51)),l9_51);
}
#else
{
vec4 l9_79;
...
#endif
l9_79=vec4(l9_52.xyz*l9_80,l9_80);
}
#else
{
l9_79=l9_52;
