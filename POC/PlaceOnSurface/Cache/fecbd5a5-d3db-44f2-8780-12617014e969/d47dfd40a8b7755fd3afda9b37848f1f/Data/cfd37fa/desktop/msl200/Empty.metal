...
//float4 Tweak_N0 4160
//float globalOpacity 4176
//float4 baseTexSize 4192
//float4 baseTexDims 4208
//float4 baseTexView 4224
...
float4 param=(*sc_set0.UserUniforms).Tweak_N0;
Output_N0=param;
float Output_N19=0.0;
Output_N19=Output_N0.w;
float Output_N20=0.0;
float param_1=(*sc_set0.UserUniforms).globalOpacity;
Output_N20=param_1;
...
float4 l9_91=fast::max(param_14,float4(0.0));
float4 param_15=l9_91;
if (sc_ShaderCacheConstant_tmp!=0)
{
