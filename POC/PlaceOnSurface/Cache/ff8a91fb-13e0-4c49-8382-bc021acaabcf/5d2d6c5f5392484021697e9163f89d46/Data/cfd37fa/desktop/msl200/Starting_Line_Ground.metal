...
//float Port_RangeMinA_N079 4392
//float Port_RangeMaxA_N079 4396
//float Port_RangeMinB_N079 4400
//float Port_RangeMaxB_N079 4404
//float4 Port_Value0_N080 4416
//float Port_Position1_N080 4432
//float4 Port_Value1_N080 4448
//float Port_Position2_N080 4464
//float4 Port_Value2_N080 4480
//float Port_Position3_N080 4496
//float4 Port_Value3_N080 4512
//float Port_Position4_N080 4528
//float4 Port_Value4_N080 4544
//float4 Port_Value5_N080 4560
//float Port_Input1_N081 4576
//float depthRef 4580
//}
...
float4 param_11=(*sc_set0.UserUniforms).Tweak_N6;
Output_N6=param_11;
...
float Value2_N1=0.0;
float Value3_N1=0.0;
float4 param_12=Output_N7;
float param_13=param_12.x;
float param_14=param_12.y;
float param_15=param_12.z;
Value1_N1=param_13;
Value2_N1=param_14;
Value3_N1=param_15;
float Output_N3=0.0;
float param_16=(*sc_set0.UserUniforms).Tweak_N3;
Output_N3=param_16;
...
float param_17=ValueOut_N79;
float4 param_18=(*sc_set0.UserUniforms).Port_Value0_N080;
float param_19=(*sc_set0.UserUniforms).Port_Position1_N080;
float4 param_20=(*sc_set0.UserUniforms).Port_Value1_N080;
float param_21=(*sc_set0.UserUniforms).Port_Position2_N080;
float4 param_22=(*sc_set0.UserUniforms).Port_Value2_N080;
float param_23=(*sc_set0.UserUniforms).Port_Position3_N080;
float4 param_24=(*sc_set0.UserUniforms).Port_Value3_N080;
float param_25=(*sc_set0.UserUniforms).Port_Position4_N080;
float4 param_26=(*sc_set0.UserUniforms).Port_Value4_N080;
float4 param_27=(*sc_set0.UserUniforms).Port_Value5_N080;
param_17=fast::clamp(param_17,0.0,1.0);
float4 param_28;
if (param_17<param_19)
{
param_28=mix(param_18,param_20,float4(fast::clamp(param_17/param_19,0.0,1.0)));
}
else
{
if (param_17<param_21)
{
param_28=mix(param_20,param_22,float4(fast::clamp((param_17-param_19)/(param_21-param_19),0.0,1.0)));
}
else
{
if (param_17<param_23)
{
param_28=mix(param_22,param_24,float4(fast::clamp((param_17-param_21)/(param_23-param_21),0.0,1.0)));
}
else
{
if (param_17<param_25)
{
param_28=mix(param_24,param_26,float4(fast::clamp((param_17-param_23)/(param_25-param_23),0.0,1.0)));
}
else
{
param_28=mix(param_26,param_27,float4(fast::clamp((param_17-param_25)/(1.0-param_25),0.0,1.0)));
}
}
}
}
bool l9_87=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_88;
if (l9_87)
{
...
if (l9_88)
{
l9_89=80==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_89=l9_88;
...
{
l9_90=pow(Value_N80.x,(*sc_set0.UserUniforms).Port_Input1_N081);
}
float l9_91=l9_90;
float l9_92;
if (Value_N80.y<=0.0)
...
{
l9_92=pow(Value_N80.y,(*sc_set0.UserUniforms).Port_Input1_N081);
}
float l9_93=l9_92;
float l9_94;
if (Value_N80.z<=0.0)
...
{
l9_94=pow(Value_N80.z,(*sc_set0.UserUniforms).Port_Input1_N081);
}
float l9_95=l9_94;
float l9_96;
if (Value_N80.w<=0.0)
...
{
l9_96=pow(Value_N80.w,(*sc_set0.UserUniforms).Port_Input1_N081);
}
Output_N81=float4(l9_91,l9_93,l9_95,l9_96);
float4 Output_N82=float4(0.0);
Output_N82=Value_N2*Output_N81;
FinalColor=Output_N82;
float param_29=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_29<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_101=fast::max(param_30,float4(0.0));
float4 param_31=l9_101;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_31.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=param_31;
return out;
}
float4 param_32=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_102=param_32;
