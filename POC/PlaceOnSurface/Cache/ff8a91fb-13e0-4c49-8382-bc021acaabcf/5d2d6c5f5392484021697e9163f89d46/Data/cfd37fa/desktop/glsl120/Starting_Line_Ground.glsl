...
float l9_26=clamp((((length(sc_Camera.position-varPos)-Port_RangeMinA_N079)/(Port_RangeMaxA_N079-Port_RangeMinA_N079))*(Port_RangeMaxB_N079-Port_RangeMinB_N079))+Port_RangeMinB_N079,0.0,1.0);
vec4 l9_27;
if (l9_26<Port_Position1_N080)
{
l9_27=mix(Port_Value0_N080,Port_Value1_N080,vec4(clamp(l9_26/Port_Position1_N080,0.0,1.0)));
}
else
{
vec4 l9_28;
if (l9_26<Port_Position2_N080)
{
l9_28=mix(Port_Value1_N080,Port_Value2_N080,vec4(clamp((l9_26-Port_Position1_N080)/(Port_Position2_N080-Port_Position1_N080),0.0,1.0)));
}
else
{
vec4 l9_29;
if (l9_26<Port_Position3_N080)
{
l9_29=mix(Port_Value2_N080,Port_Value3_N080,vec4(clamp((l9_26-Port_Position2_N080)/(Port_Position3_N080-Port_Position2_N080),0.0,1.0)));
}
else
{
vec4 l9_30;
if (l9_26<Port_Position4_N080)
{
l9_30=mix(Port_Value3_N080,Port_Value4_N080,vec4(clamp((l9_26-Port_Position3_N080)/(Port_Position4_N080-Port_Position3_N080),0.0,1.0)));
}
else
{
l9_30=mix(Port_Value4_N080,Port_Value5_N080,vec4(clamp((l9_26-Port_Position4_N080)/(1.0-Port_Position4_N080),0.0,1.0)));
}
l9_29=l9_30;
}
l9_28=l9_29;
...
{
l9_35=pow(l9_27.x,Port_Input1_N081);
}
float l9_36;
if (l9_27.y<=0.0)
{
...
{
l9_36=pow(l9_27.y,Port_Input1_N081);
}
float l9_37;
if (l9_27.z<=0.0)
{
...
{
l9_37=pow(l9_27.z,Port_Input1_N081);
}
float l9_38;
if (l9_27.w<=0.0)
{
...
{
l9_38=pow(l9_27.w,Port_Input1_N081);
}
vec4 l9_39=vec4(l9_35,l9_36,l9_37,l9_38);
vec4 l9_40=vec4((mix(Port_Input0_N102,mix(vec4(dot(l9_25,Port_Input1_N094)),l9_25,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*Tweak_N6).xyz,Tweak_N3)*l9_39;
float l9_41=l9_40.w;
...
{
l9_45=clamp(dot(l9_40.xyz,vec3(l9_41)),0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_47=(1.0-dot(l9_40.xyz,vec3(0.33333001)))*l9_41;
}
#else
{
float l9_48;
...
{
l9_48=(1.0-clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0))*l9_41;
}
#else
{
float l9_49;
...
{
l9_49=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0)*l9_41;
}
#else
{
float l9_50;
#if (sc_BlendMode_Add)
{
l9_50=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_51;
...
{
l9_52=dot(l9_40.xyz,vec3(0.33333001))*l9_41;
}
#else
{
float l9_53;
#if (sc_BlendMode_Min)
{
l9_53=1.0-clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_54;
#if (sc_BlendMode_Max)
{
l9_54=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_54=1.0;
...
#endif
l9_42=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_40.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_43);
}
#else
{
vec4 l9_55;
...
#endif
vec3 l9_65=mix(l9_63.xyz,definedBlend(l9_63.xyz,l9_40.xyz).xyz,vec3(l9_41));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_67=vec4(mix(vec3(1.0),l9_40.xyz,vec3(l9_41)),l9_41);
}
#else
{
vec4 l9_68;
...
#endif
l9_68=vec4(l9_40.xyz*l9_69,l9_69);
}
#else
{
l9_68=l9_40;
