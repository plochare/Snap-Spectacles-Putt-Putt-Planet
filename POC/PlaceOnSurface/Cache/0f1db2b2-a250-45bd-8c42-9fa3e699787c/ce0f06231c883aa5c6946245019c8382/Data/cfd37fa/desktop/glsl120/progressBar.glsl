...
//sampler sampler deepMapSmpSC 0:18
...
//texture texture2D deepMap 0:1:0:18
...
uniform vec4 deepMapSize;
uniform vec4 deepMapView;
uniform mat3 deepMapTransform;
uniform vec4 deepMapUvMinMax;
uniform vec4 deepMapBorderColor;
uniform float currentPosition;
uniform float globalOpacity;
uniform vec2 Port_Scale_N008;
uniform vec2 Port_Center_N008;
uniform float Port_RangeMinA_N012;
uniform float Port_RangeMaxA_N012;
uniform float Port_RangeMinB_N012;
uniform float Port_RangeMaxB_N012;
uniform float Port_Value2_N010;
...
#endif
#ifndef deepMapHasSwappedViews
#define deepMapHasSwappedViews 0
#elif deepMapHasSwappedViews==1
#undef deepMapHasSwappedViews
#define deepMapHasSwappedViews 1
#endif
#ifndef deepMapLayout
#define deepMapLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_deepMap
#define SC_USE_UV_TRANSFORM_deepMap 0
#elif SC_USE_UV_TRANSFORM_deepMap==1
#undef SC_USE_UV_TRANSFORM_deepMap
#define SC_USE_UV_TRANSFORM_deepMap 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_deepMap
#define SC_SOFTWARE_WRAP_MODE_U_deepMap -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_deepMap
#define SC_SOFTWARE_WRAP_MODE_V_deepMap -1
#endif
#ifndef SC_USE_UV_MIN_MAX_deepMap
#define SC_USE_UV_MIN_MAX_deepMap 0
#elif SC_USE_UV_MIN_MAX_deepMap==1
#undef SC_USE_UV_MIN_MAX_deepMap
#define SC_USE_UV_MIN_MAX_deepMap 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_deepMap
#define SC_USE_CLAMP_TO_BORDER_deepMap 0
#elif SC_USE_CLAMP_TO_BORDER_deepMap==1
#undef SC_USE_CLAMP_TO_BORDER_deepMap
#define SC_USE_CLAMP_TO_BORDER_deepMap 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
float l9_20=l9_19;
vec3 l9_21=sc_SamplingCoordsViewToGlobal(vec2(l9_16,l9_18),baseTexLayout,l9_0);
...
#endif
vec2 l9_24=(((varPackedTex.xy-Port_Center_N008)*Port_Scale_N008)+Port_Center_N008)+vec2((((currentPosition-Port_RangeMinA_N012)/(Port_RangeMaxA_N012-Port_RangeMinA_N012))*(Port_RangeMaxB_N012-Port_RangeMinB_N012))+Port_RangeMinB_N012,Port_Value2_N010);
int l9_25;
#if (deepMapHasSwappedViews)
{
...
#endif
float l9_26=l9_24.x;
sc_SoftwareWrapEarly(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_deepMap,SC_SOFTWARE_WRAP_MODE_V_deepMap).x);
float l9_27=l9_26;
float l9_28=l9_24.y;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_deepMap,SC_SOFTWARE_WRAP_MODE_V_deepMap).y);
float l9_29=l9_28;
vec2 l9_30;
float l9_31;
#if (SC_USE_UV_MIN_MAX_deepMap)
{
bool l9_32;
#if (SC_USE_CLAMP_TO_BORDER_deepMap)
{
l9_32=ivec2(SC_SOFTWARE_WRAP_MODE_U_deepMap,SC_SOFTWARE_WRAP_MODE_V_deepMap).x==3;
}
#else
{
l9_32=(int(SC_USE_CLAMP_TO_BORDER_deepMap)!=0);
}
#endif
float l9_33=l9_27;
float l9_34=1.0;
sc_ClampUV(l9_33,deepMapUvMinMax.x,deepMapUvMinMax.z,l9_32,l9_34);
float l9_35=l9_33;
float l9_36=l9_34;
bool l9_37;
#if (SC_USE_CLAMP_TO_BORDER_deepMap)
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_deepMap,SC_SOFTWARE_WRAP_MODE_V_deepMap).y==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_deepMap)!=0);
}
#endif
float l9_38=l9_29;
float l9_39=l9_36;
sc_ClampUV(l9_38,deepMapUvMinMax.y,deepMapUvMinMax.w,l9_37,l9_39);
l9_31=l9_39;
...
#endif
vec2 l9_40=sc_TransformUV(l9_30,(int(SC_USE_UV_TRANSFORM_deepMap)!=0),deepMapTransform);
float l9_41=l9_40.x;
float l9_42=l9_31;
sc_SoftwareWrapLate(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_deepMap,SC_SOFTWARE_WRAP_MODE_V_deepMap).x,(int(SC_USE_CLAMP_TO_BORDER_deepMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_deepMap)!=0)),l9_42);
float l9_43=l9_40.y;
float l9_44=l9_42;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_deepMap,SC_SOFTWARE_WRAP_MODE_V_deepMap).y,(int(SC_USE_CLAMP_TO_BORDER_deepMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_deepMap)!=0)),l9_44);
float l9_45=l9_44;
vec3 l9_46=sc_SamplingCoordsViewToGlobal(vec2(l9_41,l9_43),deepMapLayout,l9_25);
vec4 l9_47=texture2D(deepMap,l9_46.xy,0.0);
vec4 l9_48;
#if (SC_USE_CLAMP_TO_BORDER_deepMap)
{
l9_48=mix(deepMapBorderColor,l9_47,vec4(l9_45));
}
#else
{
l9_48=l9_47;
...
#endif
float l9_49=(l9_23.y-l9_48.x)*globalOpacity;
vec4 l9_50=vec4(barColor.x,barColor.y,barColor.z,vec4(0.0).w);
l9_50.w=l9_49;
...
#endif
l9_66=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_70,sc_ScreenTextureLayout,l9_71).xy,0.0);
}
#endif
vec4 l9_72;
...
{
vec4 l9_73=l9_66;
l9_73.x=l9_66.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_72=l9_73;
}
#else
{
...
#endif
vec3 l9_74=mix(l9_72.xyz,definedBlend(l9_72.xyz,l9_50.xyz).xyz,vec3(l9_49));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_76=vec4(mix(vec3(1.0),l9_50.xyz,vec3(l9_49)),l9_49);
}
#else
{
vec4 l9_77;
...
#endif
l9_77=vec4(l9_50.xyz*l9_78,l9_78);
}
#else
{
l9_77=l9_50;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_86).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_87=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_86).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_99).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_104==0)
{
l9_107=texture2D(sc_OITAlpha0,l9_99);
l9_106=texture2D(sc_OITDepthLow0,l9_99);
l9_105=texture2D(sc_OITDepthHigh0,l9_99);
}
else
{
l9_107=vec4(0.0);
...
if (l9_104==1)
{
l9_110=texture2D(sc_OITAlpha1,l9_99);
l9_109=texture2D(sc_OITDepthLow1,l9_99);
l9_108=texture2D(sc_OITDepthHigh1,l9_99);
}
else
{
l9_110=l9_107;
...
vec4 l9_125=texture2D(sc_OITFilteredDepthBoundsTexture,l9_99);
