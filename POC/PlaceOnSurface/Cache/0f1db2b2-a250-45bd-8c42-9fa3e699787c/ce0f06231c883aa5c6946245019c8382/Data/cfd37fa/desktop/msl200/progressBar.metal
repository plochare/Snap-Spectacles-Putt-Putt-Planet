...
//float4 deepMapSize 4304
//float4 deepMapDims 4320
//float4 deepMapView 4336
//float3x3 deepMapTransform 4352
//float4 deepMapUvMinMax 4400
//float4 deepMapBorderColor 4416
//float currentPosition 4432
//float globalOpacity 4436
//float2 Port_Scale_N008 4440
//float2 Port_Center_N008 4448
//float Port_RangeMinA_N012 4456
//float Port_RangeMaxA_N012 4460
//float Port_RangeMinB_N012 4464
//float Port_RangeMaxB_N012 4468
//float Port_Value2_N010 4472
//float depthRef 4476
//}
...
//spec_const bool deepMapHasSwappedViews 42
...
constant int SC_SOFTWARE_WRAP_MODE_U_deepMap [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_deepMap [[function_constant(78)]];
...
constant int deepMapLayout [[function_constant(81)]];
...
float4 param=(*sc_set0.UserUniforms).barColor;
Output_N1=param;
...
float param_12=(*sc_set0.UserUniforms).currentPosition;
Output_N11=param_12;
float ValueOut_N12=0.0;
ValueOut_N12=(((Output_N11-(*sc_set0.UserUniforms).Port_RangeMinA_N012)/((*sc_set0.UserUniforms).Port_RangeMaxA_N012-(*sc_set0.UserUniforms).Port_RangeMinA_N012))*((*sc_set0.UserUniforms).Port_RangeMaxB_N012-(*sc_set0.UserUniforms).Port_RangeMinB_N012))+(*sc_set0.UserUniforms).Port_RangeMinB_N012;
...
int l9_92=l9_87;
int param_13=deepMapLayout_tmp;
int param_14=l9_92;
float2 param_15=CoordsOut_N9;
bool param_16=(int(SC_USE_UV_TRANSFORM_deepMap_tmp)!=0);
float3x3 param_17=(*sc_set0.UserUniforms).deepMapTransform;
int2 param_18=int2(SC_SOFTWARE_WRAP_MODE_U_deepMap_tmp,SC_SOFTWARE_WRAP_MODE_V_deepMap_tmp);
bool param_19=(int(SC_USE_UV_MIN_MAX_deepMap_tmp)!=0);
float4 param_20=(*sc_set0.UserUniforms).deepMapUvMinMax;
bool param_21=(int(SC_USE_CLAMP_TO_BORDER_deepMap_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).deepMapBorderColor;
float param_23=0.0;
bool l9_93=param_21&&(!param_19);
float l9_94=1.0;
float l9_95=param_15.x;
int l9_96=param_18.x;
if (l9_96==1)
{
l9_95=fract(l9_95);
}
...
param_15.x=l9_95;
float l9_100=param_15.y;
int l9_101=param_18.y;
if (l9_101==1)
{
l9_100=fract(l9_100);
}
...
float l9_107=param_15.x;
float l9_108=param_20.x;
float l9_109=param_20.z;
bool l9_110=l9_106;
float l9_111=l9_94;
...
float l9_116=param_15.y;
float l9_117=param_20.y;
float l9_118=param_20.w;
bool l9_119=l9_115;
float l9_120=l9_94;
...
float2 l9_123=param_15;
bool l9_124=param_16;
float3x3 l9_125=param_17;
if (l9_124)
{
...
param_15=l9_128;
float l9_129=param_15.x;
int l9_130=param_18.x;
bool l9_131=l9_93;
float l9_132=l9_94;
...
param_15.x=l9_129;
l9_94=l9_132;
float l9_140=param_15.y;
int l9_141=param_18.y;
bool l9_142=l9_93;
float l9_143=l9_94;
...
param_15.y=l9_140;
l9_94=l9_143;
float2 l9_151=param_15;
int l9_152=param_13;
int l9_153=param_14;
float l9_154=param_23;
...
float l9_162=l9_154;
float4 l9_163=sc_set0.deepMap.sample(sc_set0.deepMapSmpSC,l9_161,bias(l9_162));
float4 l9_164=l9_163;
float4 l9_165=l9_164;
if (param_21)
{
l9_165=mix(param_22,l9_165,float4(l9_94));
}
...
float param_24=(*sc_set0.UserUniforms).globalOpacity;
Output_N20=param_24;
...
float3 param_29=in.varPos;
float4 param_30=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_29,param_30,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_31=FinalColor;
float4 l9_245=param_31;
if (sc_ShaderCacheConstant_tmp!=0)
{
