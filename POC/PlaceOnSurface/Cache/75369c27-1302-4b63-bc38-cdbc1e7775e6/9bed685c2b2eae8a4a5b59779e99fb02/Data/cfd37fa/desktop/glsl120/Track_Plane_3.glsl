...
{
if (l9_23.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_28=clamp(l9_23.x*2.0,0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_25.xyz,vec3(l9_23.x)),0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_31=(1.0-dot(l9_25.xyz,vec3(0.33333001)))*l9_23.x;
}
#else
{
float l9_32;
...
{
l9_32=(1.0-clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0))*l9_23.x;
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*l9_23.x;
}
#else
{
float l9_34;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_35=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*l9_23.x;
}
#else
{
float l9_36;
...
{
l9_36=dot(l9_25.xyz,vec3(0.33333001))*l9_23.x;
}
#else
{
float l9_37;
...
#endif
vec3 l9_49=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_25.xyz).xyz,vec3(l9_23.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_25.xyz,vec3(l9_23.x)),l9_23.x);
}
#else
{
vec4 l9_52;
