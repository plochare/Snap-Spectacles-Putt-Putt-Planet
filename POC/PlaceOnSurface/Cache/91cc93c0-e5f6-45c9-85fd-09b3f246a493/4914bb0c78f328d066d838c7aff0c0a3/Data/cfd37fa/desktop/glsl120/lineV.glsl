...
//sampler sampler Tweak_N8SmpSC 0:16
...
//texture texture2D Tweak_N8 0:0:0:16
...
#endif
float l9_0=float(varPackedTex.x<Port_Input1_N006);
vec4 l9_1=mix(Tweak_N18,Tweak_N18,vec4(l9_0));
float l9_2=length(vec3(sc_ModelMatrix[0].xyz));
float l9_3=length(vec3(sc_ModelMatrix[1].xyz));
vec4 l9_4;
if ((float(l9_2<l9_3)*1.0)!=0.0)
{
l9_4=vec4(l9_2);
}
else
...
vec4 l9_5=l9_4+vec4(1.234e-06);
vec2 l9_6=vec2((vec4(l9_2*Tweak_N182)/l9_5).x,(vec4(Tweak_N182*l9_3)/l9_5).x);
vec2 l9_7=vec2((((Tweak_N11-Port_RangeMinA_N013)/(Port_RangeMaxA_N013-Port_RangeMinA_N013))*(Port_RangeMaxB_N013-Port_RangeMinB_N013))+Port_RangeMinB_N013,Port_Value2_N010);
vec2 l9_8=((((((varPackedTex.xy-Port_Center_N012)*Port_Scale_N012)+Port_Center_N012)-Port_Center_N014)*l9_6)+Port_Center_N014)+l9_7;
float l9_9=l9_8.x;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).x);
float l9_10=l9_9;
float l9_11=l9_8.y;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).y);
float l9_12=l9_11;
vec2 l9_13;
float l9_14;
...
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).x==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0);
}
#endif
float l9_16=l9_10;
float l9_17=1.0;
sc_ClampUV(l9_16,Tweak_N8UvMinMax.x,Tweak_N8UvMinMax.z,l9_15,l9_17);
float l9_18=l9_16;
float l9_19=l9_17;
bool l9_20;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N8)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).y==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0);
}
#endif
float l9_21=l9_12;
float l9_22=l9_19;
sc_ClampUV(l9_21,Tweak_N8UvMinMax.y,Tweak_N8UvMinMax.w,l9_20,l9_22);
l9_14=l9_22;
...
#endif
vec2 l9_23=sc_TransformUV(l9_13,(int(SC_USE_UV_TRANSFORM_Tweak_N8)!=0),Tweak_N8Transform);
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N8)!=0)),l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N8)!=0)),l9_27);
float l9_28=l9_27;
vec3 l9_29=sc_SamplingCoordsViewToGlobal(vec2(l9_24,l9_26),Tweak_N8Layout,Tweak_N8GetStereoViewIndex());
vec4 l9_30=texture2D(Tweak_N8,l9_29.xy,0.0);
vec4 l9_31;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N8)
{
l9_31=mix(Tweak_N8BorderColor,l9_30,vec4(l9_28));
}
#else
{
l9_31=l9_30;
...
#endif
vec2 l9_32=(((varPackedTex.xy-Port_Center_N157)*l9_6)+Port_Center_N157)+l9_7;
float l9_33=l9_32.x;
sc_SoftwareWrapEarly(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).x);
float l9_34=l9_33;
float l9_35=l9_32.y;
sc_SoftwareWrapEarly(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).y);
float l9_36=l9_35;
vec2 l9_37;
float l9_38;
#if (SC_USE_UV_MIN_MAX_Tweak_N8)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N8)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).x==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0);
}
#endif
float l9_40=l9_34;
float l9_41=1.0;
sc_ClampUV(l9_40,Tweak_N8UvMinMax.x,Tweak_N8UvMinMax.z,l9_39,l9_41);
float l9_42=l9_40;
float l9_43=l9_41;
bool l9_44;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N8)
{
l9_44=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).y==3;
}
#else
{
l9_44=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0);
}
#endif
float l9_45=l9_36;
float l9_46=l9_43;
sc_ClampUV(l9_45,Tweak_N8UvMinMax.y,Tweak_N8UvMinMax.w,l9_44,l9_46);
l9_38=l9_46;
...
#endif
vec2 l9_47=sc_TransformUV(l9_37,(int(SC_USE_UV_TRANSFORM_Tweak_N8)!=0),Tweak_N8Transform);
float l9_48=l9_47.x;
float l9_49=l9_38;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N8)!=0)),l9_49);
float l9_50=l9_47.y;
float l9_51=l9_49;
sc_SoftwareWrapLate(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N8)!=0)),l9_51);
float l9_52=l9_51;
vec3 l9_53=sc_SamplingCoordsViewToGlobal(vec2(l9_48,l9_50),Tweak_N8Layout,Tweak_N8GetStereoViewIndex());
vec4 l9_54=texture2D(Tweak_N8,l9_53.xy,0.0);
vec4 l9_55;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N8)
{
l9_55=mix(Tweak_N8BorderColor,l9_54,vec4(l9_52));
}
#else
{
l9_55=l9_54;
...
#endif
vec4 l9_56=min(l9_31,l9_55);
vec4 l9_57=mix(Port_Input0_N020,vec4((l9_0*Port_Input1_N027)+Tweak_N18.w),l9_56);
if ((float(l9_57.x<Port_Input1_N024)*1.0)!=0.0)
{
discard;
}
vec4 l9_58=l9_57*vec4(Tweak_N21);
float l9_59=l9_58.x;
vec4 l9_60=vec4(l9_1.x,l9_1.y,l9_1.z,vec4(0.0).w);
l9_60.w=l9_59;
...
#endif
l9_76=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_80,sc_ScreenTextureLayout,l9_81).xy,0.0);
}
#endif
vec4 l9_82;
