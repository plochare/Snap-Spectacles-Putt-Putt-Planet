...
//}
//ubo int UserUniforms 0:33:4416 {
...
//float4 Tweak_N18 4160
//float4 Tweak_N8Size 4176
//float4 Tweak_N8Dims 4192
//float4 Tweak_N8View 4208
//float3x3 Tweak_N8Transform 4224
//float4 Tweak_N8UvMinMax 4272
//float4 Tweak_N8BorderColor 4288
//float Tweak_N182 4304
//float Tweak_N11 4308
//float Tweak_N21 4312
//float Port_Input1_N006 4316
//float4 Port_Input0_N020 4320
//float Port_Input1_N027 4336
//float2 Port_Scale_N012 4344
//float2 Port_Center_N012 4352
//float Port_Import_N189 4360
//float2 Port_Center_N014 4368
//float Port_RangeMinA_N013 4376
//float Port_RangeMaxA_N013 4380
//float Port_RangeMinB_N013 4384
//float Port_RangeMaxB_N013 4388
//float Port_Value2_N010 4392
//float2 Port_Center_N157 4400
//float Port_Input1_N024 4408
//float depthRef 4412
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N8 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N8 33
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N8 35
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36
//spec_const bool Tweak_N8HasSwappedViews 37
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N8 70
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 71
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N8 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73
//spec_const int Tweak_N8Layout 74
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N8 [[function_constant(70)]];
...
constant int Tweak_N8Layout [[function_constant(74)]];
...
float4 param=(*sc_set0.UserUniforms).Tweak_N18;
Output_N18=param;
...
float4x4 param_1=Matrix_N184;
float4 param_2=param_1[0];
float4 param_3=param_1[1];
Vector0_N185=param_2;
Vector1_N185=param_3;
...
float param_4=(*sc_set0.UserUniforms).Tweak_N182;
Output_N182=param_4;
...
float4x4 l9_7=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
l9_7=(*sc_set0.UserUniforms).sc_ModelMatrix;
float4 l9_8=float4(0.0);
float4 l9_9=float4(0.0);
float4x4 l9_10=l9_7;
float4 l9_11=l9_10[0];
float4 l9_12=l9_10[1];
l9_8=l9_11;
l9_9=l9_12;
float3 l9_13=float3(0.0);
l9_13=float3(l9_8.x,l9_8.y,l9_8.z);
float l9_14=0.0;
l9_14=length(l9_13);
float3 l9_15=float3(0.0);
l9_15=float3(l9_9.x,l9_9.y,l9_9.z);
float l9_16=0.0;
l9_16=length(l9_15);
float l9_17=0.0;
l9_17=float(l9_14<l9_16);
param_5=l9_17;
float4 param_8;
if ((param_5*1.0)!=0.0)
{
...
float4 l9_21=l9_20[0];
l9_19=l9_21;
float3 l9_22=float3(0.0);
l9_22=float3(l9_19.x,l9_19.y,l9_19.z);
float l9_23=0.0;
l9_23=length(l9_22);
param_6=float4(l9_23);
param_8=param_6;
}
else
{
float4x4 l9_24=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
l9_24=(*sc_set0.UserUniforms).sc_ModelMatrix;
float4 l9_25=float4(0.0);
float4x4 l9_26=l9_24;
float4 l9_27=l9_26[1];
l9_25=l9_27;
float3 l9_28=float3(0.0);
l9_28=float3(l9_25.x,l9_25.y,l9_25.z);
float l9_29=0.0;
l9_29=length(l9_28);
param_7=float4(l9_29);
param_8=param_7;
}
Result_N194=param_8;
...
float param_9=(*sc_set0.UserUniforms).Tweak_N11;
Output_N11=param_9;
float ValueOut_N13=0.0;
ValueOut_N13=(((Output_N11-(*sc_set0.UserUniforms).Port_RangeMinA_N013)/((*sc_set0.UserUniforms).Port_RangeMaxA_N013-(*sc_set0.UserUniforms).Port_RangeMinA_N013))*((*sc_set0.UserUniforms).Port_RangeMaxB_N013-(*sc_set0.UserUniforms).Port_RangeMinB_N013))+(*sc_set0.UserUniforms).Port_RangeMinB_N013;
...
int l9_35=l9_30;
int param_10=Tweak_N8Layout_tmp;
int param_11=l9_35;
float2 param_12=CoordsOut_N2;
bool param_13=(int(SC_USE_UV_TRANSFORM_Tweak_N8_tmp)!=0);
float3x3 param_14=(*sc_set0.UserUniforms).Tweak_N8Transform;
int2 param_15=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8_tmp);
bool param_16=(int(SC_USE_UV_MIN_MAX_Tweak_N8_tmp)!=0);
float4 param_17=(*sc_set0.UserUniforms).Tweak_N8UvMinMax;
bool param_18=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8_tmp)!=0);
float4 param_19=(*sc_set0.UserUniforms).Tweak_N8BorderColor;
float param_20=0.0;
bool l9_36=param_18&&(!param_16);
float l9_37=1.0;
float l9_38=param_12.x;
int l9_39=param_15.x;
if (l9_39==1)
{
l9_38=fract(l9_38);
}
...
param_12.x=l9_38;
float l9_43=param_12.y;
int l9_44=param_15.y;
if (l9_44==1)
{
l9_43=fract(l9_43);
}
...
float l9_50=param_12.x;
float l9_51=param_17.x;
float l9_52=param_17.z;
bool l9_53=l9_49;
float l9_54=l9_37;
...
float l9_59=param_12.y;
float l9_60=param_17.y;
float l9_61=param_17.w;
bool l9_62=l9_58;
float l9_63=l9_37;
...
float2 l9_66=param_12;
bool l9_67=param_13;
float3x3 l9_68=param_14;
if (l9_67)
{
...
float2 l9_71=l9_70;
param_12=l9_71;
float l9_72=param_12.x;
int l9_73=param_15.x;
bool l9_74=l9_36;
float l9_75=l9_37;
if ((l9_73==0)||(l9_73==3))
{
...
param_12.x=l9_72;
l9_37=l9_75;
float l9_83=param_12.y;
int l9_84=param_15.y;
bool l9_85=l9_36;
float l9_86=l9_37;
if ((l9_84==0)||(l9_84==3))
{
...
param_12.y=l9_83;
l9_37=l9_86;
float2 l9_94=param_12;
int l9_95=param_10;
int l9_96=param_11;
float l9_97=param_20;
float2 l9_98=l9_94;
int l9_99=l9_95;
int l9_100=l9_96;
...
float l9_105=l9_97;
float4 l9_106=sc_set0.Tweak_N8.sample(sc_set0.Tweak_N8SmpSC,l9_104,bias(l9_105));
float4 l9_107=l9_106;
float4 l9_108=l9_107;
if (param_18)
{
l9_108=mix(param_19,l9_108,float4(l9_37));
}
...
int l9_115=l9_110;
int param_21=Tweak_N8Layout_tmp;
int param_22=l9_115;
float2 param_23=CoordsOut_N1;
bool param_24=(int(SC_USE_UV_TRANSFORM_Tweak_N8_tmp)!=0);
float3x3 param_25=(*sc_set0.UserUniforms).Tweak_N8Transform;
int2 param_26=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8_tmp);
bool param_27=(int(SC_USE_UV_MIN_MAX_Tweak_N8_tmp)!=0);
float4 param_28=(*sc_set0.UserUniforms).Tweak_N8UvMinMax;
bool param_29=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8_tmp)!=0);
float4 param_30=(*sc_set0.UserUniforms).Tweak_N8BorderColor;
float param_31=0.0;
bool l9_116=param_29&&(!param_27);
float l9_117=1.0;
float l9_118=param_23.x;
int l9_119=param_26.x;
if (l9_119==1)
{
l9_118=fract(l9_118);
}
...
param_23.x=l9_118;
float l9_123=param_23.y;
int l9_124=param_26.y;
if (l9_124==1)
{
l9_123=fract(l9_123);
}
...
float l9_130=param_23.x;
float l9_131=param_28.x;
float l9_132=param_28.z;
bool l9_133=l9_129;
float l9_134=l9_117;
...
float l9_139=param_23.y;
float l9_140=param_28.y;
float l9_141=param_28.w;
bool l9_142=l9_138;
float l9_143=l9_117;
...
float2 l9_146=param_23;
bool l9_147=param_24;
float3x3 l9_148=param_25;
if (l9_147)
{
...
param_23=l9_151;
float l9_152=param_23.x;
int l9_153=param_26.x;
bool l9_154=l9_116;
float l9_155=l9_117;
...
param_23.x=l9_152;
l9_117=l9_155;
float l9_163=param_23.y;
int l9_164=param_26.y;
bool l9_165=l9_116;
float l9_166=l9_117;
...
param_23.y=l9_163;
l9_117=l9_166;
float2 l9_174=param_23;
int l9_175=param_21;
int l9_176=param_22;
float l9_177=param_31;
...
float l9_185=l9_177;
float4 l9_186=sc_set0.Tweak_N8.sample(sc_set0.Tweak_N8SmpSC,l9_184,bias(l9_185));
float4 l9_187=l9_186;
float4 l9_188=l9_187;
if (param_29)
{
l9_188=mix(param_30,l9_188,float4(l9_117));
}
...
float4 param_32=Output_N20;
float param_33=Output_N24;
float4 param_34=param_32;
if ((param_33*1.0)!=0.0)
{
discard_fragment();
}
...
float param_35=(*sc_set0.UserUniforms).Tweak_N21;
Output_N21=param_35;
...
FinalColor=Value_N3;
float param_36=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_36<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float3 param_40=in.varPos;
float4 param_41=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_40,param_41,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_42=FinalColor;
float4 l9_268=param_42;
if (sc_ShaderCacheConstant_tmp!=0)
{
