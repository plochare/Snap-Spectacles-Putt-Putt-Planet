...
vec4 l9_40=(mix(Port_Input0_N102,mix(vec4(dot(l9_25,Port_Input1_N094)),l9_25,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*Tweak_N6)*l9_39;
float l9_41=l9_40.w;
