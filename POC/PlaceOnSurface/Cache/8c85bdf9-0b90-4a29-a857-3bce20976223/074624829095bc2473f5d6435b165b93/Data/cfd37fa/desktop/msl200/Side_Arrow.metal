...
//float4 Port_Import_N091 4320
//float Port_Import_N092 4336
//float4 Port_Input1_N094 4352
//float Port_Import_N095 4368
//float Port_Import_N100 4372
//float Port_RangeMinA_N079 4376
//float Port_RangeMaxA_N079 4380
//float Port_RangeMinB_N079 4384
//float Port_RangeMaxB_N079 4388
//float4 Port_Value0_N080 4400
//float Port_Position1_N080 4416
//float4 Port_Value1_N080 4432
//float Port_Position2_N080 4448
//float4 Port_Value2_N080 4464
//float Port_Position3_N080 4480
//float4 Port_Value3_N080 4496
//float Port_Position4_N080 4512
//float4 Port_Value4_N080 4528
//float4 Port_Value5_N080 4544
//float Port_Input1_N081 4560
//float depthRef 4564
//}
...
float param_12=ValueOut_N79;
float4 param_13=(*sc_set0.UserUniforms).Port_Value0_N080;
float param_14=(*sc_set0.UserUniforms).Port_Position1_N080;
float4 param_15=(*sc_set0.UserUniforms).Port_Value1_N080;
float param_16=(*sc_set0.UserUniforms).Port_Position2_N080;
float4 param_17=(*sc_set0.UserUniforms).Port_Value2_N080;
float param_18=(*sc_set0.UserUniforms).Port_Position3_N080;
float4 param_19=(*sc_set0.UserUniforms).Port_Value3_N080;
float param_20=(*sc_set0.UserUniforms).Port_Position4_N080;
float4 param_21=(*sc_set0.UserUniforms).Port_Value4_N080;
float4 param_22=(*sc_set0.UserUniforms).Port_Value5_N080;
param_12=fast::clamp(param_12,0.0,1.0);
float4 param_23;
if (param_12<param_14)
{
param_23=mix(param_13,param_15,float4(fast::clamp(param_12/param_14,0.0,1.0)));
}
else
{
if (param_12<param_16)
{
param_23=mix(param_15,param_17,float4(fast::clamp((param_12-param_14)/(param_16-param_14),0.0,1.0)));
}
else
{
if (param_12<param_18)
{
param_23=mix(param_17,param_19,float4(fast::clamp((param_12-param_16)/(param_18-param_16),0.0,1.0)));
}
else
{
if (param_12<param_20)
{
param_23=mix(param_19,param_21,float4(fast::clamp((param_12-param_18)/(param_20-param_18),0.0,1.0)));
}
else
{
param_23=mix(param_21,param_22,float4(fast::clamp((param_12-param_20)/(1.0-param_20),0.0,1.0)));
}
}
}
}
...
float4 l9_101=fast::max(param_25,float4(0.0));
float4 param_26=l9_101;
if (sc_ShaderCacheConstant_tmp!=0)
{
