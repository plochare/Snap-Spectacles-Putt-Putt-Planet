import { PlaceSurfaceDetector } from './PlaceSurfaceDetector';
...
export class LensInitializer extends BaseScriptComponent {
    ...
    @input
    placeSurfaceDetector: placeSurfaceDetector
    ...
    onAwake() {
        ...
        this.placeSurfaceDetector.init();
        
        this.tutorialController.startTutorial(() => {
            this.placeSurfaceDetector.start();
        })
