...
//sampler sampler Tweak_N0SmpSC 0:16
...
//texture texture2D Tweak_N0 0:0:0:16
...
uniform float Tweak_N68;
uniform int overrideTimeEnabled;
uniform float overrideTimeElapsed;
uniform vec4 sc_Time;
uniform float overrideTimeDelta;
uniform mat4 sc_ModelMatrixInverse;
uniform float Port_Value_N064;
uniform float Port_RangeMinA_N074;
uniform float Port_RangeMaxA_N074;
uniform float Port_RangeMinB_N074;
uniform float Port_RangeMaxB_N074;
uniform float Port_Input1_N069;
uniform float Port_Input1_N009;
uniform float Port_Input1_N016;
uniform vec3 Port_Input0_N066;
...
uniform float Port_Input0_N029;
uniform float Port_Input1_N028;
uniform float Port_Multiplier_N044;
...
uniform vec2 Port_Center_N053;
uniform float Port_Feather_N078;
uniform float Port_Input0_N023;
uniform float Port_Import_N089;
uniform float Port_Import_N093;
uniform float Port_Input0_N024;
uniform float Port_Input1_N026;
uniform vec4 Port_Input0_N082;
uniform float Port_Multiplier_N027;
uniform float Port_Input1_N113;
uniform float Port_Input1_N080;
uniform float Port_Input1_N081;
uniform float Port_Import_N095;
uniform float Port_Import_N102;
uniform float Port_Import_N103;
uniform vec4 Port_Input1_N099;
...
uniform float Port_Input3_N114;
uniform vec4 Port_Input1_N059;
uniform vec4 Port_Input2_N059;
...
varying vec2 Interpolator_UVCoord2;
...
float l9_31=(((Tweak_N68-Port_RangeMinA_N074)/(Port_RangeMaxA_N074-Port_RangeMinA_N074))*(Port_RangeMaxB_N074-Port_RangeMinB_N074))+Port_RangeMinB_N074;
float l9_32;
if (Port_RangeMaxB_N074>Port_RangeMinB_N074)
{
l9_32=clamp(l9_31,Port_RangeMinB_N074,Port_RangeMaxB_N074);
}
else
{
l9_32=clamp(l9_31,Port_RangeMaxB_N074,Port_RangeMinB_N074);
}
float l9_33=mix((Port_Value_N064+0.001)-0.001,Port_Input1_N069,l9_32);
vec3 l9_34;
vec3 l9_35;
vec3 l9_36;
if (l9_27)
...
l9_36=varTangent.xyz;
l9_35=l9_30;
l9_34=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz-mix(Port_Input0_N066,vec3(0.0,0.0,l9_33),vec3(float(floor((l9_2.y*Port_Input1_N009)+0.5)>Port_Input1_N016))))+sc_ModelMatrix[3].xyz;
}
varPos=l9_34;
...
{
vec4 l9_51=l9_47;
l9_51.x=l9_47.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_50=l9_51;
}
#else
{
...
#endif
gl_Position=l9_50;
Interpolator_UVCoord2=texture2;
}
...
#endif
#ifndef N78_Reevers
#define N78_Reevers 0
#elif N78_Reevers==1
#undef N78_Reevers
#define N78_Reevers 1
#endif
#ifndef N78_Out
#define N78_Out 0
#elif N78_Out==1
...
float l9_1=clamp(Port_Import_N086,0.0,1.0);
float l9_2=(Port_Input0_N029-varPackedTex.w)-Port_Input1_N028;
float l9_3=l9_0*Port_Multiplier_N044;
float l9_4=float(Tweak_N68==Port_Input1_N072);
float l9_5=mix(Tweak_N68,mod(l9_3*Port_Input1_N046,Port_Input1_N047),l9_4);
float l9_6=clamp(Port_Import_N032,0.0,1.0);
float l9_7=clamp((smoothstep(l9_1,l9_1+clamp(Port_Import_N087,0.0,1.0),l9_2+l9_5)*(1.0-smoothstep(l9_6,l9_6+clamp(Port_Import_N033,0.0,1.0),l9_2+(l9_5-Port_Input1_N040))))+0.001,Port_Input1_N045+0.001,Port_Input2_N045+0.001)-0.001;
float l9_8=float(floor((varPackedTex.w*Port_Input1_N009)+0.5)>Port_Input1_N016);
vec2 l9_9=vec2(l9_8);
vec2 l9_10=varPackedTex.xy+mix(vec2(0.0,mix(Port_Input0_N050,Port_Input1_N050,l9_7)),Port_Input1_N051,l9_9);
vec2 l9_11=mix(((l9_10-Port_Center_N060)*vec2(mix(Port_Input0_N079,Port_Input1_N079,l9_7)))+Port_Center_N060,((l9_10-Port_Center_N053)*vec2(mix(Port_Input0_N056,Port_Input1_N056,l9_7*Port_Input1_N117)))+Port_Center_N053,l9_9);
int l9_12;
...
#endif
float l9_13=l9_11.x;
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_14=l9_13;
float l9_15=l9_11.y;
sc_SoftwareWrapEarly(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_16=l9_15;
vec2 l9_17;
float l9_18;
...
{
l9_19=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_19=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_20=l9_14;
float l9_21=1.0;
sc_ClampUV(l9_20,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_19,l9_21);
float l9_22=l9_20;
float l9_23=l9_21;
bool l9_24;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_24=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_25=l9_16;
float l9_26=l9_23;
sc_ClampUV(l9_25,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_24,l9_26);
l9_18=l9_26;
...
#endif
vec2 l9_27=sc_TransformUV(l9_17,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_28=l9_27.x;
float l9_29=l9_18;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_29);
float l9_30=l9_27.y;
float l9_31=l9_29;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_31);
float l9_32=l9_31;
vec3 l9_33=sc_SamplingCoordsViewToGlobal(vec2(l9_28,l9_30),Tweak_N0Layout,l9_12);
vec4 l9_34=texture2D(Tweak_N0,l9_33.xy,0.0);
vec4 l9_35;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_35=mix(Tweak_N0BorderColor,l9_34,vec4(l9_32));
}
#else
{
l9_35=l9_34;
...
#endif
float l9_36=mix(Tweak_N68-Port_Feather_N078,Tweak_N68+Port_Feather_N078,Tweak_N68);
float l9_37;
#if (N78_Reevers)
{
l9_37=1.0-Interpolator_UVCoord2.y;
}
#else
{
l9_37=Interpolator_UVCoord2.y;
}
#endif
float l9_38=smoothstep(l9_36-Port_Feather_N078,l9_36+Port_Feather_N078,l9_37);
float l9_39;
#if (!N78_Out)
{
l9_39=1.0-l9_38;
...
#endif
float l9_40=l9_35.x*l9_39;
float l9_41=mix(l9_40,l9_35.z*Tweak_N68,l9_8);
float l9_42=clamp(Port_Import_N089,0.0,1.0);
float l9_43=(Port_Input0_N024-varPackedTex.w)-Port_Input1_N026;
float l9_44=l9_0*Port_Multiplier_N027;
vec4 l9_45=mix(Port_Input0_N082,vec4(mod((l9_44+Port_Input1_N113)*Port_Input1_N080,Port_Input1_N081)),vec4(l9_4));
float l9_46=clamp(Port_Import_N102,0.0,1.0);
float l9_47=clamp((smoothstep(l9_42,l9_42+clamp(Port_Import_N093,0.0,1.0),l9_43+l9_45.x)*(1.0-smoothstep(l9_46,l9_46+clamp(Port_Import_N103,0.0,1.0),l9_43+(l9_45-Port_Input1_N099).x)))+0.001,Port_Input1_N110+0.001,Port_Input2_N110+0.001)-0.001;
float l9_48;
if (l9_47<=0.0)
{
l9_48=0.0;
...
{
l9_48=pow(l9_47,Port_Input1_N116);
}
vec4 l9_49=vec4(Tweak_N5.x,Tweak_N5.y,Tweak_N5.z,vec4(0.0).w);
l9_49.w=(((l9_41*Interpolator_UVCoord2.y)*Tweak_N19)*(Port_Input0_N023*Interpolator_UVCoord2.y))+(((l9_48*Interpolator_UVCoord2.y)*(l9_41*Port_Input1_N115))*Port_Input3_N114);
vec4 l9_50=clamp(l9_49+vec4(0.001),Port_Input1_N059+vec4(0.001),Port_Input2_N059+vec4(0.001))-vec4(0.001);
float l9_51=l9_50.w;
...
{
l9_55=clamp(dot(l9_50.xyz,vec3(l9_51)),0.0,1.0);
}
#else
{
float l9_56;
...
{
l9_57=(1.0-dot(l9_50.xyz,vec3(0.33333001)))*l9_51;
}
#else
{
float l9_58;
...
{
l9_58=(1.0-clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0))*l9_51;
}
#else
{
float l9_59;
...
{
l9_59=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0)*l9_51;
}
#else
{
float l9_60;
#if (sc_BlendMode_Add)
{
l9_60=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_61;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_61=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0)*l9_51;
}
#else
{
float l9_62;
...
{
l9_62=dot(l9_50.xyz,vec3(0.33333001))*l9_51;
}
#else
{
float l9_63;
#if (sc_BlendMode_Min)
{
l9_63=1.0-clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_64;
#if (sc_BlendMode_Max)
{
l9_64=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_64=1.0;
...
#endif
l9_52=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_50.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_53);
}
#else
{
vec4 l9_65;
...
#endif
vec3 l9_75=mix(l9_73.xyz,definedBlend(l9_73.xyz,l9_50.xyz).xyz,vec3(l9_51));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_77=vec4(mix(vec3(1.0),l9_50.xyz,vec3(l9_51)),l9_51);
}
#else
{
vec4 l9_78;
...
#endif
l9_78=vec4(l9_50.xyz*l9_79,l9_79);
}
#else
{
l9_78=l9_50;
