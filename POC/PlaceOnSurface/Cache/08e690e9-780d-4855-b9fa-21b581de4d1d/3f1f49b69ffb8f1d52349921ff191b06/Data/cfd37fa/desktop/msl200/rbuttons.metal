...
//sampler sampler textSmpSC 0:32
...
//texture texture2D text 0:20:0:32
...
//}
//ubo int UserUniforms 0:35:4576 {
...
//float hover 4304
//float4 textSize 4320
//float4 textDims 4336
//float4 textView 4352
//float3x3 textTransform 4368
//float4 textUvMinMax 4416
//float4 textBorderColor 4432
//float2 textUVScale 4448
//float globalOpacity 4456
//float Port_RangeMinA_N016 4460
//float Port_RangeMaxA_N016 4464
//float Port_RangeMinB_N016 4468
//float Port_RangeMaxB_N016 4472
//float2 Port_Center_N014 4480
//float Port_RangeMinA_N017 4488
//float Port_RangeMaxA_N017 4492
//float Port_RangeMinB_N017 4496
//float Port_RangeMaxB_N017 4500
//float4 Port_Import_N073 4512
//float2 Port_Center_N009 4528
//float4 Port_Import_N076 4544
//float Port_Input1_N013 4560
//float Port_Input2_N013 4564
//float depthRef 4568
//}
...
//spec_const bool sc_ProxyAlphaOne 66
...
//spec_const bool textHasSwappedViews 73
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 74
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 75
//spec_const int SC_SOFTWARE_WRAP_MODE_U_text 76
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 77
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78
//spec_const int SC_SOFTWARE_WRAP_MODE_V_text 79
//spec_const int baseTexLayout 80
//spec_const int intensityTextureLayout 81
//spec_const int sc_DepthBufferMode 82
//spec_const int sc_RenderingSpace 83
//spec_const int sc_ScreenTextureLayout 84
//spec_const int sc_ShaderCacheConstant 85
//spec_const int sc_SkinBonesCount 86
//spec_const int sc_StereoRenderingMode 87
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 88
//spec_const int textLayout 89
//SG_REFLECTION_END
...
constant bool textHasSwappedViews [[function_constant(73)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_text [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_text [[function_constant(79)]];
...
constant int textLayout [[function_constant(89)]];
...
float2 param_13=(*sc_set0.UserUniforms).textUVScale;
Output_N10=param_13;
...
int l9_92=l9_87;
int param_14=textLayout_tmp;
int param_15=l9_92;
float2 param_16=CoordsOut_N9;
bool param_17=(int(SC_USE_UV_TRANSFORM_text_tmp)!=0);
float3x3 param_18=(*sc_set0.UserUniforms).textTransform;
int2 param_19=int2(SC_SOFTWARE_WRAP_MODE_U_text_tmp,SC_SOFTWARE_WRAP_MODE_V_text_tmp);
bool param_20=(int(SC_USE_UV_MIN_MAX_text_tmp)!=0);
float4 param_21=(*sc_set0.UserUniforms).textUvMinMax;
bool param_22=(int(SC_USE_CLAMP_TO_BORDER_text_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).textBorderColor;
float param_24=0.0;
bool l9_93=param_22&&(!param_20);
float l9_94=1.0;
...
param_16.x=l9_95;
float l9_100=param_16.y;
int l9_101=param_19.y;
if (l9_101==1)
{
l9_100=fract(l9_100);
}
...
float l9_107=param_16.x;
float l9_108=param_21.x;
float l9_109=param_21.z;
bool l9_110=l9_106;
float l9_111=l9_94;
...
float l9_116=param_16.y;
float l9_117=param_21.y;
float l9_118=param_21.w;
bool l9_119=l9_115;
float l9_120=l9_94;
...
float2 l9_123=param_16;
bool l9_124=param_17;
float3x3 l9_125=param_18;
if (l9_124)
{
...
param_16=l9_128;
float l9_129=param_16.x;
int l9_130=param_19.x;
bool l9_131=l9_93;
float l9_132=l9_94;
...
param_16.x=l9_129;
l9_94=l9_132;
float l9_140=param_16.y;
int l9_141=param_19.y;
bool l9_142=l9_93;
float l9_143=l9_94;
...
param_16.y=l9_140;
l9_94=l9_143;
float2 l9_151=param_16;
int l9_152=param_14;
int l9_153=param_15;
float l9_154=param_24;
...
float l9_162=l9_154;
float4 l9_163=sc_set0.text.sample(sc_set0.textSmpSC,l9_161,bias(l9_162));
float4 l9_164=l9_163;
float4 l9_165=l9_164;
if (param_22)
{
l9_165=mix(param_23,l9_165,float4(l9_94));
}
...
bool l9_170=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_170)
{
...
float4 l9_171=fast::max(param_27,float4(0.0));
float4 param_28=l9_171;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_175=l9_174;
float l9_176=l9_175;
float l9_177=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_176;
float3 l9_178=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_172.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_184.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_185=l9_184;
l9_182=l9_185;
}
...
float2 l9_187=l9_186.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_224=l9_216;
float4 l9_225=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_223,bias(l9_224));
...
{
l9_243=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_243=float4(0.0);
