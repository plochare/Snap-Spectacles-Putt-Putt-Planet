...
let PlaceSurfaceDetector = class PlaceSurfaceDetector extends BaseScriptComponent {
    ...
    startStartPlacementState() {
        ...
        this.currentState = new PlacingStartState_1.PlacingStartState(this, this.surfaceDetection, this.pfbPlaceObject, this.camTr, this.placingStartForwardDisplace, (startPosition, startRotation, startObject) => {
