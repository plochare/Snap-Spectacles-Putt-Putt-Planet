...
#endif
vec2 l9_0=((varPackedTex.xy-Port_Center_N014)*vec2((((hover-Port_RangeMinA_N016)/(Port_RangeMaxA_N016-Port_RangeMinA_N016))*(Port_RangeMaxB_N016-Port_RangeMinB_N016))+Port_RangeMinB_N016))+Port_Center_N014;
float l9_1=l9_0.x;
float l9_2=l9_1;
...
vec4 l9_49=texture2D(baseTex,l9_48.xy,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
{
float l9_52=l9_1;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_53=l9_52;
float l9_54=l9_4;
sc_SoftwareWrapEarly(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_55=l9_54;
vec2 l9_56;
float l9_57;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_59=l9_53;
float l9_60=1.0;
sc_ClampUV(l9_59,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_58,l9_60);
float l9_61=l9_59;
float l9_62=l9_60;
bool l9_63;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_64=l9_55;
float l9_65=l9_62;
sc_ClampUV(l9_64,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_63,l9_65);
l9_57=l9_65;
...
#endif
vec2 l9_66=sc_TransformUV(l9_56,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_67=l9_66.x;
float l9_68=l9_57;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_68);
float l9_69=l9_66.y;
float l9_70=l9_68;
sc_SoftwareWrapLate(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_70);
float l9_71=l9_70;
vec3 l9_72=sc_SamplingCoordsViewToGlobal(vec2(l9_67,l9_69),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_73=texture2D(baseTex,l9_72.xy,0.0);
vec4 l9_74;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_74=mix(baseTexBorderColor,l9_73,vec4(l9_71));
}
#else
{
l9_74=l9_73;
...
{
float l9_75=l9_1;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_76=l9_75;
float l9_77=l9_4;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_78=l9_77;
vec2 l9_79;
float l9_80;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_82=l9_76;
float l9_83=1.0;
sc_ClampUV(l9_82,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_81,l9_83);
float l9_84=l9_82;
float l9_85=l9_83;
bool l9_86;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_86=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_87=l9_78;
float l9_88=l9_85;
sc_ClampUV(l9_87,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_86,l9_88);
l9_80=l9_88;
...
#endif
vec2 l9_89=sc_TransformUV(l9_79,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_93);
float l9_94=l9_93;
vec3 l9_95=sc_SamplingCoordsViewToGlobal(vec2(l9_90,l9_92),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_96=texture2D(baseTex,l9_95.xy,0.0);
vec4 l9_97;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_97=mix(baseTexBorderColor,l9_96,vec4(l9_94));
}
#else
{
l9_97=l9_96;
...
vec3 l9_98=mix(strokeColor.xyz,iconColor.xyz,vec3(l9_27.x));
float l9_99=(clamp(((l9_25.x*((((hover-Port_RangeMinA_N017)/(Port_RangeMaxA_N017-Port_RangeMinA_N017))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017))+l9_27.x)+0.001,Port_Input1_N013+0.001,Port_Input2_N013+0.001)-0.001)*globalOpacity;
vec4 l9_100=vec4(l9_98.x,l9_98.y,l9_98.z,vec4(0.0).w);
l9_100.w=l9_99;
...
{
l9_103=clamp(l9_99*2.0,0.0,1.0);
}
#else
{
float l9_104;
...
{
l9_104=clamp(dot(l9_100.xyz,vec3(l9_99)),0.0,1.0);
}
#else
{
float l9_105;
...
{
l9_106=(1.0-dot(l9_100.xyz,vec3(0.33333001)))*l9_99;
}
#else
{
float l9_107;
...
{
l9_107=(1.0-clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0))*l9_99;
}
#else
{
float l9_108;
...
{
l9_108=clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0)*l9_99;
}
#else
{
float l9_109;
#if (sc_BlendMode_Add)
{
l9_109=clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_110;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_110=clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0)*l9_99;
}
#else
{
float l9_111;
...
{
l9_111=dot(l9_100.xyz,vec3(0.33333001))*l9_99;
}
#else
{
float l9_112;
#if (sc_BlendMode_Min)
{
l9_112=1.0-clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_113;
#if (sc_BlendMode_Max)
{
l9_113=clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_113=1.0;
...
#endif
l9_101=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_100.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_102);
}
#else
{
vec4 l9_114;
...
#endif
vec3 l9_124=mix(l9_122.xyz,definedBlend(l9_122.xyz,l9_100.xyz).xyz,vec3(l9_99));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_126=vec4(mix(vec3(1.0),l9_100.xyz,vec3(l9_99)),l9_99);
}
#else
{
vec4 l9_127;
...
#endif
l9_127=vec4(l9_100.xyz*l9_128,l9_128);
}
#else
{
l9_127=l9_100;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_135-0.0039215689)),min(1.0,l9_135+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_137),packValue(l9_137),packValue(l9_137),packValue(l9_137)));
