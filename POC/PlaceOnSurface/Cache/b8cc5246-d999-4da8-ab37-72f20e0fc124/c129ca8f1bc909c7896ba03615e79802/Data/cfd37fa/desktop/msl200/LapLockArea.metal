...
//}
//ubo int UserUniforms 0:31:4512 {
...
//float4 Tweak_N15 4160
//float Tweak_N12 4176
//float GlobalOpacity 4180
//float2 Port_Input1_N006 4184
//float Port_Input1_N008 4192
//float Port_Input1_N011 4196
//float4 Port_Value0_N010 4208
//float Port_Position1_N010 4224
//float4 Port_Value1_N010 4240
//float4 Port_Value2_N010 4256
//float Port_Input1_N013 4272
//float4 Port_Value3_N010 4288
//float4 Port_Value4_N010 4304
//float4 Port_Value0_N000 4320
//float Port_Position1_N000 4336
//float4 Port_Value1_N000 4352
//float Port_Position2_N000 4368
//float4 Port_Value2_N000 4384
//float Port_Position3_N000 4400
//float4 Port_Value3_N000 4416
//float4 Port_Value4_N000 4432
//float Port_Input1_N001 4448
//float4 Port_Input1_N003 4464
//float4 Port_Input2_N003 4480
//float depthRef 4496
//}
...
float4 param=(*sc_set0.UserUniforms).Tweak_N15;
Output_N15=param;
...
float param_1=(*sc_set0.UserUniforms).Tweak_N12;
Output_N12=param_1;
float Output_N13=0.0;
Output_N13=Output_N12+(*sc_set0.UserUniforms).Port_Input1_N013;
float4 Value_N10=float4(0.0);
float param_2=Output_N11;
float4 param_3=(*sc_set0.UserUniforms).Port_Value0_N010;
float param_4=(*sc_set0.UserUniforms).Port_Position1_N010;
float4 param_5=(*sc_set0.UserUniforms).Port_Value1_N010;
float param_6=Output_N12;
float4 param_7=(*sc_set0.UserUniforms).Port_Value2_N010;
float param_8=Output_N13;
float4 param_9=(*sc_set0.UserUniforms).Port_Value3_N010;
float4 param_10=(*sc_set0.UserUniforms).Port_Value4_N010;
param_2=fast::clamp(param_2,0.0,1.0);
float4 param_11;
if (param_2<param_4)
{
param_11=mix(param_3,param_5,float4(fast::clamp(param_2/param_4,0.0,1.0)));
}
else
{
if (param_2<param_6)
{
param_11=mix(param_5,param_7,float4(fast::clamp((param_2-param_4)/(param_6-param_4),0.0,1.0)));
}
else
{
if (param_2<param_8)
{
param_11=mix(param_7,param_9,float4(fast::clamp((param_2-param_6)/(param_8-param_6),0.0,1.0)));
}
else
{
param_11=mix(param_9,param_10,float4(fast::clamp((param_2-param_8)/(1.0-param_8),0.0,1.0)));
}
}
}
...
if (l9_8)
{
l9_9=10==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_9=l9_8;
...
float param_13=Output_N11;
float4 param_14=(*sc_set0.UserUniforms).Port_Value0_N000;
float param_15=(*sc_set0.UserUniforms).Port_Position1_N000;
float4 param_16=(*sc_set0.UserUniforms).Port_Value1_N000;
float param_17=(*sc_set0.UserUniforms).Port_Position2_N000;
float4 param_18=(*sc_set0.UserUniforms).Port_Value2_N000;
float param_19=(*sc_set0.UserUniforms).Port_Position3_N000;
float4 param_20=(*sc_set0.UserUniforms).Port_Value3_N000;
float4 param_21=(*sc_set0.UserUniforms).Port_Value4_N000;
...
if (l9_11)
{
l9_12=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_12=l9_11;
...
float4 l9_17=fast::max(param_24,float4(0.0));
float4 param_25=l9_17;
if (sc_ShaderCacheConstant_tmp!=0)
{
