...
uniform vec4 Tweak_N15;
uniform float Tweak_N12;
uniform float GlobalOpacity;
uniform vec2 Port_Input1_N006;
...
uniform vec4 Port_Value3_N010;
uniform vec4 Port_Value4_N010;
...
float l9_1=Tweak_N12+Port_Input1_N013;
float l9_2=clamp((1.0-(distance(varPackedTex.xy,Port_Input1_N006)*Port_Input1_N008))-Port_Input1_N011,0.0,1.0);
vec4 l9_3;
if (l9_2<Port_Position1_N010)
{
l9_3=mix(Port_Value0_N010,Port_Value1_N010,vec4(clamp(l9_2/Port_Position1_N010,0.0,1.0)));
}
else
{
vec4 l9_4;
if (l9_2<Tweak_N12)
{
l9_4=mix(Port_Value1_N010,Port_Value2_N010,vec4(clamp((l9_2-Port_Position1_N010)/(Tweak_N12-Port_Position1_N010),0.0,1.0)));
}
else
{
vec4 l9_5;
if (l9_2<l9_1)
{
l9_5=mix(Port_Value2_N010,Port_Value3_N010,vec4(clamp((l9_2-Tweak_N12)/(l9_1-Tweak_N12),0.0,1.0)));
}
else
{
l9_5=mix(Port_Value3_N010,Port_Value4_N010,vec4(clamp((l9_2-l9_1)/(1.0-l9_1),0.0,1.0)));
}
l9_4=l9_5;
}
l9_3=l9_4;
...
vec4 l9_10=vec4(GlobalOpacity);
vec4 l9_11=l9_3*l9_10;
vec4 l9_12;
if (l9_2<Port_Position1_N000)
{
l9_12=mix(Port_Value0_N000,Port_Value1_N000,vec4(clamp(l9_2/Port_Position1_N000,0.0,1.0)));
}
else
{
vec4 l9_13;
if (l9_2<Port_Position2_N000)
{
l9_13=mix(Port_Value1_N000,Port_Value2_N000,vec4(clamp((l9_2-Port_Position1_N000)/(Port_Position2_N000-Port_Position1_N000),0.0,1.0)));
}
else
{
vec4 l9_14;
if (l9_2<Port_Position3_N000)
{
l9_14=mix(Port_Value2_N000,Port_Value3_N000,vec4(clamp((l9_2-Port_Position2_N000)/(Port_Position3_N000-Port_Position2_N000),0.0,1.0)));
}
else
{
l9_14=mix(Port_Value3_N000,Port_Value4_N000,vec4(clamp((l9_2-Port_Position3_N000)/(1.0-Port_Position3_N000),0.0,1.0)));
}
l9_13=l9_14;
}
l9_12=l9_13;
...
vec4 l9_18=l9_12*vec4(Port_Input1_N001);
vec4 l9_19=clamp((l9_11+(l9_18*l9_10))+vec4(0.001),Port_Input1_N003+vec4(0.001),Port_Input2_N003+vec4(0.001))-vec4(0.001);
float l9_20=l9_19.x;
vec4 l9_21=vec4(Tweak_N15.x,Tweak_N15.y,Tweak_N15.z,vec4(0.0).w);
l9_21.w=l9_20;
...
{
l9_25=clamp(dot(l9_21.xyz,vec3(l9_20)),0.0,1.0);
}
#else
{
float l9_26;
...
{
l9_27=(1.0-dot(l9_21.xyz,vec3(0.33333001)))*l9_20;
}
#else
{
float l9_28;
...
{
l9_28=(1.0-clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0))*l9_20;
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*l9_20;
}
#else
{
float l9_30;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_31=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*l9_20;
}
#else
{
float l9_32;
...
{
l9_32=dot(l9_21.xyz,vec3(0.33333001))*l9_20;
}
#else
{
float l9_33;
...
#endif
l9_37=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_41,sc_ScreenTextureLayout,l9_42).xy,0.0);
}
#endif
vec4 l9_43;
...
#endif
vec3 l9_45=mix(l9_43.xyz,definedBlend(l9_43.xyz,l9_21.xyz).xyz,vec3(l9_20));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_47=vec4(mix(vec3(1.0),l9_21.xyz,vec3(l9_20)),l9_20);
}
#else
{
vec4 l9_48;
