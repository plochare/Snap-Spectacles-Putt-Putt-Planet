...
//float offset 4176
//float4 Tweak_N25Size 4192
//float4 Tweak_N25Dims 4208
//float4 Tweak_N25View 4224
//float3x3 Tweak_N25Transform 4240
//float4 Tweak_N25UvMinMax 4288
//float4 Tweak_N25BorderColor 4304
//int trackSwitch 4320
//float4 Tweak_N19Size 4336
//float4 Tweak_N19Dims 4352
//float4 Tweak_N19View 4368
//float3x3 Tweak_N19Transform 4384
//float4 Tweak_N19UvMinMax 4432
//float4 Tweak_N19BorderColor 4448
//float opacitySwitch 4464
//float Port_Value4_N032 4468
//float4 Port_Import_N059 4480
//float4 Port_Import_N060 4496
//float Port_Input0_N086 4512
//float Port_Input1_N086 4516
//float2 Port_Import_N063 4520
//float2 Port_Import_N015 4528
//float2 Port_Import_N066 4536
//float2 Port_Import_N068 4544
//float Port_Input1_N083 4552
//float Port_Input2_N083 4556
//float2 Port_Scale_N030 4560
//float2 Port_Center_N030 4568
//float2 Port_Scale_N014 4576
//float2 Port_Center_N014 4584
//float4 Port_Default_N013 4592
//float4 Port_Input2_N002 4608
//float depthRef 4624
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N19 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N25 32
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N19 34
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N25 35
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 36
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N19 37
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N25 38
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 39
//spec_const bool Tweak_N19HasSwappedViews 40
//spec_const bool Tweak_N25HasSwappedViews 41
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N19 74
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 75
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 76
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N19 77
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 78
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79
//spec_const int Tweak_N19Layout 80
//spec_const int Tweak_N25Layout 81
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N19 [[function_constant(74)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N19 [[function_constant(77)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 [[function_constant(78)]];
...
constant int Tweak_N19Layout [[function_constant(80)]];
constant int Tweak_N19Layout_tmp = is_function_constant_defined(Tweak_N19Layout) ? Tweak_N19Layout : 0;
constant int Tweak_N25Layout [[function_constant(81)]];
...
float param_9=(*sc_set0.UserUniforms).offset;
Output_N16=param_9;
...
float4 param_13=(*sc_set0.UserUniforms).Port_Default_N013;
ssGlobals param_15=Globals;
float l9_7=0.0;
float l9_8=float((*sc_set0.UserUniforms).trackSwitch);
l9_7=l9_8;
param_10=l9_7;
param_10=floor(param_10);
float4 param_14;
if (param_10==0.0)
{
float2 l9_9=float2(0.0);
l9_9=param_15.Surface_UVCoord0;
float2 l9_10=float2(0.0);
l9_10=((l9_9-(*sc_set0.UserUniforms).Port_Center_N030)*(*sc_set0.UserUniforms).Port_Scale_N030)+(*sc_set0.UserUniforms).Port_Center_N030;
param_11=float4(l9_10,0.0,0.0);
param_14=param_11;
}
else
{
...
l9_11=param_15.Surface_UVCoord0;
float2 l9_12=float2(0.0);
l9_12=((l9_11-(*sc_set0.UserUniforms).Port_Center_N014)*(*sc_set0.UserUniforms).Port_Scale_N014)+(*sc_set0.UserUniforms).Port_Center_N014;
param_12=float4(l9_12,0.0,0.0);
param_14=param_12;
}
else
{
...
int l9_18=l9_13;
int param_16=Tweak_N25Layout_tmp;
int param_17=l9_18;
float2 param_18=Result_N13.xy;
bool param_19=(int(SC_USE_UV_TRANSFORM_Tweak_N25_tmp)!=0);
float3x3 param_20=(*sc_set0.UserUniforms).Tweak_N25Transform;
int2 param_21=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25_tmp);
bool param_22=(int(SC_USE_UV_MIN_MAX_Tweak_N25_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).Tweak_N25UvMinMax;
bool param_24=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25_tmp)!=0);
float4 param_25=(*sc_set0.UserUniforms).Tweak_N25BorderColor;
float param_26=0.0;
bool l9_19=param_24&&(!param_22);
float l9_20=1.0;
float l9_21=param_18.x;
int l9_22=param_21.x;
if (l9_22==1)
{
l9_21=fract(l9_21);
}
...
param_18.x=l9_21;
float l9_26=param_18.y;
int l9_27=param_21.y;
if (l9_27==1)
{
l9_26=fract(l9_26);
}
...
float l9_33=param_18.x;
float l9_34=param_23.x;
float l9_35=param_23.z;
bool l9_36=l9_32;
float l9_37=l9_20;
...
float l9_42=param_18.y;
float l9_43=param_23.y;
float l9_44=param_23.w;
bool l9_45=l9_41;
float l9_46=l9_20;
...
float2 l9_49=param_18;
bool l9_50=param_19;
float3x3 l9_51=param_20;
if (l9_50)
{
...
float2 l9_54=l9_53;
param_18=l9_54;
float l9_55=param_18.x;
int l9_56=param_21.x;
bool l9_57=l9_19;
float l9_58=l9_20;
if ((l9_56==0)||(l9_56==3))
{
...
param_18.x=l9_55;
l9_20=l9_58;
float l9_66=param_18.y;
int l9_67=param_21.y;
bool l9_68=l9_19;
float l9_69=l9_20;
if ((l9_67==0)||(l9_67==3))
{
...
param_18.y=l9_66;
l9_20=l9_69;
float2 l9_77=param_18;
int l9_78=param_16;
int l9_79=param_17;
float l9_80=param_26;
float2 l9_81=l9_77;
int l9_82=l9_78;
int l9_83=l9_79;
...
float l9_88=l9_80;
float4 l9_89=sc_set0.Tweak_N25.sample(sc_set0.Tweak_N25SmpSC,l9_87,bias(l9_88));
float4 l9_90=l9_89;
float4 l9_91=l9_90;
if (param_24)
{
l9_91=mix(param_25,l9_91,float4(l9_20));
}
float4 l9_92=l9_91;
Output_N25=l9_92;
...
int l9_98=l9_93;
int param_27=Tweak_N19Layout_tmp;
int param_28=l9_98;
float2 param_29=UVCoord_N27;
bool param_30=(int(SC_USE_UV_TRANSFORM_Tweak_N19_tmp)!=0);
float3x3 param_31=(*sc_set0.UserUniforms).Tweak_N19Transform;
int2 param_32=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N19_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N19_tmp);
bool param_33=(int(SC_USE_UV_MIN_MAX_Tweak_N19_tmp)!=0);
float4 param_34=(*sc_set0.UserUniforms).Tweak_N19UvMinMax;
bool param_35=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N19_tmp)!=0);
float4 param_36=(*sc_set0.UserUniforms).Tweak_N19BorderColor;
float param_37=0.0;
bool l9_99=param_35&&(!param_33);
float l9_100=1.0;
float l9_101=param_29.x;
int l9_102=param_32.x;
if (l9_102==1)
{
l9_101=fract(l9_101);
}
...
param_29.x=l9_101;
float l9_106=param_29.y;
int l9_107=param_32.y;
if (l9_107==1)
{
l9_106=fract(l9_106);
}
...
float l9_113=param_29.x;
float l9_114=param_34.x;
float l9_115=param_34.z;
bool l9_116=l9_112;
float l9_117=l9_100;
...
float l9_122=param_29.y;
float l9_123=param_34.y;
float l9_124=param_34.w;
bool l9_125=l9_121;
float l9_126=l9_100;
...
float2 l9_129=param_29;
bool l9_130=param_30;
float3x3 l9_131=param_31;
if (l9_130)
{
...
param_29=l9_134;
float l9_135=param_29.x;
int l9_136=param_32.x;
bool l9_137=l9_99;
float l9_138=l9_100;
...
param_29.x=l9_135;
l9_100=l9_138;
float l9_146=param_29.y;
int l9_147=param_32.y;
bool l9_148=l9_99;
float l9_149=l9_100;
...
param_29.y=l9_146;
l9_100=l9_149;
float2 l9_157=param_29;
int l9_158=param_27;
int l9_159=param_28;
float l9_160=param_37;
...
float l9_168=l9_160;
float4 l9_169=sc_set0.Tweak_N19.sample(sc_set0.Tweak_N19SmpSC,l9_167,bias(l9_168));
float4 l9_170=l9_169;
float4 l9_171=l9_170;
if (param_35)
{
l9_171=mix(param_36,l9_171,float4(l9_100));
}
float4 l9_172=l9_171;
Output_N19=l9_172;
float Output_N21=0.0;
float param_38=(*sc_set0.UserUniforms).opacitySwitch;
Output_N21=param_38;
...
bool l9_176=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_176)
{
...
float4 l9_177=fast::max(param_40,float4(0.0));
float4 param_41=l9_177;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_186=param_42;
float4 l9_187=float4(0.0);
float4 l9_188=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_189=out.FragColor0;
float4 l9_190=l9_189;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_190.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_193=l9_192.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_198=l9_197;
int l9_199=l9_198;
float3 l9_200=float3(l9_194,0.0);
int l9_201=l9_196;
int l9_202=l9_199;
if (l9_201==1)
{
l9_200.y=((2.0*l9_200.y)+float(l9_202))-1.0;
}
float2 l9_203=l9_200.xy;
l9_195=l9_203;
}
else
{
...
int l9_212=l9_207;
float2 l9_213=l9_206;
int l9_214=l9_212;
float2 l9_215=l9_213;
int l9_216=l9_214;
float l9_217=0.0;
float4 l9_218=float4(0.0);
float2 l9_219=l9_215;
int l9_220=sc_ScreenTextureLayout_tmp;
int l9_221=l9_216;
float l9_222=l9_217;
...
float l9_230=l9_222;
float4 l9_231=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_229,bias(l9_230));
float4 l9_232=l9_231;
l9_218=l9_232;
float4 l9_233=l9_218;
float4 l9_234=l9_233;
float4 l9_235=l9_234;
l9_188=l9_235;
}
float4 l9_236=l9_188;
float4 l9_237=l9_236;
float3 l9_238=l9_237.xyz;
float3 l9_239=l9_238;
float3 l9_240=l9_186.xyz;
float3 l9_241=definedBlend(l9_239,l9_240,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_187=float4(l9_241.x,l9_241.y,l9_241.z,l9_187.w);
float3 l9_242=mix(l9_238,l9_187.xyz,float3(l9_186.w));
l9_187=float4(l9_242.x,l9_242.y,l9_242.z,l9_187.w);
l9_187.w=1.0;
float4 l9_243=l9_187;
param_42=l9_243;
}
else
{
...
{
l9_249=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_249=float4(0.0);
...
float4 l9_251=param_45;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_251.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_251;
return out;
}
} // FRAGMENT SHADER
