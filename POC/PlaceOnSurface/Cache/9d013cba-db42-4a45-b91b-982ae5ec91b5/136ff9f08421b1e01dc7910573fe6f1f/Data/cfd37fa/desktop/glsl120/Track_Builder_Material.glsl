...
//sampler sampler Tweak_N19SmpSC 0:17
...
//texture texture2D Tweak_N19 0:0:0:17
//texture texture2D Tweak_N25 0:1:0:18
...
uniform float opacitySwitch;
uniform float Port_Value4_N032;
uniform vec4 Port_Import_N059;
uniform vec4 Port_Import_N060;
uniform float Port_Input0_N086;
uniform float Port_Input1_N086;
uniform vec2 Port_Import_N063;
uniform vec2 Port_Import_N015;
uniform vec2 Port_Import_N066;
uniform vec2 Port_Import_N068;
uniform float Port_Input1_N083;
uniform float Port_Input2_N083;
uniform vec2 Port_Scale_N030;
uniform vec2 Port_Center_N030;
uniform vec2 Port_Scale_N014;
uniform vec2 Port_Center_N014;
uniform vec4 Port_Default_N013;
uniform vec4 Port_Input2_N002;
...
#endif
vec2 l9_0=vec2(offset);
vec2 l9_1=Port_Import_N068-Port_Import_N066;
vec4 l9_2=mix(Port_Import_N059,Port_Import_N060,vec4(smoothstep(Port_Input0_N086,Port_Input1_N086,clamp((dot((((varPackedTex.xy-l9_0)*Port_Import_N063)+l9_0)-Port_Import_N066,l9_1)/(dot(l9_1,l9_1)+1.234e-06))+0.001,Port_Input1_N083+0.001,Port_Input2_N083+0.001)-0.001)));
float l9_3=floor(float(trackSwitch));
vec4 l9_4;
if (l9_3==0.0)
{
l9_4=vec4(((varPackedTex.xy-Port_Center_N030)*Port_Scale_N030)+Port_Center_N030,0.0,0.0);
}
else
{
vec4 l9_5;
if (l9_3==1.0)
{
l9_5=vec4(((varPackedTex.xy-Port_Center_N014)*Port_Scale_N014)+Port_Center_N014,0.0,0.0);
}
else
{
l9_5=Port_Default_N013;
}
l9_4=l9_5;
}
int l9_6;
...
#endif
float l9_7=l9_4.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x);
float l9_8=l9_7;
float l9_9=l9_4.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
...
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,Tweak_N25UvMinMax.x,Tweak_N25UvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,Tweak_N25UvMinMax.y,Tweak_N25UvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0)),l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0)),l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),Tweak_N25Layout,l9_6);
vec4 l9_28=texture2D(Tweak_N25,l9_27.xy,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_29=mix(Tweak_N25BorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N19,SC_SOFTWARE_WRAP_MODE_V_Tweak_N19).x);
float l9_33=l9_32;
float l9_34=varPackedTex.y;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N19,SC_SOFTWARE_WRAP_MODE_V_Tweak_N19).y);
float l9_35=l9_34;
vec2 l9_36;
float l9_37;
...
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N19,SC_SOFTWARE_WRAP_MODE_V_Tweak_N19).x==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N19)!=0);
}
#endif
float l9_39=l9_33;
float l9_40=1.0;
sc_ClampUV(l9_39,Tweak_N19UvMinMax.x,Tweak_N19UvMinMax.z,l9_38,l9_40);
float l9_41=l9_39;
float l9_42=l9_40;
bool l9_43;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N19)
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N19,SC_SOFTWARE_WRAP_MODE_V_Tweak_N19).y==3;
}
#else
{
l9_43=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N19)!=0);
}
#endif
float l9_44=l9_35;
float l9_45=l9_42;
sc_ClampUV(l9_44,Tweak_N19UvMinMax.y,Tweak_N19UvMinMax.w,l9_43,l9_45);
l9_37=l9_45;
...
#endif
vec2 l9_46=sc_TransformUV(l9_36,(int(SC_USE_UV_TRANSFORM_Tweak_N19)!=0),Tweak_N19Transform);
float l9_47=l9_46.x;
float l9_48=l9_37;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N19,SC_SOFTWARE_WRAP_MODE_V_Tweak_N19).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N19)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N19)!=0)),l9_48);
float l9_49=l9_46.y;
float l9_50=l9_48;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N19,SC_SOFTWARE_WRAP_MODE_V_Tweak_N19).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N19)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N19)!=0)),l9_50);
float l9_51=l9_50;
vec3 l9_52=sc_SamplingCoordsViewToGlobal(vec2(l9_47,l9_49),Tweak_N19Layout,l9_31);
vec4 l9_53=texture2D(Tweak_N19,l9_52.xy,0.0);
vec4 l9_54;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N19)
{
l9_54=mix(Tweak_N19BorderColor,l9_53,vec4(l9_51));
}
#else
{
l9_54=l9_53;
...
#endif
vec4 l9_55=mix(l9_29,l9_54,vec4(opacitySwitch));
vec4 l9_56=mix(l9_30*Port_Input2_N002,l9_2,l9_55);
float l9_57=l9_56.x;
vec4 l9_58=vec4(Tweak_N1.xyz,l9_57);
...
#endif
l9_74=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_78,sc_ScreenTextureLayout,l9_79).xy,0.0);
}
#endif
vec4 l9_80;
...
{
vec4 l9_81=l9_74;
l9_81.x=l9_74.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_80=l9_81;
}
#else
{
...
#endif
vec3 l9_82=mix(l9_80.xyz,definedBlend(l9_80.xyz,l9_58.xyz).xyz,vec3(l9_57));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_84=vec4(mix(vec3(1.0),l9_58.xyz,vec3(l9_57)),l9_57);
}
#else
{
vec4 l9_85;
...
#endif
l9_85=vec4(l9_58.xyz*l9_86,l9_86);
}
#else
{
l9_85=l9_58;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_94).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_95=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_94).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_107).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_112==0)
{
l9_115=texture2D(sc_OITAlpha0,l9_107);
l9_114=texture2D(sc_OITDepthLow0,l9_107);
l9_113=texture2D(sc_OITDepthHigh0,l9_107);
}
else
{
l9_115=vec4(0.0);
...
if (l9_112==1)
{
l9_118=texture2D(sc_OITAlpha1,l9_107);
l9_117=texture2D(sc_OITDepthLow1,l9_107);
l9_116=texture2D(sc_OITDepthHigh1,l9_107);
}
else
{
l9_118=l9_115;
...
vec4 l9_133=texture2D(sc_OITFilteredDepthBoundsTexture,l9_107);
