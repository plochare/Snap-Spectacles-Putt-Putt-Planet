...
sc_SoftwareWrapEarly(l9_1,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_2=l9_1;
float l9_3=varPackedTex.y;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_4=l9_3;
vec2 l9_5;
float l9_6;
...
{
l9_7=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_7=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_8=l9_2;
float l9_9=1.0;
sc_ClampUV(l9_8,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_7,l9_9);
float l9_10=l9_8;
float l9_11=l9_9;
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_13=l9_4;
float l9_14=l9_11;
sc_ClampUV(l9_13,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_12,l9_14);
l9_6=l9_14;
...
#endif
vec2 l9_15=sc_TransformUV(l9_5,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_16=l9_15.x;
float l9_17=l9_6;
sc_SoftwareWrapLate(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_17);
float l9_18=l9_15.y;
float l9_19=l9_17;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_19);
float l9_20=l9_19;
vec3 l9_21=sc_SamplingCoordsViewToGlobal(vec2(l9_16,l9_18),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_22=texture2D(Tweak_N0,l9_21.xy,0.0);
vec4 l9_23;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_23=mix(Tweak_N0BorderColor,l9_22,vec4(l9_20));
}
#else
{
l9_23=l9_22;
...
#endif
float l9_24=(l9_23.x+l9_23.y)+l9_23.z;
l9_0=vec4(l9_24,l9_24,l9_24,l9_23.w)*vec4((Port_Value_N006+0.001)-0.001);
}
#else
{
float l9_25=varPackedTex.x;
sc_SoftwareWrapEarly(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_26=l9_25;
float l9_27=varPackedTex.y;
sc_SoftwareWrapEarly(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_28=l9_27;
vec2 l9_29;
float l9_30;
#if (SC_USE_UV_MIN_MAX_Tweak_N0)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_31=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_31=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_32=l9_26;
float l9_33=1.0;
sc_ClampUV(l9_32,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_31,l9_33);
float l9_34=l9_32;
float l9_35=l9_33;
bool l9_36;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_36=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_37=l9_28;
float l9_38=l9_35;
sc_ClampUV(l9_37,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_36,l9_38);
l9_30=l9_38;
...
#endif
vec2 l9_39=sc_TransformUV(l9_29,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_40=l9_39.x;
float l9_41=l9_30;
sc_SoftwareWrapLate(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_41);
float l9_42=l9_39.y;
float l9_43=l9_41;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_43);
float l9_44=l9_43;
vec3 l9_45=sc_SamplingCoordsViewToGlobal(vec2(l9_40,l9_42),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_46=texture2D(Tweak_N0,l9_45.xy,0.0);
vec4 l9_47;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_47=mix(Tweak_N0BorderColor,l9_46,vec4(l9_44));
}
#else
{
l9_47=l9_46;
...
{
l9_50=clamp(l9_0.w*2.0,0.0,1.0);
}
#else
{
float l9_51;
...
{
l9_51=clamp(dot(l9_0.xyz,vec3(l9_0.w)),0.0,1.0);
}
#else
{
float l9_52;
...
{
l9_53=(1.0-dot(l9_0.xyz,vec3(0.33333001)))*l9_0.w;
}
#else
{
float l9_54;
...
{
l9_54=(1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0))*l9_0.w;
}
#else
{
float l9_55;
...
{
l9_55=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_0.w;
}
#else
{
float l9_56;
#if (sc_BlendMode_Add)
{
l9_56=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_57;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_57=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_0.w;
}
#else
{
float l9_58;
...
{
l9_58=dot(l9_0.xyz,vec3(0.33333001))*l9_0.w;
}
#else
{
float l9_59;
#if (sc_BlendMode_Min)
{
l9_59=1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_60;
#if (sc_BlendMode_Max)
{
l9_60=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_60=1.0;
...
#endif
l9_48=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_0.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_49);
}
#else
{
vec4 l9_61;
...
#endif
vec3 l9_71=mix(l9_69.xyz,definedBlend(l9_69.xyz,l9_0.xyz).xyz,vec3(l9_0.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_73=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_0.w)),l9_0.w);
}
#else
{
vec4 l9_74;
...
#endif
l9_74=vec4(l9_0.xyz*l9_75,l9_75);
}
#else
{
l9_74=l9_0;
