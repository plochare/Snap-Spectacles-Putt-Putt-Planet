...
(function (PathBuilder) {
    function buildFromPoints(points, width) {
        ...
        const maxDistance = Math.max(verticesAndNormals[verticesAndNormals.length - 1][0][2], verticesAndNormals[verticesAndNormals.length - 1][1][2]);
    ...
    PathBuilder.buildFromPoints = buildFromPoints;
})(PathBuilder || (exports.PathBuilder = PathBuilder = {}));
