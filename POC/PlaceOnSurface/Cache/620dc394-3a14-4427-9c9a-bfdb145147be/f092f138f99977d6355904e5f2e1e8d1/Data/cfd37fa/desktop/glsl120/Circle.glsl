...
uniform float Tweak_N39;
uniform float Port_Value_N005;
uniform float Port_Value_N008;
...
uniform float Port_StartValue_N032;
uniform float Port_StartPower_N032;
uniform float Port_EndValue_N032;
uniform float Port_EndPower_N032;
...
uniform float Port_Import_N011;
uniform float Port_Import_N012;
uniform float Port_Import_N013;
uniform float Port_Import_N015;
uniform float Port_Value_N022;
uniform float Port_Import_N016;
uniform float Port_Value0_N029;
uniform float Port_Position1_N029;
uniform float Port_Value1_N029;
uniform float Port_Value2_N029;
...
float l9_2=(Port_Value_N005+0.001)-0.001;
float l9_3=(Port_Value_N008+0.001)-0.001;
float l9_4=distance(varPackedTex.xy,Port_Input1_N001);
float l9_5=l9_1*Port_Multiplier_N025;
float l9_6=(fract(l9_5*Tweak_N41)-0.0)/(1.0-0.0);
float l9_7=ssPow(l9_6,Port_StartPower_N032);
float l9_8=ssPow(1.0-l9_6,Port_EndPower_N032);
float l9_9=mix(0.2,0.40000001,(abs(Port_StartPower_N032-Port_EndPower_N032)-0.0)/(1.5-0.0));
float l9_10=(mix(l9_7,1.0-l9_8,smoothstep(0.5-l9_9,0.5+l9_9,l9_6))*(Port_EndValue_N032-Port_StartValue_N032))+Port_StartValue_N032;
float l9_11=(((l9_10-Port_RangeMinA_N034)/(Port_RangeMaxA_N034-Port_RangeMinA_N034))*(Port_RangeMaxB_N034-l9_2))+l9_2;
float l9_12=clamp(l9_10,0.0,1.0);
float l9_13;
if (l9_12<Port_Position1_N029)
{
l9_13=mix(Port_Value0_N029,Port_Value1_N029,clamp(l9_12/Port_Position1_N029,0.0,1.0));
}
else
{
l9_13=mix(Port_Value1_N029,Port_Value2_N029,clamp((l9_12-Port_Position1_N029)/(1.0-Port_Position1_N029),0.0,1.0));
}
...
bool l9_16;
vec4 l9_17;
if (l9_15&&(29==PreviewNodeID))
{
l9_17=vec4(l9_13,l9_13,l9_13,1.0);
l9_16=true;
}
else
{
...
vec4 l9_18=vec4(Tweak_N5.x,Tweak_N5.y,Tweak_N5.z,vec4(0.0).w);
l9_18.w=((smoothstep(l9_2-l9_3,l9_2,l9_4)*(1.0-smoothstep(l9_2,l9_2+l9_3,l9_4)))+((smoothstep(l9_11-mix(Port_Input0_N038,Port_Input1_N038,l9_10),l9_11,l9_4)*(1.0-smoothstep(l9_11,l9_11+((Port_Value_N022+0.001)-0.001),l9_4)))*l9_13))*Tweak_N39;
vec4 l9_19=clamp(l9_18+vec4(0.001),Port_Input1_N059+vec4(0.001),Port_Input2_N059+vec4(0.001))-vec4(0.001);
float l9_20=l9_19.w;
...
{
l9_24=clamp(dot(l9_19.xyz,vec3(l9_20)),0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_26=(1.0-dot(l9_19.xyz,vec3(0.33333001)))*l9_20;
}
#else
{
float l9_27;
...
{
l9_27=(1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0))*l9_20;
}
#else
{
float l9_28;
...
{
l9_28=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*l9_20;
}
#else
{
float l9_29;
#if (sc_BlendMode_Add)
{
l9_29=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_30=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*l9_20;
}
#else
{
float l9_31;
...
{
l9_31=dot(l9_19.xyz,vec3(0.33333001))*l9_20;
}
#else
{
float l9_32;
#if (sc_BlendMode_Min)
{
l9_32=1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
#if (sc_BlendMode_Max)
{
l9_33=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_33=1.0;
...
#endif
l9_21=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_19.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_22);
}
#else
{
vec4 l9_34;
...
#if (sc_FramebufferFetch)
{
vec4 l9_37=sc_readFragData0_Platform();
vec4 l9_38;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_39=l9_37;
l9_39.x=l9_37.x+_sc_framebufferFetchMarker;
l9_38=l9_39;
}
#else
{
...
#endif
l9_36=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_40,sc_ScreenTextureLayout,l9_41).xy,0.0);
}
#endif
vec4 l9_42;
...
{
vec4 l9_43=l9_36;
l9_43.x=l9_36.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_42=l9_43;
}
#else
{
...
#endif
vec3 l9_44=mix(l9_42.xyz,definedBlend(l9_42.xyz,l9_19.xyz).xyz,vec3(l9_20));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_46=vec4(mix(vec3(1.0),l9_19.xyz,vec3(l9_20)),l9_20);
}
#else
{
vec4 l9_47;
...
#endif
l9_47=vec4(l9_19.xyz*l9_48,l9_48);
}
#else
{
l9_47=l9_19;
...
#endif
int l9_57=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_56).xy);
...
if (l9_74==0)
{
l9_77=texture2D(sc_OITAlpha0,l9_69);
l9_76=texture2D(sc_OITDepthLow0,l9_69);
l9_75=texture2D(sc_OITDepthHigh0,l9_69);
}
else
{
l9_77=vec4(0.0);
...
if (l9_74==1)
{
l9_80=texture2D(sc_OITAlpha1,l9_69);
l9_79=texture2D(sc_OITDepthLow1,l9_69);
l9_78=texture2D(sc_OITDepthHigh1,l9_69);
}
else
{
l9_80=l9_77;
...
vec4 l9_95=texture2D(sc_OITFilteredDepthBoundsTexture,l9_69);
vec2 l9_96=l9_95.xy;
int l9_97;
#if (sc_SkinBonesCount>0)
{
