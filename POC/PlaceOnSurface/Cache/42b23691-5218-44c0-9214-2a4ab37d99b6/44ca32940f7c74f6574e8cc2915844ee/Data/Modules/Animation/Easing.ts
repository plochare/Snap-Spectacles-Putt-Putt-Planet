...
export namespace Easing {
    export const Linear: EasingFunction = (k: number): number => k;
...
export const easings: IEasing = {
    ...
    ExpoIn: Easing.Exponential.In,
    ExpoOut: Easing.Exponential.Out,
    ExpoInOut: Easing.Exponential.InOut,
