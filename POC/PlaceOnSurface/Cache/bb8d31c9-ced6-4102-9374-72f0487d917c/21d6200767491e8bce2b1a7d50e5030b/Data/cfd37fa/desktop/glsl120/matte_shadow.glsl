...
float l9_34=l9_33.x;
float l9_35=l9_24;
sc_SoftwareWrapLate(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_35);
float l9_36=l9_33.y;
float l9_37=l9_35;
sc_SoftwareWrapLate(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_37);
float l9_38=l9_37;
vec3 l9_39=sc_SamplingCoordsViewToGlobal(vec2(l9_34,l9_36),opacityTexLayout,l9_18);
...
#endif
l9_6=mix(Port_Input0_N006,l9_8,vec3(l9_41.x));
}
#else
{
vec3 l9_42;
Node0_Shadow_Sample(l9_42,l9_5);
l9_6=l9_42;
}
#endif
vec4 l9_43=vec4(l9_6.x,l9_6.y,l9_6.z,vec4(0.0).w);
l9_43.w=Port_Value2_N001;
...
{
l9_46=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_47;
...
{
l9_47=clamp(dot(l9_43.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_48;
...
{
l9_49=(1.0-dot(l9_43.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_50;
...
{
l9_50=(1.0-clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_51;
...
{
l9_51=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_52;
#if (sc_BlendMode_Add)
{
l9_52=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_53;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_53=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_54;
...
{
l9_54=dot(l9_43.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_55;
#if (sc_BlendMode_Min)
{
l9_55=1.0-clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_56;
#if (sc_BlendMode_Max)
{
l9_56=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_56=1.0;
...
#endif
l9_44=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_43.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_45);
}
#else
{
vec4 l9_57;
...
#endif
l9_59=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_63,sc_ScreenTextureLayout,l9_64).xy,0.0);
}
#endif
vec4 l9_65;
...
#endif
vec3 l9_67=mix(l9_65.xyz,definedBlend(l9_65.xyz,l9_43.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_69=vec4(mix(vec3(1.0),l9_43.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_70;
...
{
l9_71=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_71=Port_Value2_N001;
}
#endif
l9_70=vec4(l9_43.xyz*l9_71,l9_71);
}
#else
{
l9_70=l9_43;
