...
float l9_2=max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*Port_Normal_N002)),Port_Exponent_N002),0.0)*Port_Intensity_N002;
vec4 l9_3=vec4(((Tweak_N1*vec4(1.0-l9_2))+(Tweak_N0*vec4(l9_2))).xyz,Opacity);
...
{
l9_6=clamp(Opacity*2.0,0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_7=clamp(dot(l9_3.xyz,vec3(Opacity)),0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_9=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*Opacity;
}
#else
{
float l9_10;
...
{
l9_10=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*Opacity;
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_12;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_13=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_14;
...
{
l9_14=dot(l9_3.xyz,vec3(0.33333001))*Opacity;
}
#else
{
float l9_15;
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_3.xyz).xyz,vec3(Opacity));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_3.xyz,vec3(Opacity)),Opacity);
}
#else
{
vec4 l9_30;
