...
//float4 Tweak_N0 4176
//float Opacity 4192
//float3 Port_Normal_N002 4208
//float Port_Exponent_N002 4224
//float Port_Intensity_N002 4228
//float depthRef 4232
//}
...
Output_N1=param;
float Rim_N2=0.0;
float3 param_1=(*sc_set0.UserUniforms).Port_Normal_N002;
float param_2=(*sc_set0.UserUniforms).Port_Exponent_N002;
float param_3=(*sc_set0.UserUniforms).Port_Intensity_N002;
ssGlobals param_5=Globals;
param_1=float3x3(float3(param_5.VertexTangent_WorldSpace),float3(param_5.VertexBinormal_WorldSpace),float3(param_5.VertexNormal_WorldSpace))*param_1;
float l9_7=abs(dot(-param_5.ViewDirWS,param_1));
float param_4=pow(1.0-l9_7,param_2);
param_4=fast::max(param_4,0.0);
param_4*=param_3;
Rim_N2=param_4;
float Output_N9=0.0;
...
float4 param_6=(*sc_set0.UserUniforms).Tweak_N0;
Output_N0=param_6;
...
float param_7=(*sc_set0.UserUniforms).Opacity;
Output_N10=param_7;
...
float4 l9_12=fast::max(param_9,float4(0.0));
float4 param_10=l9_12;
if (sc_ShaderCacheConstant_tmp!=0)
{
