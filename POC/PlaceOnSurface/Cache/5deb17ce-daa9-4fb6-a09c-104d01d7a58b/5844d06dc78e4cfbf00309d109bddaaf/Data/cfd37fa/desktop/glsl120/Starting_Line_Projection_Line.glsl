...
#endif
vec4 l9_24=l9_23*vec4(clamp(Port_Import_N092,0.0,5.0));
vec4 l9_25=vec4((mix(Port_Input0_N102,mix(vec4(dot(l9_24,Port_Input1_N094)),l9_24,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*Tweak_N6).xyz,Tweak_N3);
#if (sc_BlendMode_AlphaTest)
{
if (Tweak_N3<alphaTestThreshold)
{
discard;
}
}
...
{
if (Tweak_N3<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_28=clamp(Tweak_N3*2.0,0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_25.xyz,vec3(Tweak_N3)),0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_31=(1.0-dot(l9_25.xyz,vec3(0.33333001)))*Tweak_N3;
}
#else
{
float l9_32;
...
{
l9_32=(1.0-clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0))*Tweak_N3;
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*Tweak_N3;
}
#else
{
float l9_34;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_35=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*Tweak_N3;
}
#else
{
float l9_36;
...
{
l9_36=dot(l9_25.xyz,vec3(0.33333001))*Tweak_N3;
}
#else
{
float l9_37;
...
#endif
vec3 l9_49=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_25.xyz).xyz,vec3(Tweak_N3));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_25.xyz,vec3(Tweak_N3)),Tweak_N3);
}
#else
{
vec4 l9_52;
