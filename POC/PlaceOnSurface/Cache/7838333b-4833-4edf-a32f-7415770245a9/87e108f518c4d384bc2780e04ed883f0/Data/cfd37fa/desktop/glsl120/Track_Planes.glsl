...
sc_SoftwareWrapEarly(l9_1,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x);
float l9_2=l9_1;
float l9_3=varPackedTex.y;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y);
float l9_4=l9_3;
vec2 l9_5;
float l9_6;
...
{
l9_7=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x==3;
}
#else
{
l9_7=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_8=l9_2;
float l9_9=1.0;
sc_ClampUV(l9_8,Tweak_N3UvMinMax.x,Tweak_N3UvMinMax.z,l9_7,l9_9);
float l9_10=l9_8;
float l9_11=l9_9;
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_13=l9_4;
float l9_14=l9_11;
sc_ClampUV(l9_13,Tweak_N3UvMinMax.y,Tweak_N3UvMinMax.w,l9_12,l9_14);
l9_6=l9_14;
...
#endif
vec2 l9_15=sc_TransformUV(l9_5,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform);
float l9_16=l9_15.x;
float l9_17=l9_6;
sc_SoftwareWrapLate(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0)),l9_17);
float l9_18=l9_15.y;
float l9_19=l9_17;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0)),l9_19);
float l9_20=l9_19;
vec3 l9_21=sc_SamplingCoordsViewToGlobal(vec2(l9_16,l9_18),Tweak_N3Layout,l9_0);
vec4 l9_22=texture2D(Tweak_N3,l9_21.xy,0.0);
vec4 l9_23;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_23=mix(Tweak_N3BorderColor,l9_22,vec4(l9_20));
}
#else
{
l9_23=l9_22;
...
#endif
vec4 l9_24=Tweak_N5+l9_23;
vec4 l9_25=vec4(l9_24.x,l9_24.y,l9_24.z,vec4(0.0).w);
l9_25.w=Tweak_N6;
#if (sc_BlendMode_AlphaTest)
{
if (Tweak_N6<alphaTestThreshold)
{
discard;
}
}
...
{
if (Tweak_N6<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_28=clamp(Tweak_N6*2.0,0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_25.xyz,vec3(Tweak_N6)),0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_31=(1.0-dot(l9_25.xyz,vec3(0.33333001)))*Tweak_N6;
}
#else
{
float l9_32;
...
{
l9_32=(1.0-clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0))*Tweak_N6;
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*Tweak_N6;
}
#else
{
float l9_34;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_35=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*Tweak_N6;
}
#else
{
float l9_36;
...
{
l9_36=dot(l9_25.xyz,vec3(0.33333001))*Tweak_N6;
}
#else
{
float l9_37;
...
#endif
l9_41=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_45,sc_ScreenTextureLayout,l9_46).xy,0.0);
}
#endif
vec4 l9_47;
...
#endif
vec3 l9_49=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_25.xyz).xyz,vec3(Tweak_N6));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_25.xyz,vec3(Tweak_N6)),Tweak_N6);
}
#else
{
vec4 l9_52;
