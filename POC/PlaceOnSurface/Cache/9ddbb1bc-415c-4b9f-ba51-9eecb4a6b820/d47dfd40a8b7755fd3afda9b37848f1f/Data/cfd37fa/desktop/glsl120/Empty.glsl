...
#endif
float l9_24=(Tweak_N0.w*globalOpacity)*l9_23.x;
vec4 l9_25=vec4(Tweak_N0.x,Tweak_N0.y,Tweak_N0.z,vec4(0.0).w);
l9_25.w=l9_24;
...
{
l9_29=clamp(dot(l9_25.xyz,vec3(l9_24)),0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_31=(1.0-dot(l9_25.xyz,vec3(0.33333001)))*l9_24;
}
#else
{
float l9_32;
...
{
l9_32=(1.0-clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0))*l9_24;
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*l9_24;
}
#else
{
float l9_34;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_35=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*l9_24;
}
#else
{
float l9_36;
...
{
l9_36=dot(l9_25.xyz,vec3(0.33333001))*l9_24;
}
#else
{
float l9_37;
...
#endif
vec3 l9_49=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_25.xyz).xyz,vec3(l9_24));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_25.xyz,vec3(l9_24)),l9_24);
}
#else
{
vec4 l9_52;
