...
//sampler sampler iconMapSmpSC 0:18
...
//texture texture2D iconMap 0:1:0:18
...
uniform vec4 iconMapSize;
uniform vec4 iconMapView;
uniform mat3 iconMapTransform;
uniform vec4 iconMapUvMinMax;
uniform vec4 iconMapBorderColor;
...
uniform float Port_RangeMinA_N016;
uniform float Port_RangeMaxA_N016;
uniform float Port_RangeMinB_N016;
uniform float Port_RangeMaxB_N016;
uniform vec2 Port_Center_N014;
uniform float Port_RangeMinA_N017;
uniform float Port_RangeMaxA_N017;
uniform float Port_RangeMinB_N017;
uniform float Port_RangeMaxB_N017;
uniform vec4 Port_Import_N073;
uniform vec4 Port_Import_N076;
uniform float Port_Input1_N013;
uniform float Port_Input2_N013;
...
#endif
#ifndef iconMapHasSwappedViews
#define iconMapHasSwappedViews 0
#elif iconMapHasSwappedViews==1
#undef iconMapHasSwappedViews
#define iconMapHasSwappedViews 1
#endif
#ifndef iconMapLayout
#define iconMapLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_iconMap
#define SC_USE_UV_TRANSFORM_iconMap 0
#elif SC_USE_UV_TRANSFORM_iconMap==1
#undef SC_USE_UV_TRANSFORM_iconMap
#define SC_USE_UV_TRANSFORM_iconMap 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_iconMap
#define SC_SOFTWARE_WRAP_MODE_U_iconMap -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_iconMap
#define SC_SOFTWARE_WRAP_MODE_V_iconMap -1
#endif
#ifndef SC_USE_UV_MIN_MAX_iconMap
#define SC_USE_UV_MIN_MAX_iconMap 0
#elif SC_USE_UV_MIN_MAX_iconMap==1
#undef SC_USE_UV_MIN_MAX_iconMap
#define SC_USE_UV_MIN_MAX_iconMap 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_iconMap
#define SC_USE_CLAMP_TO_BORDER_iconMap 0
#elif SC_USE_CLAMP_TO_BORDER_iconMap==1
#undef SC_USE_CLAMP_TO_BORDER_iconMap
#define SC_USE_CLAMP_TO_BORDER_iconMap 1
#endif
#ifndef sc_PointLightsCount
#define sc_PointLightsCount 0
#endif
...
#endif
float l9_0=(((hover-Port_RangeMinA_N023)/(Port_RangeMaxA_N023-Port_RangeMinA_N023))*(Port_RangeMaxB_N023-Port_RangeMinB_N023))+Port_RangeMinB_N023;
float l9_1;
if (Port_RangeMaxB_N023>Port_RangeMinB_N023)
{
l9_1=clamp(l9_0,Port_RangeMinB_N023,Port_RangeMaxB_N023);
}
else
{
l9_1=clamp(l9_0,Port_RangeMaxB_N023,Port_RangeMinB_N023);
}
vec4 l9_2=vec4(l9_1);
float l9_3=(((hover-Port_RangeMinA_N016)/(Port_RangeMaxA_N016-Port_RangeMinA_N016))*(Port_RangeMaxB_N016-Port_RangeMinB_N016))+Port_RangeMinB_N016;
float l9_4;
if (Port_RangeMaxB_N016>Port_RangeMinB_N016)
{
l9_4=clamp(l9_3,Port_RangeMinB_N016,Port_RangeMaxB_N016);
}
else
{
l9_4=clamp(l9_3,Port_RangeMaxB_N016,Port_RangeMinB_N016);
}
vec2 l9_5=vec2(l9_4);
vec2 l9_6=((varPackedTex.xy-Port_Center_N014)*l9_5)+Port_Center_N014;
int l9_7;
...
float l9_29=l9_28;
vec3 l9_30=sc_SamplingCoordsViewToGlobal(vec2(l9_25,l9_27),baseTexLayout,l9_7);
...
#endif
float l9_33=(((hover-Port_RangeMinA_N017)/(Port_RangeMaxA_N017-Port_RangeMinA_N017))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017;
float l9_34;
if (Port_RangeMaxB_N017>Port_RangeMinB_N017)
{
l9_34=clamp(l9_33,Port_RangeMinB_N017,Port_RangeMaxB_N017);
}
else
{
l9_34=clamp(l9_33,Port_RangeMaxB_N017,Port_RangeMinB_N017);
}
float l9_35=l9_32.x*l9_34;
int l9_36;
#if (iconMapHasSwappedViews)
{
...
#endif
float l9_37=l9_8;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_iconMap,SC_SOFTWARE_WRAP_MODE_V_iconMap).x);
float l9_38=l9_37;
float l9_39=l9_11;
sc_SoftwareWrapEarly(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_iconMap,SC_SOFTWARE_WRAP_MODE_V_iconMap).y);
float l9_40=l9_39;
vec2 l9_41;
float l9_42;
#if (SC_USE_UV_MIN_MAX_iconMap)
{
bool l9_43;
#if (SC_USE_CLAMP_TO_BORDER_iconMap)
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_iconMap,SC_SOFTWARE_WRAP_MODE_V_iconMap).x==3;
}
#else
{
l9_43=(int(SC_USE_CLAMP_TO_BORDER_iconMap)!=0);
}
#endif
float l9_44=l9_38;
float l9_45=1.0;
sc_ClampUV(l9_44,iconMapUvMinMax.x,iconMapUvMinMax.z,l9_43,l9_45);
float l9_46=l9_44;
float l9_47=l9_45;
bool l9_48;
#if (SC_USE_CLAMP_TO_BORDER_iconMap)
{
l9_48=ivec2(SC_SOFTWARE_WRAP_MODE_U_iconMap,SC_SOFTWARE_WRAP_MODE_V_iconMap).y==3;
}
#else
{
l9_48=(int(SC_USE_CLAMP_TO_BORDER_iconMap)!=0);
}
#endif
float l9_49=l9_40;
float l9_50=l9_47;
sc_ClampUV(l9_49,iconMapUvMinMax.y,iconMapUvMinMax.w,l9_48,l9_50);
l9_42=l9_50;
...
#endif
vec2 l9_51=sc_TransformUV(l9_41,(int(SC_USE_UV_TRANSFORM_iconMap)!=0),iconMapTransform);
float l9_52=l9_51.x;
float l9_53=l9_42;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_iconMap,SC_SOFTWARE_WRAP_MODE_V_iconMap).x,(int(SC_USE_CLAMP_TO_BORDER_iconMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iconMap)!=0)),l9_53);
float l9_54=l9_51.y;
float l9_55=l9_53;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_iconMap,SC_SOFTWARE_WRAP_MODE_V_iconMap).y,(int(SC_USE_CLAMP_TO_BORDER_iconMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iconMap)!=0)),l9_55);
float l9_56=l9_55;
vec3 l9_57=sc_SamplingCoordsViewToGlobal(vec2(l9_52,l9_54),iconMapLayout,l9_36);
vec4 l9_58=texture2D(iconMap,l9_57.xy,0.0);
vec4 l9_59;
#if (SC_USE_CLAMP_TO_BORDER_iconMap)
{
l9_59=mix(iconMapBorderColor,l9_58,vec4(l9_56));
}
#else
{
l9_59=l9_58;
...
#endif
vec3 l9_60=mix(mix(strokeColor,selectedColor,l9_2).xyz,iconColor.xyz,vec3(l9_59.x));
float l9_61=(clamp((l9_35+l9_59.x)+0.001,Port_Input1_N013+0.001,Port_Input2_N013+0.001)-0.001)*globalOpacity;
vec4 l9_62=vec4(l9_60.x,l9_60.y,l9_60.z,vec4(0.0).w);
l9_62.w=l9_61;
#if (sc_BlendMode_AlphaTest)
{
if (l9_61<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_61<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_66=clamp(dot(l9_62.xyz,vec3(l9_61)),0.0,1.0);
}
#else
{
float l9_67;
...
{
l9_68=(1.0-dot(l9_62.xyz,vec3(0.33333001)))*l9_61;
}
#else
{
float l9_69;
...
{
l9_69=(1.0-clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0))*l9_61;
}
#else
{
float l9_70;
...
{
l9_70=clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0)*l9_61;
}
#else
{
float l9_71;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_72=clamp(dot(l9_62.xyz,vec3(1.0)),0.0,1.0)*l9_61;
}
#else
{
float l9_73;
...
{
l9_73=dot(l9_62.xyz,vec3(0.33333001))*l9_61;
}
#else
{
float l9_74;
...
#endif
l9_78=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_82,sc_ScreenTextureLayout,l9_83).xy,0.0);
}
#endif
vec4 l9_84;
...
{
vec4 l9_85=l9_78;
l9_85.x=l9_78.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_84=l9_85;
}
#else
{
...
#endif
vec3 l9_86=mix(l9_84.xyz,definedBlend(l9_84.xyz,l9_62.xyz).xyz,vec3(l9_61));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_88=vec4(mix(vec3(1.0),l9_62.xyz,vec3(l9_61)),l9_61);
}
#else
{
vec4 l9_89;
...
#endif
l9_89=vec4(l9_62.xyz*l9_90,l9_90);
}
#else
{
l9_89=l9_62;
