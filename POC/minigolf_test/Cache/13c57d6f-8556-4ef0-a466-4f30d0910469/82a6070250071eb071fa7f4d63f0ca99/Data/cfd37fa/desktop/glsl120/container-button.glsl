...
#endif
float l9_6=l9_4.x;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_7=l9_6;
float l9_8=l9_4.y;
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_9=l9_8;
vec2 l9_10;
float l9_11;
...
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_13=l9_7;
float l9_14=1.0;
sc_ClampUV(l9_13,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_12,l9_14);
float l9_15=l9_13;
float l9_16=l9_14;
bool l9_17;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_17=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_18=l9_9;
float l9_19=l9_16;
sc_ClampUV(l9_18,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_17,l9_19);
l9_11=l9_19;
...
#endif
vec2 l9_20=sc_TransformUV(l9_10,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_21=l9_20.x;
float l9_22=l9_11;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_22);
float l9_23=l9_20.y;
float l9_24=l9_22;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_24);
float l9_25=l9_24;
vec3 l9_26=sc_SamplingCoordsViewToGlobal(vec2(l9_21,l9_23),additional_settings_btn_refl_texLayout,l9_5);
vec4 l9_27=texture2D(additional_settings_btn_refl_tex,l9_26.xy,0.0);
vec4 l9_28;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_28=mix(additional_settings_btn_refl_texBorderColor,l9_27,vec4(l9_25));
}
#else
{
l9_28=l9_27;
...
#endif
float l9_29=length((vec4(normalize((sc_ModelMatrixInverse*l9_1).xyz).xy,0.0,0.0).xy*Port_Input1_N009)+Port_Input2_N009);
vec4 l9_30=mix(Port_Value_N026,Port_Value_N027,vec4(triggered));
vec4 l9_31=max(l9_30,Port_Input1_N019);
float l9_32=clamp(l9_29,0.0,1.0);
vec4 l9_33;
if (l9_32<Port_Position1_N007)
{
l9_33=mix(l9_30,l9_31,vec4(clamp(l9_32/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_34;
if (l9_32<Port_Position2_N007)
{
l9_34=mix(l9_31,Port_Value2_N007,vec4(clamp((l9_32-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_34=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_32-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_33=l9_34;
}
...
vec4 l9_39=l9_28+l9_33;
vec4 l9_40=baseColor*l9_33;
float l9_41=clamp((l9_29*Port_Input1_N031)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
float l9_42;
if (l9_41<=0.0)
{
l9_42=0.0;
...
{
l9_42=pow(l9_41,Port_Input1_N022);
}
float l9_43;
if (l9_42<=0.0)
{
...
{
l9_43=pow(l9_42,Port_Input1_N034);
}
float l9_44=l9_43*Port_Input1_N041;
vec2 l9_45=((varPackedTex.xy-Port_Center_N002)*iconScale)+Port_Center_N002;
int l9_46;
...
float l9_48=l9_47;
float l9_49=l9_45.y;
sc_SoftwareWrapEarly(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_50=l9_49;
vec2 l9_51;
float l9_52;
...
{
l9_53=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_53=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_54=l9_48;
float l9_55=1.0;
sc_ClampUV(l9_54,iconUvMinMax.x,iconUvMinMax.z,l9_53,l9_55);
float l9_56=l9_54;
float l9_57=l9_55;
bool l9_58;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_59=l9_50;
float l9_60=l9_57;
sc_ClampUV(l9_59,iconUvMinMax.y,iconUvMinMax.w,l9_58,l9_60);
l9_52=l9_60;
...
#endif
vec2 l9_61=sc_TransformUV(l9_51,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_62=l9_61.x;
float l9_63=l9_52;
sc_SoftwareWrapLate(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_63);
float l9_64=l9_61.y;
float l9_65=l9_63;
sc_SoftwareWrapLate(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_65);
float l9_66=l9_65;
vec3 l9_67=sc_SamplingCoordsViewToGlobal(vec2(l9_62,l9_64),iconLayout,l9_46);
vec4 l9_68=texture2D(icon,l9_67.xy,0.0);
vec4 l9_69;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_69=mix(iconBorderColor,l9_68,vec4(l9_66));
}
#else
{
l9_69=l9_68;
...
#endif
vec4 l9_70=mix(mix(mix(baseColor*(l9_39*vec4(Port_Input1_N014)),clamp((vec4(Port_Input0_N038)-l9_40)+vec4(0.001),Port_Input1_N043+vec4(0.001),Port_Input2_N043+vec4(0.001))-vec4(0.001),vec4(isToggle*triggered)),hoverColor,vec4(hovered*l9_44)),vec4(l9_69.xyz,0.0),vec4(l9_69.w));
float l9_71=max(l9_42,mix(Port_Input0_N018,Port_Input1_N018,triggered));
float l9_72=max(l9_69.w,l9_71)*alpha;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_108-0.0039215689)),min(1.0,l9_108+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_110),packValue(l9_110),packValue(l9_110),packValue(l9_110)));
