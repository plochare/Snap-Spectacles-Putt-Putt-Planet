...
float l9_5=N15_ReflectionUV.x;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_6=l9_5;
float l9_7=N15_ReflectionUV.y;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
...
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_26=texture2D(planet_refl_map,l9_25.xy,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_27=mix(planet_refl_mapBorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
vec4 l9_28=(vec4(reflIntensity)*l9_27)+param_10;
vec2 l9_29=Port_Import_N060-Port_Import_N058;
vec4 l9_30=vec4(l9_28.x,l9_28.y,l9_28.z,vec4(0.0).w);
l9_30.w=mix(vec4(l9_28.w),Port_Input1_N029,mix(Port_Import_N038,Port_Import_N031,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot((((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N033))/vec2(Port_RangeMaxA_N033-Port_RangeMinA_N033))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Globals.Surface_UVCoord0)+Port_Center_N047)-Port_Import_N058,l9_29)/dot(l9_29,l9_29))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001)))).x;
Value1=l9_30;
Result=Value1;
}
#else
...
N15_NormalSpace=1;
N15_Normal=Port_Import_N013;
vec3 l9_31=N15_Normal;
vec3 l9_32;
if (N15_NormalSpace==1)
{
l9_32=normalize(mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_31);
}
else
{
l9_32=l9_31;
}
vec3 l9_33=normalize(-Globals.ViewDirWS);
vec3 l9_34=normalize(cross(l9_33,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_35=cross(l9_34,l9_33);
N15_ReflectionUV=((mat3(vec3(l9_34.x,l9_35.x,l9_33.x),vec3(l9_34.y,l9_35.y,l9_33.y),vec3(l9_34.z,l9_35.z,l9_33.z))*l9_32).xy*0.5)+vec2(0.5);
float l9_36=N15_ReflectionUV.x;
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_37=l9_36;
float l9_38=N15_ReflectionUV.y;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_39=l9_38;
vec2 l9_40;
float l9_41;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_43=l9_37;
float l9_44=1.0;
sc_ClampUV(l9_43,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_42,l9_44);
float l9_45=l9_43;
float l9_46=l9_44;
bool l9_47;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_47=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_48=l9_39;
float l9_49=l9_46;
sc_ClampUV(l9_48,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_47,l9_49);
l9_41=l9_49;
...
#endif
vec2 l9_50=sc_TransformUV(l9_40,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_51=l9_50.x;
float l9_52=l9_41;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_52);
float l9_53=l9_50.y;
float l9_54=l9_52;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_54);
float l9_55=l9_54;
vec3 l9_56=sc_SamplingCoordsViewToGlobal(vec2(l9_51,l9_53),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_57=texture2D(planet_refl_map,l9_56.xy,0.0);
vec4 l9_58;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_58=mix(planet_refl_mapBorderColor,l9_57,vec4(l9_55));
}
#else
{
l9_58=l9_57;
...
Default=(vec4(reflIntensity)*l9_58)+param_22;
Result=Default;
}
#endif
}
...
#endif
float l9_7=varPackedTex.z;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_8=l9_7;
float l9_9=varPackedTex.w;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
...
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),Tweak_N6Layout,l9_6);
vec4 l9_28=texture2D(Tweak_N6,l9_27.xy,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_29=mix(Tweak_N6BorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
#endif
vec3 l9_30=mix(l9_5.xyz,(l9_29.xyz*l9_5.xyz).xyz,vec3(l9_29.w));
...
{
l9_34=clamp(l9_5.w*2.0,0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_35=clamp(dot(l9_31.xyz,vec3(l9_5.w)),0.0,1.0);
}
#else
{
float l9_36;
...
{
l9_37=(1.0-dot(l9_31.xyz,vec3(0.33333001)))*l9_5.w;
}
#else
{
float l9_38;
...
{
l9_38=(1.0-clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0))*l9_5.w;
}
#else
{
float l9_39;
...
{
l9_39=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_40;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_41=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_42;
...
{
l9_42=dot(l9_31.xyz,vec3(0.33333001))*l9_5.w;
}
#else
{
float l9_43;
...
#endif
vec3 l9_55=mix(l9_53.xyz,definedBlend(l9_53.xyz,l9_31.xyz).xyz,vec3(l9_5.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_57=vec4(mix(vec3(1.0),l9_31.xyz,vec3(l9_5.w)),l9_5.w);
}
#else
{
vec4 l9_58;
