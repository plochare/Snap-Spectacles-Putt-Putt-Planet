...
vec2 l9_11=((mat3(vec3(l9_9.x,l9_10.x,l9_8.x),vec3(l9_9.y,l9_10.y,l9_8.y),vec3(l9_9.z,l9_10.z,l9_8.z))*normalize(mat3(l9_4,l9_5,l9_3)*Port_Import_N013)).xy*0.5)+vec2(0.5);
int l9_12;
...
#endif
float l9_13=l9_11.x;
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_14=l9_13;
float l9_15=l9_11.y;
sc_SoftwareWrapEarly(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_16=l9_15;
vec2 l9_17;
float l9_18;
...
{
l9_19=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
...
float l9_20=l9_14;
float l9_21=1.0;
sc_ClampUV(l9_20,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_19,l9_21);
float l9_22=l9_20;
float l9_23=l9_21;
bool l9_24;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_24=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_25=l9_16;
float l9_26=l9_23;
sc_ClampUV(l9_25,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_24,l9_26);
l9_18=l9_26;
...
#endif
vec2 l9_27=sc_TransformUV(l9_17,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_28=l9_27.x;
float l9_29=l9_18;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_29);
float l9_30=l9_27.y;
float l9_31=l9_29;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_31);
float l9_32=l9_31;
vec3 l9_33=sc_SamplingCoordsViewToGlobal(vec2(l9_28,l9_30),planet_refl_mapLayout,l9_12);
vec4 l9_34=texture2D(planet_refl_map,l9_33.xy,0.0);
vec4 l9_35;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_35=mix(planet_refl_mapBorderColor,l9_34,vec4(l9_32));
}
#else
{
l9_35=l9_34;
...
#endif
vec4 l9_36=vec4(reflIntensity)*l9_35;
vec4 l9_37;
#if (Tweak_N37)
{
vec2 l9_38;
Node3_Rotate_Coords(varPackedTex.xy,Port_Rotation_N003,Port_Center_N003,l9_38,l9_7);
vec4 l9_39;
Node0_Gradient(l9_38.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_39,l9_7);
vec4 l9_40=l9_39;
vec2 l9_41=(((varPackedTex.xy+Port_Offset_N062)-Port_Center_N060)*vec2(Tweak_N66*Tweak_N64,Tweak_N64))+Port_Center_N060;
int l9_42;
...
#endif
float l9_43=l9_41.x;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x);
float l9_44=l9_43;
float l9_45=l9_41.y;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y);
float l9_46=l9_45;
vec2 l9_47;
float l9_48;
...
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_50=l9_44;
float l9_51=1.0;
sc_ClampUV(l9_50,Tweak_N25UvMinMax.x,Tweak_N25UvMinMax.z,l9_49,l9_51);
float l9_52=l9_50;
float l9_53=l9_51;
bool l9_54;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_54=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y==3;
}
#else
{
l9_54=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_55=l9_46;
float l9_56=l9_53;
sc_ClampUV(l9_55,Tweak_N25UvMinMax.y,Tweak_N25UvMinMax.w,l9_54,l9_56);
l9_48=l9_56;
...
#endif
vec2 l9_57=sc_TransformUV(l9_47,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform);
float l9_58=l9_57.x;
float l9_59=l9_48;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0)),l9_59);
float l9_60=l9_57.y;
float l9_61=l9_59;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0)),l9_61);
float l9_62=l9_61;
vec3 l9_63=sc_SamplingCoordsViewToGlobal(vec2(l9_58,l9_60),Tweak_N25Layout,l9_42);
vec4 l9_64=texture2D(Tweak_N25,l9_63.xy,0.0);
vec4 l9_65;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_65=mix(Tweak_N25BorderColor,l9_64,vec4(l9_62));
}
#else
{
l9_65=l9_64;
...
#endif
l9_37=vec4(mix(l9_40.xyz,l9_65.xyz,vec3(l9_65.w)),0.0);
}
#else
{
vec2 l9_66;
Node3_Rotate_Coords(varPackedTex.xy,Port_Rotation_N003,Port_Center_N003,l9_66,l9_7);
vec4 l9_67;
Node0_Gradient(l9_66.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_67,l9_7);
l9_37=l9_67;
}
#endif
vec4 l9_68=l9_36+l9_37;
int l9_69;
...
float l9_85=l9_84.x;
float l9_86=l9_75;
sc_SoftwareWrapLate(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_86);
float l9_87=l9_84.y;
float l9_88=l9_86;
sc_SoftwareWrapLate(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_88);
float l9_89=l9_88;
vec3 l9_90=sc_SamplingCoordsViewToGlobal(vec2(l9_85,l9_87),Tweak_N6Layout,l9_69);
