...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N25 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N6 32
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33
//spec_const bool SC_USE_CLAMP_TO_BORDER_planet_refl_map 34
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N25 35
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N6 36
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 37
//spec_const bool SC_USE_UV_MIN_MAX_planet_refl_map 38
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N25 39
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N6 40
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 41
//spec_const bool SC_USE_UV_TRANSFORM_planet_refl_map 42
//spec_const bool Tweak_N25HasSwappedViews 43
//spec_const bool Tweak_N37 44
//spec_const bool Tweak_N6HasSwappedViews 45
//spec_const bool UseViewSpaceDepthVariant 46
//spec_const bool intensityTextureHasSwappedViews 47
//spec_const bool planet_refl_mapHasSwappedViews 48
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 79
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 80
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 82
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 83
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 84
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 86
//spec_const int Tweak_N25Layout 87
//spec_const int Tweak_N6Layout 88
//spec_const int intensityTextureLayout 89
//spec_const int planet_refl_mapLayout 90
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 [[function_constant(80)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map [[function_constant(82)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 [[function_constant(83)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 [[function_constant(84)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map [[function_constant(86)]];
...
constant int Tweak_N25Layout [[function_constant(87)]];
constant int Tweak_N25Layout_tmp = is_function_constant_defined(Tweak_N25Layout) ? Tweak_N25Layout : 0;
constant int Tweak_N6Layout [[function_constant(88)]];
...
constant int planet_refl_mapLayout [[function_constant(90)]];
...
float l9_96=l9_88;
float4 l9_97=sc_set0.planet_refl_map.sample(sc_set0.planet_refl_mapSmpSC,l9_95,bias(l9_96));
float4 l9_98=l9_97;
float4 l9_99=l9_98;
if (param_13)
{
...
float l9_104=(*sc_set0.UserUniforms).Port_Rotation_N003;
float2 l9_105=(*sc_set0.UserUniforms).Port_Center_N003;
...
float4 l9_110=(*sc_set0.UserUniforms).Tweak_N2;
l9_109=l9_110;
float l9_111=0.0;
float l9_112=(*sc_set0.UserUniforms).colorRatio;
l9_111=l9_112;
float4 l9_113=float4(0.0);
float4 l9_114=(*sc_set0.UserUniforms).Tweak_N8;
l9_113=l9_114;
float4 l9_115=float4(0.0);
float4 l9_116=(*sc_set0.UserUniforms).Tweak_N9;
l9_115=l9_116;
...
bool l9_124=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_125;
if (l9_124)
{
...
if (l9_125)
{
l9_126=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_126=l9_125;
...
l9_127=l9_101+(*sc_set0.UserUniforms).Port_Offset_N062;
float l9_128=0.0;
float l9_129=(*sc_set0.UserUniforms).Tweak_N66;
l9_128=l9_129;
float l9_130=0.0;
float l9_131=(*sc_set0.UserUniforms).Tweak_N64;
l9_130=l9_131;
float l9_132=0.0;
...
l9_134=((l9_127-(*sc_set0.UserUniforms).Port_Center_N060)*l9_133)+(*sc_set0.UserUniforms).Port_Center_N060;
float4 l9_135=float4(0.0);
int l9_136=0;
...
float3x3 l9_146=(*sc_set0.UserUniforms).Tweak_N25Transform;
...
float4 l9_149=(*sc_set0.UserUniforms).Tweak_N25UvMinMax;
bool l9_150=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25_tmp)!=0);
float4 l9_151=(*sc_set0.UserUniforms).Tweak_N25BorderColor;
float l9_152=0.0;
...
float l9_222=l9_214;
float4 l9_223=sc_set0.Tweak_N25.sample(sc_set0.Tweak_N25SmpSC,l9_221,bias(l9_222));
...
float l9_236=(*sc_set0.UserUniforms).Port_Rotation_N003;
float2 l9_237=(*sc_set0.UserUniforms).Port_Center_N003;
...
float4 l9_242=(*sc_set0.UserUniforms).Tweak_N2;
l9_241=l9_242;
float l9_243=0.0;
float l9_244=(*sc_set0.UserUniforms).colorRatio;
l9_243=l9_244;
float4 l9_245=float4(0.0);
float4 l9_246=(*sc_set0.UserUniforms).Tweak_N8;
l9_245=l9_246;
float4 l9_247=float4(0.0);
float4 l9_248=(*sc_set0.UserUniforms).Tweak_N9;
l9_247=l9_248;
...
bool l9_256=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_257;
if (l9_256)
{
...
if (l9_257)
{
l9_258=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_258=l9_257;
...
float l9_334=l9_326;
float4 l9_335=sc_set0.Tweak_N6.sample(sc_set0.Tweak_N6SmpSC,l9_333,bias(l9_334));
...
bool l9_344=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_344)
{
...
float l9_349=l9_348;
float l9_350=l9_349;
float l9_351=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_350;
float3 l9_352=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_346.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_358.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_361=l9_360.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_398=l9_390;
float4 l9_399=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_397,bias(l9_398));
...
float3 l9_409=definedBlend(l9_407,l9_408,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_417=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_417=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_419.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
