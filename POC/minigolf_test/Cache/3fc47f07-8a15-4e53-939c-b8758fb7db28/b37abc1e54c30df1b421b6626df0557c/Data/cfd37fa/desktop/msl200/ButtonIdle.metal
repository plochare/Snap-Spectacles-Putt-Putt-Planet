...
if (l9_93)
{
l9_94=7==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_94=l9_93;
...
float l9_170=l9_162;
float4 l9_171=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_169,bias(l9_170));
...
float l9_175=0.0;
float l9_176=float((*sc_set0.UserUniforms).iconEnabled!=0);
l9_175=l9_176;
param_42=l9_175;
float param_45;
if ((param_42*1.0)!=0.0)
...
l9_178=((l9_177-(*sc_set0.UserUniforms).Port_Center_N002)*(*sc_set0.UserUniforms).Port_Scale_N002)+(*sc_set0.UserUniforms).Port_Center_N002;
...
float3x3 l9_190=(*sc_set0.UserUniforms).iconTransform;
...
float4 l9_193=(*sc_set0.UserUniforms).iconUvMinMax;
bool l9_194=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 l9_195=(*sc_set0.UserUniforms).iconBorderColor;
float l9_196=0.0;
...
float l9_266=l9_258;
float4 l9_267=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_265,bias(l9_266));
...
bool l9_277=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_277)
{
...
float l9_282=l9_281;
float l9_283=l9_282;
float l9_284=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_283;
float3 l9_285=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_279.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_291.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_294=l9_293.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_331=l9_323;
float4 l9_332=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_330,bias(l9_331));
...
float3 l9_342=definedBlend(l9_340,l9_341,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_350=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_350=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_352.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
