...
export class BallArcBehavior extends BaseScriptComponent {
    ...
    */
    ...
    displayStroke(){
        ...
        this.t8Object.getTransform().setLocalPosition(new vec3(this.startpoint.getTransform().getWorldPosition().x + this.dragDistance*Math.sin(this.launchAngle), 0, this.startpoint.getTransform().getWorldPosition().z + this.dragDistance*Math.cos(this.launchAngle)))
