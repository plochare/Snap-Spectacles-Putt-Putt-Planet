...
export class BallArcBehavior extends BaseScriptComponent {
    ...
    */
    ...
    displayStroke(){
        ...
        //
        const dragHeight = dragpoint.z - startpoint.z
        const dragDistance = dragpoint.x - startpoint.x

        const launchAngle = this.calculateAngle(this.dragObject.getTransform().getWorldPosition(), this.targetObject.getTransform().getWorldPosition())
        const rotationQuaternion = quat.quatFromEuler(0,launchAngle,0)
        
        //this.t8Object.getTransform().setWorldRotation(this.rotationQuaternion)
