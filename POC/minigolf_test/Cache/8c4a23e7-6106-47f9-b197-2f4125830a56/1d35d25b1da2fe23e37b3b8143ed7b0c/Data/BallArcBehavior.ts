...
export class BallArcBehavior extends BaseScriptComponent {
  ...
  private calculateMidpoint(pos1: vec3, pos2: vec3): vec3 {
    ...
    displayArc(){
        ...
        this.t0Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.1*dragDistance, 0, startpoint.y + 0.1*dragHeight))
        this.t1Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.2*dragDistance, 0, startpoint.y + 0.2*dragHeight))
        this.t2Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.3*dragDistance, 0, startpoint.y + 0.3*dragHeight))
        this.t3Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.4*dragDistance, 0, startpoint.y + 0.4*dragHeight))
        this.t4Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.5*dragDistance, 0, startpoint.y + 0.5*dragHeight))
        this.t5Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.6*dragDistance, 0, startpoint.y + 0.6*dragHeight))
        this.t6Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.7*dragDistance, 0, startpoint.y + 0.7*dragHeight))
        this.t7Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.8*dragDistance, 0, startpoint.y + 0.9*dragHeight))
        this.t8Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.9*dragDistance, 0, startpoint.y + 0.9*dragHeight))
        //
