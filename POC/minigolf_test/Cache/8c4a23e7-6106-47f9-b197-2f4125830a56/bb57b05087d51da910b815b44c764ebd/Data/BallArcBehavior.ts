...
export class BallArcBehavior extends BaseScriptComponent {
    ...
    */
    ...
    moveBall(){
        let velx = Math.sqrt(Math.abs(2.0 * this.GRAVITY * this.arcHeight))
        let velz = vertVelocity / Math.tan(this.launchAngleRad) 
    ...
    displayStroke(){
        ...
        this.clubObject.getTransform().setLocalPosition(new vec3(startpoint.x + dragDistance*Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + dragDistance*Math.sin((launchAngle) * 0.0174533)))
