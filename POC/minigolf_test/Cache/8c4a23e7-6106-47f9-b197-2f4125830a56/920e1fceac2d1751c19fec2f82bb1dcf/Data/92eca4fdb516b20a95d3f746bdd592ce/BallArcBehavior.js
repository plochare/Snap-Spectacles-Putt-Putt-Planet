...
let BallArcBehavior = class BallArcBehavior extends BaseScriptComponent {
    ...
    onUpdate() {
        ...
        */
        /*
        if (this.gamestate = "ballMove1"){
            if (this.ballObject.getComponent("Physics.BodyComponent").velocity.x<0.001 && this.ballObject.getComponent("Physics.BodyComponent").velocity.z<0.001){
    ...
    moveBall() {
        let velx = 25 * Math.cos((this.ballAngle) * -0.0174533);
        let velz = -25 * Math.sin((this.ballAngle) * -0.0174533);
    ...
    displayStroke() {
        ...
        this.clubObject.getTransform().setLocalPosition(new vec3(startpoint.x + dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        this.t2Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.15 * dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + 0.15 * dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        this.t3Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.25 * dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + 0.25 * dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        this.t4Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.35 * dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + 0.35 * dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        this.t5Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.45 * dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + 0.45 * dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        this.t6Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.55 * dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + 0.55 * dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        this.t7Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.65 * dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + 0.65 * dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        this.t8Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.75 * dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + 0.75 * dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        this.t9Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.85 * dragDistance * Math.cos((this.ballAngle) * -0.0174533), 0, startpoint.z + 0.85 * dragDistance * Math.sin((this.ballAngle) * 0.0174533)));
        //
