...
export class BallArcBehavior extends BaseScriptComponent {
    ...
    */
    ...
    displayStroke(){
        ...
        this.t8Object.getTransform().setLocalPosition(new vec3(this.startpoint.x + this.dragDistance*Math.sin(launchAngle), 0, this.startpoint.z + this.dragDistance*Math.cos(launchAngle)))
