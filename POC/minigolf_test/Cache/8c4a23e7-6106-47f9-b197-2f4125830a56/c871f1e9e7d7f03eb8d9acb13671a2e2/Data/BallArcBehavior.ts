...
export class BallArcBehavior extends BaseScriptComponent {
  ...
  private calculateMidpoint(pos1: vec3, pos2: vec3): vec3 {
    ...
    public arcControllerAngle = 360-50 + 90
    ...
    onTriggerEnd() {
        ...
        let arcAngleRad = this.arcControllerAngle * (Math.PI / 180) 
        ...
        this.ballObject.getComponent("Physics.BodyComponent").velocity = new vec3(horizVelocity * Math.cos(arcAngleRad), vertVelocity, horizVelocity * Math.sin(arcAngleRad))
