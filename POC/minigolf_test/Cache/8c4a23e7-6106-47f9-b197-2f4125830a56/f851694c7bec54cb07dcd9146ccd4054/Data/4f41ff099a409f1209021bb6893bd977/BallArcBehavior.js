...
let BallArcBehavior = class BallArcBehavior extends BaseScriptComponent {
    ...
    displayStroke() {
        ...
        this.t1Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.15 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.1 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t2Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.25 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.2 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t3Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.35 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.3 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t4Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.45 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.4 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t5Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.55 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.5 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t6Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.65 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.6 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t7Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.75 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.7 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t8Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.85 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.8 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
