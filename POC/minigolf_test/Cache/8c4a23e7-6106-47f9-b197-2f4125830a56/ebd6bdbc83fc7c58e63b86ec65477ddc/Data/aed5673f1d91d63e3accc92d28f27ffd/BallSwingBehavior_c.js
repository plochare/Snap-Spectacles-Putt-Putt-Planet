...
// @input Component.Text currentScoreText
checkUndefined("currentScoreText", []);
// @input Component.Text highScoreText
checkUndefined("highScoreText", []);
...
// @input Component.AudioComponent bounce2audio
checkUndefined("bounce2audio", []);
// @input Component.AudioComponent bounce3audio
checkUndefined("bounce3audio", []);
// @input Component.AudioComponent backboardaudio
checkUndefined("backboardaudio", []);
...
// @input SceneObject puttContainer
checkUndefined("puttContainer", []);
...
// @input SceneObject t9Object
checkUndefined("t9Object", []);
// @input SceneObject clubObject
checkUndefined("clubObject", []);
...
var Module = require("../../../../../Modules/Src/Assets/GameAssets/Scripts/BallSwingBehavior");
Object.setPrototypeOf(script, Module.BallSwingBehavior.prototype);
script.__initialize();
if (script.onAwake) {
   script.onAwake();
}
