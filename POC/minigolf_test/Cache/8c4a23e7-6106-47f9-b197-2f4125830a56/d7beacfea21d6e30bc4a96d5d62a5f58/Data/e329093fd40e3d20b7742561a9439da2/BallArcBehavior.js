...
let BallArcBehavior = class BallArcBehavior extends BaseScriptComponent {
    ...
    onTriggerEnd() {
        ...
        let vertVelocity = Math.sqrt(Math.abs(2.0 * this.GRAVITY * this.arcHeight)) * 4.55;
        ...
        this.ballObject.getComponent("Physics.BodyComponent").velocity = new vec3(horizVelocity, vertVelocity, 0.0);
