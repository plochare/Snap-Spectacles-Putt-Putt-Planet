...
export class BallArcBehavior extends BaseScriptComponent {
    ...
    */
    ...
    displayStroke(){
        ...
        this.t8Object.getTransform().setWorldPosition(new vec3(this.startpoint.getTransform().getWorldPosition().x, 0, this.startpoint.getTransform().getWorldPosition().z))
