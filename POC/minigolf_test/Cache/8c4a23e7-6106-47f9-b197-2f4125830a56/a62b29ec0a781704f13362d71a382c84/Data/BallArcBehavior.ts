...
export class BallArcBehavior extends BaseScriptComponent {
  ...
  private calculateMidpoint(pos1: vec3, pos2: vec3): vec3 {
    ...
    displayArc(){
        ...
        const midpoint = this.calculateMidpoint(this.dragObject.getTransform().getWorldPosition(), this.startpoint.getTransform().getWorldPosition())
        this.t8Object.getTransform().setLocalPosition(new vec3(midpoint.x, 0, midpoint.z))
