...
let BallArcBehavior = class BallArcBehavior extends BaseScriptComponent {
    ...
    moveBall() {
        let velx = 40 * Math.cos((this.ballAngle) * -0.0174533);
        let velz = 40 * Math.sin((this.ballAngle) * -0.0174533);
        ...
        this.ballObject.getComponent("Physics.BodyComponent").velocity = new vec3(0, 0, 0);
    }
    displayStroke() {
