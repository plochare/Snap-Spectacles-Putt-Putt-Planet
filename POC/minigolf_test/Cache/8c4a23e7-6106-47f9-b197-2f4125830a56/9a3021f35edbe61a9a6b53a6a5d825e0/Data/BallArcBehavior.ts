  ...
  private calculateMidpoint(pos1: vec3, pos2: vec3): vec3 {
    ...
    onAwake() {
        ...
        */
        ...
        this.currentScoreText.text = currentScoreVal.toString()
        this.highScoreText.text = highScoreVal.toString()
        this.timerText.text = timerVal.toString()
        // 
