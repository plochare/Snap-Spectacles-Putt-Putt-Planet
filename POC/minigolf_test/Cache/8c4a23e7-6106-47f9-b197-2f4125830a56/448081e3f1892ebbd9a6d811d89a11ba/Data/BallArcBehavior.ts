...
export class BallArcBehavior extends BaseScriptComponent {
    ...
    */
    ...
    displayStroke(){
        ...
        this.t8Object.getTransform().setLocalRotation(quat.quatFromEuler(0,launchAngle,0))
        
        this.t8Object.getTransform().setWorldPosition(new vec3(this.startpoint.getTransform().getWorldPosition().x + dragDistance*Math.sin(launchAngle), 0, this.startpoint.getTransform().getWorldPosition().z + dragDistance*Math.cos(launchAngle)))
