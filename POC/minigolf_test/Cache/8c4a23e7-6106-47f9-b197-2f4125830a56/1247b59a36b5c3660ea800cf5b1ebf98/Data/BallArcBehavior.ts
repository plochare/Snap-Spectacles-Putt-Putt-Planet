...
export class BallArcBehavior extends BaseScriptComponent {
  ...
  private calculateMidpoint(pos1: vec3, pos2: vec3): vec3 {
    ...
    public arcControllerAngle = -50 - 90
    ...
    onTriggerEnd() {
        ...
        this.ballObject.getComponent("Physics.BodyComponent").velocity = new vec3(-1 * horizVelocity * Math.cos(arcAngleRad), vertVelocity, -1 * horizVelocity * Math.sin(arcAngleRad))
