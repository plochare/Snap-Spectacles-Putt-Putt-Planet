...
export class BallArcBehavior extends BaseScriptComponent {
    ...
    */
    ...
    displayStroke(){
        ...
        this.t8Object.getTransform().setLocalPosition(new vec3(this.dragObject.getTransform().getWorldPosition().x, 0, this.dragObject.getTransform().getWorldPosition().z))
