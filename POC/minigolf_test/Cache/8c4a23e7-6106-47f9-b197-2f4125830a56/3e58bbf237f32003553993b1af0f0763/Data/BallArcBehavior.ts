...
export class BallArcBehavior extends BaseScriptComponent {
  ...
  private calculateMidpoint(pos1: vec3, pos2: vec3): vec3 {
    ...
    displayArc(){
        ...
        this.t0Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.1*dragDistance, startpoint.y + 0.19*dragHeight))
        this.t1Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.2*dragDistance, startpoint.y + 0.36*dragHeight))
        this.t2Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.3*dragDistance, startpoint.y + 0.51*dragHeight))
        this.t3Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.4*dragDistance, startpoint.y + 0.64*dragHeight))
        this.t4Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.5*dragDistance, startpoint.y + 0.75*dragHeight))
        this.t5Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.6*dragDistance, startpoint.y + 0.84*dragHeight))
        this.t6Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.7*dragDistance, startpoint.y + 0.91*dragHeight))
        this.t7Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.8*dragDistance, startpoint.y + 0.96*dragHeight))
        this.t8Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.9*dragDistance, startpoint.y + 0.99*dragHeight))
        //
