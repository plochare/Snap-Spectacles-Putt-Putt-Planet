...
export class BallArcBehavior extends BaseScriptComponent {
    ...
    */
    ...
    displayStroke(){
        ...
        this.t8Object.getTransform().setLocalPosition(new vec3(startpoint.x + dragDistance*Math.cos((launchAngle+90) * -0.0174533), 0, startpoint.z + dragDistance*Math.sin((launchAngle+90) * -0.0174533)))
