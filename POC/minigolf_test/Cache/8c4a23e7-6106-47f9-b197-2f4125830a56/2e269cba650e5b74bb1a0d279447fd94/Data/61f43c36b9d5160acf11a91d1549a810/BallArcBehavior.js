...
let BallArcBehavior = class BallArcBehavior extends BaseScriptComponent {
    ...
    onUpdate() {
        ...
        */
        ...
        // if club in motion with 
        // this.lerptime += 0.1 * getDeltaTime()
        // print('lerptime' + this.lerptime)
        // const currentPosition = vec3.lerp(startPosition, endPosition, t);
        // this.t8Object.getTransform().setLocalPosition(currentPosition);
    }
    displayStroke() {
        const dragpoint = this.dragObject.getTransform().getLocalPosition();
        const startpoint = this.t0Object.getTransform().getLocalPosition();
        const startWorldPoint = this.t0Object.getTransform().getWorldPosition();
        ...
        this.t1Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.15 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.15 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t2Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.25 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.25 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t3Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.35 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.35 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t4Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.45 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.45 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t5Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.55 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.55 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t6Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.65 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.65 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t7Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.75 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.75 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        this.t8Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.85 * dragDistance * Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.85 * dragDistance * Math.sin((launchAngle) * 0.0174533)));
        //this.t9Object.getTransform().setLocalPosition(new vec3(startpoint.x + 0.9*dragDistance*Math.cos((launchAngle) * -0.0174533), 0, startpoint.z + 0.9*dragDistance*Math.sin((launchAngle) * 0.0174533)))
        //
