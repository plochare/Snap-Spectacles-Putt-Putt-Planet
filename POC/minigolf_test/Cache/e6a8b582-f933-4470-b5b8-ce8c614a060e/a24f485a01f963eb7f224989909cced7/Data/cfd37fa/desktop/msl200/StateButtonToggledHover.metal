...
float l9_256=l9_248;
float4 l9_257=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_255,bias(l9_256));
...
float l9_261=0.0;
float l9_262=float((*sc_set0.UserUniforms).iconEnabled!=0);
l9_261=l9_262;
param_52=l9_261;
float param_55;
if ((param_52*1.0)!=0.0)
...
float3x3 l9_276=(*sc_set0.UserUniforms).iconTransform;
...
float4 l9_279=(*sc_set0.UserUniforms).iconUvMinMax;
bool l9_280=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 l9_281=(*sc_set0.UserUniforms).iconBorderColor;
float l9_282=0.0;
...
float l9_352=l9_344;
float4 l9_353=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_351,bias(l9_352));
...
bool l9_363=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_363)
{
...
float l9_368=l9_367;
float l9_369=l9_368;
float l9_370=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_369;
float3 l9_371=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_365.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_377.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_380=l9_379.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_417=l9_409;
float4 l9_418=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_416,bias(l9_417));
...
float3 l9_428=definedBlend(l9_426,l9_427,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_436=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_436=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_438.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
