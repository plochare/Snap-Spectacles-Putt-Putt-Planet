...
vec4 l9_61;
if (l9_60<Port_Position1_N003)
{
l9_61=mix(Port_Value0_N003,Port_Value1_N003,vec4(clamp(l9_60/Port_Position1_N003,0.0,1.0)));
}
else
{
vec4 l9_62;
if (l9_60<Port_Position2_N003)
{
l9_62=mix(Port_Value1_N003,Port_Value2_N003,vec4(clamp((l9_60-Port_Position1_N003)/(Port_Position2_N003-Port_Position1_N003),0.0,1.0)));
}
else
{
vec4 l9_63;
if (l9_60<Port_Position3_N003)
{
l9_63=mix(Port_Value2_N003,Port_Value3_N003,vec4(clamp((l9_60-Port_Position2_N003)/(Port_Position3_N003-Port_Position2_N003),0.0,1.0)));
}
else
{
l9_63=mix(Port_Value3_N003,Port_Value4_N003,vec4(clamp((l9_60-Port_Position3_N003)/(1.0-Port_Position3_N003),0.0,1.0)));
}
l9_62=l9_63;
}
l9_61=l9_62;
...
vec4 l9_68=mix(l9_61,Port_Input1_N024,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
vec2 l9_69=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
float l9_70=l9_69.x;
float l9_71=l9_70;
sc_SoftwareWrapEarly(l9_71,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_72=l9_71;
float l9_73=l9_69.y;
float l9_74=l9_73;
...
{
float l9_96=l9_70;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_97=l9_96;
float l9_98=l9_73;
sc_SoftwareWrapEarly(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_99=l9_98;
vec2 l9_100;
float l9_101;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_102=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_102=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_103=l9_97;
float l9_104=1.0;
sc_ClampUV(l9_103,iconUvMinMax.x,iconUvMinMax.z,l9_102,l9_104);
float l9_105=l9_103;
float l9_106=l9_104;
bool l9_107;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_107=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_107=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_108=l9_99;
float l9_109=l9_106;
sc_ClampUV(l9_108,iconUvMinMax.y,iconUvMinMax.w,l9_107,l9_109);
l9_101=l9_109;
...
#endif
vec2 l9_110=sc_TransformUV(l9_100,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_111=l9_110.x;
float l9_112=l9_101;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_112);
float l9_113=l9_110.y;
float l9_114=l9_112;
sc_SoftwareWrapLate(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_114);
float l9_115=l9_114;
vec3 l9_116=sc_SamplingCoordsViewToGlobal(vec2(l9_111,l9_113),iconLayout,iconGetStereoViewIndex());
vec4 l9_117=texture2D(icon,l9_116.xy,0.0);
vec4 l9_118;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_118=mix(iconBorderColor,l9_117,vec4(l9_115));
}
#else
{
l9_118=l9_117;
...
{
l9_95=Port_Input2_N007;
}
vec4 l9_119=vec4(l9_95);
vec4 l9_120=mix(mix(l9_31,l9_59,vec4(Port_Input2_N005))+l9_68,l9_94,l9_119);
float l9_121=l9_120.w;
...
{
l9_124=clamp(l9_121*2.0,0.0,1.0);
}
#else
{
float l9_125;
...
{
l9_125=clamp(dot(l9_120.xyz,vec3(l9_121)),0.0,1.0);
}
#else
{
float l9_126;
...
{
l9_127=(1.0-dot(l9_120.xyz,vec3(0.33333001)))*l9_121;
}
#else
{
float l9_128;
...
{
l9_128=(1.0-clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0))*l9_121;
}
#else
{
float l9_129;
...
{
l9_129=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0)*l9_121;
}
#else
{
float l9_130;
#if (sc_BlendMode_Add)
{
l9_130=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_131;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_131=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0)*l9_121;
}
#else
{
float l9_132;
...
{
l9_132=dot(l9_120.xyz,vec3(0.33333001))*l9_121;
}
#else
{
float l9_133;
#if (sc_BlendMode_Min)
{
l9_133=1.0-clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_134;
#if (sc_BlendMode_Max)
{
l9_134=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_134=1.0;
...
#endif
l9_122=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_120.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_123);
}
#else
{
vec4 l9_135;
...
#if (sc_FramebufferFetch)
{
vec4 l9_138=sc_readFragData0_Platform();
vec4 l9_139;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_140=l9_138;
l9_140.x=l9_138.x+_sc_framebufferFetchMarker;
l9_139=l9_140;
}
#else
{
...
{
l9_142=1-sc_GetStereoViewIndex();
}
#else
{
l9_142=sc_GetStereoViewIndex();
}
#endif
l9_137=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_141,sc_ScreenTextureLayout,l9_142).xy,0.0);
}
#endif
vec4 l9_143;
...
{
vec4 l9_144=l9_137;
l9_144.x=l9_137.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_143=l9_144;
}
#else
{
...
#endif
vec3 l9_145=mix(l9_143.xyz,definedBlend(l9_143.xyz,l9_120.xyz).xyz,vec3(l9_121));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_147=vec4(mix(vec3(1.0),l9_120.xyz,vec3(l9_121)),l9_121);
}
#else
{
vec4 l9_148;
...
{
l9_152=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_152=vec4(0.0);
...
vec4 l9_154=outputMotionVectorsIfNeeded(varPos,max(l9_153,vec4(0.0)));
vec4 l9_155=clamp(l9_154,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_156=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_156-0.0039215689)),min(1.0,l9_156+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_157).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_158=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_157).xy);
float l9_159=packValue(l9_158);
int l9_166=int(l9_155.w*255.0);
float l9_167=packValue(l9_166);
sc_writeFragData0(vec4(packValue(l9_158),packValue(l9_158),packValue(l9_158),packValue(l9_158)));
sc_writeFragData1(vec4(l9_159,packValue(l9_158),packValue(l9_158),packValue(l9_158)));
sc_writeFragData2(vec4(l9_167,packValue(l9_166),packValue(l9_166),packValue(l9_166)));
...
if (l9_175==0)
{
l9_178=texture2D(sc_OITAlpha0,l9_170);
l9_177=texture2D(sc_OITDepthLow0,l9_170);
l9_176=texture2D(sc_OITDepthHigh0,l9_170);
}
else
{
l9_178=vec4(0.0);
...
if (l9_175==1)
{
l9_181=texture2D(sc_OITAlpha1,l9_170);
l9_180=texture2D(sc_OITDepthLow1,l9_170);
l9_179=texture2D(sc_OITDepthHigh1,l9_170);
}
else
{
l9_181=l9_178;
...
if (any(notEqual(l9_179,vec4(0.0)))||any(notEqual(l9_180,vec4(0.0))))
{
int l9_182[8]=l9_171;
unpackValues(l9_179.w,l9_175,l9_182);
unpackValues(l9_179.z,l9_175,l9_182);
unpackValues(l9_179.y,l9_175,l9_182);
unpackValues(l9_179.x,l9_175,l9_182);
unpackValues(l9_180.w,l9_175,l9_182);
unpackValues(l9_180.z,l9_175,l9_182);
unpackValues(l9_180.y,l9_175,l9_182);
unpackValues(l9_180.x,l9_175,l9_182);
int l9_191[8]=l9_172;
unpackValues(l9_181.w,l9_175,l9_191);
unpackValues(l9_181.z,l9_175,l9_191);
unpackValues(l9_181.y,l9_175,l9_191);
unpackValues(l9_181.x,l9_175,l9_191);
}
l9_175++;
continue;
}
...
vec4 l9_196=texture2D(sc_OITFilteredDepthBoundsTexture,l9_170);
vec2 l9_197=l9_196.xy;
int l9_198;
#if (sc_SkinBonesCount>0)
{
l9_198=encodeDepth(((1.0-l9_196.x)*1000.0)+getDepthOrderingEpsilon(),l9_197);
}
#else
{
l9_198=0;
...
#endif
int l9_199=encodeDepth(viewSpaceDepth(),l9_197);
vec4 l9_200;
l9_200=l9_155*l9_155.w;
vec4 l9_201;
int l9_202=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_202<8)
{
int l9_203=l9_171[l9_202];
int l9_204=l9_199-l9_198;
bool l9_205=l9_203<l9_204;
bool l9_206;
if (l9_205)
{
l9_206=l9_171[l9_202]>0;
}
else
{
l9_206=l9_205;
...
if (l9_206)
{
vec3 l9_207=l9_200.xyz*(1.0-(float(l9_172[l9_202])/255.0));
l9_201=vec4(l9_207.x,l9_207.y,l9_207.z,l9_200.w);
}
else
{
l9_201=l9_200;
