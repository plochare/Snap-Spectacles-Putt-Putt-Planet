...
l9_121=param_6.SurfacePosition_ObjectSpace;
float l9_122=0.0;
l9_122=l9_121.y;
float l9_123=0.0;
l9_123=float(l9_122<(*sc_set0.UserUniforms).Port_Input1_N021);
param_1=l9_123;
...
l9_124=param_6.SurfacePosition_ObjectSpace;
float l9_125=0.0;
l9_125=l9_124.y;
param_2=float4(l9_125);
param_5=param_2;
}
else
{
...
int l9_130=l9_129;
l9_128=(*sc_set0.UserUniforms).sc_ProjectionMatrixInverseArray[l9_130]*l9_127;
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_132=l9_131;
l9_128=(*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_132]*l9_127;
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_134=l9_133;
l9_128=(*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_134]*l9_127;
}
else
{
l9_128=l9_127;
...
float4 l9_135=l9_128;
out.varViewSpaceDepth=-l9_135.z;
}
...
int l9_138=l9_137;
l9_136=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_138]*param_7.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_140=l9_139;
l9_136=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_140]*float4(out.varPos,1.0);
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_142=l9_141;
l9_136=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_142]*float4(out.varPos,1.0);
}
}
}
}
...
{
float4 l9_143=param_7.position;
float4 l9_144=l9_143;
if (sc_RenderingSpace_tmp==1)
{
l9_144=(*sc_set0.UserUniforms).sc_ModelMatrix*l9_143;
}
float4 l9_145=(*sc_set0.UserUniforms).sc_ProjectorMatrix*l9_144;
float2 l9_146=((l9_145.xy/float2(l9_145.w))*0.5)+float2(0.5);
out.varShadowTex=l9_146;
}
float4 l9_147=l9_136;
...
int l9_149=l9_148;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_149][2].w!=0.0)
{
float l9_150=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
l9_147.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+l9_147.w))*l9_150)-1.0)*l9_147.w;
}
}
float4 l9_151=l9_147;
l9_136=l9_151;
float4 l9_152=l9_136;
...
l9_3=l9_2.y;
float l9_4=0.0;
l9_4=float(l9_3<(*sc_set0.UserUniforms).Port_Input1_N040);
param=l9_4;
param=floor(param);
float3 param_4;
if (param==0.0)
...
float3 l9_9=(*sc_set0.UserUniforms).Port_Default_N066;
...
l9_12=l9_11.y;
float l9_13=0.0;
l9_13=float(l9_12<(*sc_set0.UserUniforms).Port_Input1_N043);
l9_6=l9_13;
l9_6=floor(l9_6);
float3 l9_14;
if (l9_6==0.0)
{
float l9_15=0.0;
float3 l9_16=(*sc_set0.UserUniforms).Port_Normal_N014;
float l9_17=(*sc_set0.UserUniforms).Port_Exponent_N014;
float l9_18=(*sc_set0.UserUniforms).Port_Intensity_N014;
...
l9_23=(*sc_set0.UserUniforms).sc_Camera.position;
float l9_24=0.0;
l9_24=distance(l9_22,l9_23);
float l9_25=0.0;
l9_25=l9_24*(*sc_set0.UserUniforms).Port_Input1_N097;
float l9_26=0.0;
float l9_27=l9_25;
float l9_28=(*sc_set0.UserUniforms).Port_RangeMinA_N103;
float l9_29=(*sc_set0.UserUniforms).Port_RangeMaxA_N103;
float l9_30=(*sc_set0.UserUniforms).Port_RangeMinB_N103;
float l9_31=(*sc_set0.UserUniforms).Port_RangeMaxB_N103;
...
l9_26=l9_32;
float l9_34=0.0;
l9_34=(l9_15*(*sc_set0.UserUniforms).Port_Input1_N017)+l9_26;
float l9_35=0.0;
l9_35=1.0-l9_34;
float l9_36=0.0;
l9_36=fast::clamp(l9_35+0.001,(*sc_set0.UserUniforms).Port_Input1_N069+0.001,(*sc_set0.UserUniforms).Port_Input2_N069+0.001)-0.001;
float3 l9_37=float3(0.0);
l9_37=l9_10.SurfacePosition_ObjectSpace;
float l9_38=0.0;
float l9_39=(*sc_set0.UserUniforms).height_gradient;
l9_38=l9_39;
float3 l9_40=float3(0.0);
l9_40.x=(*sc_set0.UserUniforms).Port_Value1_N076;
l9_40.y=l9_38;
l9_40.z=(*sc_set0.UserUniforms).Port_Value3_N076;
float l9_41=0.0;
l9_41=distance(l9_37,l9_40);
float l9_42=0.0;
float l9_43=(*sc_set0.UserUniforms).distance_gradient;
l9_42=l9_43;
float l9_44=0.0;
l9_44=1.0-l9_42;
float l9_45=0.0;
...
float l9_47=l9_45;
float4 l9_48=(*sc_set0.UserUniforms).Port_Value0_N077;
float l9_49=(*sc_set0.UserUniforms).Port_Position1_N077;
float4 l9_50=(*sc_set0.UserUniforms).Port_Value1_N077;
float l9_51=(*sc_set0.UserUniforms).Port_Position2_N077;
float4 l9_52=(*sc_set0.UserUniforms).Port_Value2_N077;
float l9_53=(*sc_set0.UserUniforms).Port_Position3_N077;
float4 l9_54=(*sc_set0.UserUniforms).Port_Value3_N077;
float4 l9_55=(*sc_set0.UserUniforms).Port_Value4_N077;
...
bool l9_57=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_58;
if (l9_57)
{
...
if (l9_58)
{
l9_59=77==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_59=l9_58;
...
float4 l9_61=l9_46;
float l9_62=(*sc_set0.UserUniforms).Port_Amount_N080;
...
l9_65=mix(l9_60,(*sc_set0.UserUniforms).Port_Input1_N002,float4((*sc_set0.UserUniforms).Port_Input2_N002));
...
{
float l9_67=0.0;
float3 l9_68=(*sc_set0.UserUniforms).Port_Normal_N014;
float l9_69=(*sc_set0.UserUniforms).Port_Exponent_N014;
float l9_70=(*sc_set0.UserUniforms).Port_Intensity_N014;
...
l9_75=(*sc_set0.UserUniforms).sc_Camera.position;
float l9_76=0.0;
l9_76=distance(l9_74,l9_75);
float l9_77=0.0;
l9_77=l9_76*(*sc_set0.UserUniforms).Port_Input1_N097;
float l9_78=0.0;
float l9_79=l9_77;
float l9_80=(*sc_set0.UserUniforms).Port_RangeMinA_N103;
float l9_81=(*sc_set0.UserUniforms).Port_RangeMaxA_N103;
float l9_82=(*sc_set0.UserUniforms).Port_RangeMinB_N103;
float l9_83=(*sc_set0.UserUniforms).Port_RangeMaxB_N103;
...
l9_78=l9_84;
float l9_86=0.0;
l9_86=(l9_67*(*sc_set0.UserUniforms).Port_Input1_N017)+l9_78;
float l9_87=0.0;
l9_87=1.0-l9_86;
float l9_88=0.0;
l9_88=fast::clamp(l9_87+0.001,(*sc_set0.UserUniforms).Port_Input1_N069+0.001,(*sc_set0.UserUniforms).Port_Input2_N069+0.001)-0.001;
float3 l9_89=float3(0.0);
l9_89=l9_10.SurfacePosition_ObjectSpace;
float l9_90=0.0;
float l9_91=(*sc_set0.UserUniforms).height_gradient;
l9_90=l9_91;
float3 l9_92=float3(0.0);
l9_92.x=(*sc_set0.UserUniforms).Port_Value1_N076;
l9_92.y=l9_90;
l9_92.z=(*sc_set0.UserUniforms).Port_Value3_N076;
float l9_93=0.0;
l9_93=distance(l9_89,l9_92);
float l9_94=0.0;
float l9_95=(*sc_set0.UserUniforms).distance_gradient;
l9_94=l9_95;
float l9_96=0.0;
l9_96=1.0-l9_94;
float l9_97=0.0;
...
float l9_99=l9_97;
float4 l9_100=(*sc_set0.UserUniforms).Port_Value0_N077;
float l9_101=(*sc_set0.UserUniforms).Port_Position1_N077;
float4 l9_102=(*sc_set0.UserUniforms).Port_Value1_N077;
float l9_103=(*sc_set0.UserUniforms).Port_Position2_N077;
float4 l9_104=(*sc_set0.UserUniforms).Port_Value2_N077;
float l9_105=(*sc_set0.UserUniforms).Port_Position3_N077;
float4 l9_106=(*sc_set0.UserUniforms).Port_Value3_N077;
float4 l9_107=(*sc_set0.UserUniforms).Port_Value4_N077;
...
bool l9_109=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_110;
if (l9_109)
{
...
if (l9_110)
{
l9_111=77==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_111=l9_110;
...
float4 l9_113=l9_98;
float l9_114=(*sc_set0.UserUniforms).Port_Amount_N080;
...
l9_117=mix(l9_112,(*sc_set0.UserUniforms).Port_Input1_N002,float4((*sc_set0.UserUniforms).Port_Input2_N002));
...
l9_120=l9_119.y;
float l9_121=0.0;
l9_121=floor(l9_120*(*sc_set0.UserUniforms).Port_Input1_N070)/(*sc_set0.UserUniforms).Port_Input1_N070;
float l9_122=0.0;
float l9_123;
if (l9_121<=0.0)
{
...
{
l9_123=pow(l9_121,(*sc_set0.UserUniforms).Port_Input1_N071);
}
l9_122=l9_123;
float4 l9_124=float4(0.0);
float l9_125=l9_122;
float4 l9_126=(*sc_set0.UserUniforms).Port_Value0_N068;
float l9_127=(*sc_set0.UserUniforms).Port_Position1_N068;
float4 l9_128=(*sc_set0.UserUniforms).Port_Value1_N068;
float4 l9_129=(*sc_set0.UserUniforms).Port_Value2_N068;
...
bool l9_131=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_132;
if (l9_131)
{
...
if (l9_132)
{
l9_133=68==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_133=l9_132;
...
l9_134=l9_124*float4((*sc_set0.UserUniforms).Port_Input1_N072);
...
float l9_142=l9_141;
float l9_143=l9_142;
float l9_144=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_143;
float3 l9_145=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_139.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_151.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_154=l9_153.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_191=l9_183;
float4 l9_192=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_190,bias(l9_191));
...
float3 l9_202=definedBlend(l9_200,l9_201,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_210=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_210=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_212.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
