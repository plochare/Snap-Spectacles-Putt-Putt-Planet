...
float l9_7=0.0;
float l9_8=(*sc_set0.UserUniforms).status;
l9_7=l9_8;
param=l9_7;
float4 param_3;
if ((param*1.0)!=0.0)
...
l9_10=l9_12;
float l9_13=0.0;
l9_13=l9_10*(*sc_set0.UserUniforms).Port_Input1_N049;
float l9_14=0.0;
float l9_15=(*sc_set0.UserUniforms).offset;
l9_14=l9_15;
float l9_16=0.0;
float l9_17=(*sc_set0.UserUniforms).size;
l9_16=l9_17;
float l9_18=0.0;
l9_18=(((l9_16-(*sc_set0.UserUniforms).Port_RangeMinA_N050)/((*sc_set0.UserUniforms).Port_RangeMaxA_N050-(*sc_set0.UserUniforms).Port_RangeMinA_N050))*((*sc_set0.UserUniforms).Port_RangeMaxB_N050-(*sc_set0.UserUniforms).Port_RangeMinB_N050))+(*sc_set0.UserUniforms).Port_RangeMinB_N050;
float l9_19=0.0;
l9_19=(((l9_16-(*sc_set0.UserUniforms).Port_RangeMinA_N048)/((*sc_set0.UserUniforms).Port_RangeMaxA_N048-(*sc_set0.UserUniforms).Port_RangeMinA_N048))*((*sc_set0.UserUniforms).Port_RangeMaxB_N048-(*sc_set0.UserUniforms).Port_RangeMinB_N048))+(*sc_set0.UserUniforms).Port_RangeMinB_N048;
float l9_20=0.0;
l9_20=(((l9_14-(*sc_set0.UserUniforms).Port_RangeMinA_N035)/((*sc_set0.UserUniforms).Port_RangeMaxA_N035-(*sc_set0.UserUniforms).Port_RangeMinA_N035))*(l9_19-l9_18))+l9_18;
float2 l9_21=float2(0.0);
l9_21.x=l9_20;
l9_21.y=(*sc_set0.UserUniforms).Port_Value2_N034;
float2 l9_22=float2(0.0);
l9_22=float2(l9_13)+l9_21;
float l9_23=0.0;
float l9_24=(*sc_set0.UserUniforms).scale;
l9_23=l9_24;
float l9_25=0.0;
l9_25=(((l9_23-(*sc_set0.UserUniforms).Port_RangeMinA_N046)/((*sc_set0.UserUniforms).Port_RangeMaxA_N046-(*sc_set0.UserUniforms).Port_RangeMinA_N046))*((*sc_set0.UserUniforms).Port_RangeMaxB_N046-(*sc_set0.UserUniforms).Port_RangeMinB_N046))+(*sc_set0.UserUniforms).Port_RangeMinB_N046;
float2 l9_26=float2(0.0);
l9_26=((l9_22-(*sc_set0.UserUniforms).Port_Center_N039)*float2(l9_25))+(*sc_set0.UserUniforms).Port_Center_N039;
float4 l9_27=float4(0.0);
float l9_28=l9_26.x;
float4 l9_29=(*sc_set0.UserUniforms).Port_Value0_N040;
float l9_30=(*sc_set0.UserUniforms).Port_Position1_N040;
float4 l9_31=(*sc_set0.UserUniforms).Port_Value1_N040;
float l9_32=(*sc_set0.UserUniforms).Port_Position2_N040;
float4 l9_33=(*sc_set0.UserUniforms).Port_Value2_N040;
float l9_34=(*sc_set0.UserUniforms).Port_Position3_N040;
float4 l9_35=(*sc_set0.UserUniforms).Port_Value3_N040;
float l9_36=(*sc_set0.UserUniforms).Port_Position4_N040;
float4 l9_37=(*sc_set0.UserUniforms).Port_Value4_N040;
float l9_38=(*sc_set0.UserUniforms).Port_Position5_N040;
float4 l9_39=(*sc_set0.UserUniforms).Port_Value5_N040;
float4 l9_40=(*sc_set0.UserUniforms).Port_Value6_N040;
...
if (l9_43)
{
l9_44=40==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_44=l9_43;
...
l9_45=(*sc_set0.UserUniforms).Port_Value_N005;
param_2=l9_45;
param_3=param_2;
}
Output_N3=param_3;
...
bool l9_49=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_49)
{
...
float l9_54=l9_53;
float l9_55=l9_54;
float l9_56=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_55;
float3 l9_57=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_51.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_63.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_64=l9_63;
l9_61=l9_64;
}
...
float2 l9_66=l9_65.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_67=l9_66;
...
float l9_103=l9_95;
float4 l9_104=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_102,bias(l9_103));
...
float3 l9_114=definedBlend(l9_112,l9_113,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_122=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_122=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_124.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
