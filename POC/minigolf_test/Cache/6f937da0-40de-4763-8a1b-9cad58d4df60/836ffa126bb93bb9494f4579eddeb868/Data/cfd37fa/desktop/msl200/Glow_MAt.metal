...
//}
//ubo int UserUniforms 0:24:4224 {
...
//spec_const int SC_DEVICE_CLASS 65
...
constant int SC_DEVICE_CLASS [[function_constant(65)]];
...
param_1*=(param_2*0.5);
float2 l9_121=param_1;
float param_3=(snoise(l9_121)*0.5)+0.5;
param_3=floor(param_3*10000.0)*9.9999997e-05;
Noise_N13=param_3;
float ValueOut_N15=0.0;
ValueOut_N15=(((Noise_N13-(*sc_set0.UserUniforms).Port_RangeMinA_N015)/((*sc_set0.UserUniforms).Port_RangeMaxA_N015-(*sc_set0.UserUniforms).Port_RangeMinA_N015))*((*sc_set0.UserUniforms).Port_RangeMaxB_N015-(*sc_set0.UserUniforms).Port_RangeMinB_N015))+(*sc_set0.UserUniforms).Port_RangeMinB_N015;
...
ValueOut_N35=((((*sc_set0.UserUniforms).Port_ValueIn_N035-float4((*sc_set0.UserUniforms).Port_RangeMinA_N035))/float4((*sc_set0.UserUniforms).Port_RangeMaxA_N035-(*sc_set0.UserUniforms).Port_RangeMinA_N035))*(Output_N17-Output_N20))+float4(Output_N20);
...
int l9_134=l9_133;
l9_132=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_134]*param_5.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_139=param_5.position;
...
bool l9_2=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_3;
if (l9_2)
{
...
if (l9_3)
{
l9_4=5==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_4=l9_3;
...
float l9_11=l9_10;
float l9_12=l9_11;
float l9_13=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_12;
float3 l9_14=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_8.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_20.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_21=l9_20;
l9_18=l9_21;
}
...
float2 l9_23=l9_22.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_24=l9_23;
...
float l9_60=l9_52;
float4 l9_61=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_59,bias(l9_60));
float4 l9_62=l9_61;
l9_48=l9_62;
float4 l9_63=l9_48;
float4 l9_64=l9_63;
...
{
l9_79=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_79=float4(0.0);
