...
#endif
float l9_3=l9_1.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x);
float l9_4=l9_3;
float l9_5=l9_1.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,glow_mapUvMinMax.x,glow_mapUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,glow_mapUvMinMax.y,glow_mapUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0)),l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0)),l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),glow_mapLayout,l9_2);
vec4 l9_24=texture2D(glow_map,l9_23.xy,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_25=mix(glow_mapBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
#endif
float l9_26=clamp(l9_25.x,0.0,1.0);
vec4 l9_27;
if (l9_26<Port_Position1_N005)
{
l9_27=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_26/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_28;
if (l9_26<Port_Position2_N005)
{
l9_28=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_26-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_28=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_26-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_27=l9_28;
}
bool l9_29=PreviewEnabled==1;
bool l9_30;
if (l9_29)
{
l9_30=!l9_0;
...
if (l9_27.x<float(l9_27.x<Port_Input1_N003))
{
discard;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_27.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_27.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_35=clamp(l9_27.w*2.0,0.0,1.0);
}
#else
{
float l9_36;
...
{
l9_36=clamp(dot(l9_27.xyz,vec3(l9_27.w)),0.0,1.0);
}
#else
{
float l9_37;
...
{
l9_38=(1.0-dot(l9_27.xyz,vec3(0.33333001)))*l9_27.w;
}
#else
{
float l9_39;
...
{
l9_39=(1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0))*l9_27.w;
}
#else
{
float l9_40;
...
{
l9_40=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*l9_27.w;
}
#else
{
float l9_41;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_42=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*l9_27.w;
}
#else
{
float l9_43;
...
{
l9_43=dot(l9_27.xyz,vec3(0.33333001))*l9_27.w;
}
#else
{
float l9_44;
#if (sc_BlendMode_Min)
{
l9_44=1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_45;
#if (sc_BlendMode_Max)
{
l9_45=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_45=1.0;
...
#endif
l9_33=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_27.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_34);
}
#else
{
vec4 l9_46;
...
#endif
l9_48=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_52,sc_ScreenTextureLayout,l9_53).xy,0.0);
}
#endif
vec4 l9_54;
...
#endif
vec3 l9_56=mix(l9_54.xyz,definedBlend(l9_54.xyz,l9_27.xyz).xyz,vec3(l9_27.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_58=vec4(mix(vec3(1.0),l9_27.xyz,vec3(l9_27.w)),l9_27.w);
}
#else
{
vec4 l9_59;
...
#endif
l9_59=vec4(l9_27.xyz*l9_60,l9_60);
}
#else
{
l9_59=l9_27;
