...
#endif
float l9_23=l9_16.x;
sc_SoftwareWrapEarly(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_24=l9_23;
float l9_25=l9_16.y;
sc_SoftwareWrapEarly(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_26=l9_25;
vec2 l9_27;
float l9_28;
...
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_30=l9_24;
float l9_31=1.0;
sc_ClampUV(l9_30,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_29,l9_31);
float l9_32=l9_30;
float l9_33=l9_31;
bool l9_34;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_35=l9_26;
float l9_36=l9_33;
sc_ClampUV(l9_35,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_34,l9_36);
l9_28=l9_36;
...
#endif
vec2 l9_37=sc_TransformUV(l9_27,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_38=l9_37.x;
float l9_39=l9_28;
sc_SoftwareWrapLate(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_39);
float l9_40=l9_37.y;
float l9_41=l9_39;
sc_SoftwareWrapLate(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_41);
float l9_42=l9_41;
vec3 l9_43=sc_SamplingCoordsViewToGlobal(vec2(l9_38,l9_40),opacityTexLayout,l9_22);
vec4 l9_44=texture2D(opacityTex,l9_43.xy,0.0);
vec4 l9_45;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_45=mix(opacityTexBorderColor,l9_44,vec4(l9_42));
}
#else
{
l9_45=l9_44;
...
#else
{
l9_46=Port_Input2_N072;
}
#endif
float l9_47=(l9_13*l9_14).w*l9_15;
float l9_48=l9_47*l9_46;
vec3 l9_49;
#if (ENABLE_NORMALMAP)
{
vec2 l9_50;
...
{
vec2 l9_53;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_53,l9_9);
l9_52=l9_53;
}
#else
{
...
{
vec2 l9_55;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_55,l9_9);
l9_54=l9_55;
}
#else
{
...
#endif
float l9_57=l9_50.x;
sc_SoftwareWrapEarly(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_58=l9_57;
float l9_59=l9_50.y;
sc_SoftwareWrapEarly(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_60=l9_59;
vec2 l9_61;
float l9_62;
...
{
l9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_63=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_64=l9_58;
float l9_65=1.0;
sc_ClampUV(l9_64,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_63,l9_65);
float l9_66=l9_64;
float l9_67=l9_65;
bool l9_68;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_68=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
...
float l9_69=l9_60;
float l9_70=l9_67;
sc_ClampUV(l9_69,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_68,l9_70);
l9_62=l9_70;
...
#endif
vec2 l9_71=sc_TransformUV(l9_61,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_72=l9_71.x;
float l9_73=l9_62;
sc_SoftwareWrapLate(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_73);
float l9_74=l9_71.y;
float l9_75=l9_73;
sc_SoftwareWrapLate(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_75);
float l9_76=l9_75;
vec3 l9_77=sc_SamplingCoordsViewToGlobal(vec2(l9_72,l9_74),normalTexLayout,l9_56);
vec4 l9_78=texture2D(normalTex,l9_77.xy,0.0);
vec4 l9_79;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_79=mix(normalTexBorderColor,l9_78,vec4(l9_76));
}
#else
{
l9_79=l9_78;
...
{
vec2 l9_84;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_84,l9_9);
l9_83=l9_84;
}
#else
{
...
{
vec2 l9_86;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_86,l9_9);
l9_85=l9_86;
}
#else
{
l9_85=varPackedTex.xy;
}
#endif
l9_83=l9_85;
}
...
float l9_104=l9_93;
sc_SoftwareWrapLate(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_104);
float l9_105=l9_102.y;
float l9_106=l9_104;
sc_SoftwareWrapLate(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_106);
float l9_107=l9_106;
vec3 l9_108=sc_SamplingCoordsViewToGlobal(vec2(l9_103,l9_105),detailNormalTexLayout,l9_87);
...
#endif
l9_80=((l9_110.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_80=Port_Default_N113;
}
#endif
vec3 l9_111=mix(vec3(0.0,0.0,1.0),((l9_79.xyz*1.9921875)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
vec3 l9_112=mix(vec3(0.0,0.0,1.0),l9_80,vec3(Port_Strength2_N200));
vec3 l9_113=l9_112*vec3(-1.0,-1.0,1.0);
vec3 l9_114=mat3(l9_6,l9_8,l9_7)*normalize((l9_111*dot(l9_111,l9_113))-(l9_113*l9_111.z));
...
#endif
float l9_120=clamp(l9_48,0.0,1.0);
...
#endif
vec3 l9_121=max(l9_10.xyz,vec3(0.0));
vec4 l9_122;
#if (sc_ProjectiveShadowsCaster)
{
...
SurfaceProperties l9_128=SurfaceProperties(l9_127,l9_120,l9_124,varPos,l9_3,0.0,1.0,l9_125,l9_126,vec3(1.0),vec3(1.0),vec3(0.039999999));
...
{
LightingComponents l9_149=accumulateLight(LightingComponents(l9_137,l9_138,l9_143,l9_141,l9_140,l9_139),LightProperties(sc_DirectionalLights[l9_148].direction,sc_DirectionalLights[l9_148].color.xyz,sc_DirectionalLights[l9_148].color.w*l9_129[(l9_142<3) ? l9_142 : 3]),l9_128,l9_3);
...
l9_159=l9_167+1;
LightingComponents l9_174=accumulateLight(LightingComponents(l9_153,l9_154,l9_158,l9_157,l9_156,l9_155),LightProperties(l9_169,sc_PointLights[l9_166].color.xyz,l9_173),l9_128,l9_3);
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_269-0.0039215689)),min(1.0,l9_269+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_270=sc_ScreenCoordsGlobalToView(l9_4);
...
sc_writeFragData0(vec4(packValue(l9_271),packValue(l9_271),packValue(l9_271),packValue(l9_271)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_283=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
