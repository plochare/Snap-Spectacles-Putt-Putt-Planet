...
vec4 l9_27;
if (l9_26<Port_Position1_N007)
{
l9_27=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_26/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_28;
if (l9_26<Port_Position2_N007)
{
l9_28=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_26-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_28=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_26-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_27=l9_28;
}
