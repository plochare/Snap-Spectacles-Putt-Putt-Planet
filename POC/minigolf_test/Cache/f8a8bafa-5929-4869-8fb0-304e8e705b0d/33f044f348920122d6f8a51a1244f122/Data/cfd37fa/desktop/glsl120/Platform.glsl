...
float l9_23=l9_22.x;
float l9_24=l9_13;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_24);
float l9_25=l9_22.y;
float l9_26=l9_24;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_26);
float l9_27=l9_26;
vec3 l9_28=sc_SamplingCoordsViewToGlobal(vec2(l9_23,l9_25),planet_refl_mapLayout,l9_7);
vec4 l9_29=texture2D(planet_refl_map,l9_28.xy,0.0);
vec4 l9_30;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
...
#endif
vec4 l9_31=vec4(reflIntensity)*l9_30;
float l9_32=radians(Port_Rotation_N003);
float l9_33=clamp((vec2(dot(vec2(cos(l9_32),sin(l9_32)),varPackedTex.zw-Port_Center_N003),0.0)+Port_Center_N003).x,0.0,1.0);
vec4 l9_34;
if (l9_33<colorRatio)
{
l9_34=mix(Tweak_N2,Tweak_N8,vec4(clamp(l9_33/colorRatio,0.0,1.0)));
}
else
{
l9_34=mix(Tweak_N8,Tweak_N9,vec4(clamp((l9_33-colorRatio)/(1.0-colorRatio),0.0,1.0)));
}
...
float l9_56=l9_55.x;
float l9_57=l9_46;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_57);
float l9_58=l9_55.y;
float l9_59=l9_57;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_59);
float l9_60=l9_59;
vec3 l9_61=sc_SamplingCoordsViewToGlobal(vec2(l9_56,l9_58),Tweak_N6Layout,l9_40);
vec4 l9_62=texture2D(Tweak_N6,l9_61.xy,0.0);
vec4 l9_63;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
...
#endif
vec3 l9_64=l9_39.xyz;
vec3 l9_65=mix(l9_64,(l9_63.xyz*l9_64).xyz,vec3(l9_63.w));
float l9_66=l9_39.w;
vec4 l9_67=vec4(l9_65.x,l9_65.y,l9_65.z,vec4(0.0).w);
l9_67.w=l9_66;
...
{
l9_71=clamp(dot(l9_67.xyz,vec3(l9_66)),0.0,1.0);
}
#else
{
float l9_72;
...
{
l9_73=(1.0-dot(l9_67.xyz,vec3(0.33333001)))*l9_66;
}
#else
{
float l9_74;
...
{
l9_74=(1.0-clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0))*l9_66;
}
#else
{
float l9_75;
...
{
l9_75=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0)*l9_66;
}
#else
{
float l9_76;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_77=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0)*l9_66;
}
#else
{
float l9_78;
...
{
l9_78=dot(l9_67.xyz,vec3(0.33333001))*l9_66;
}
#else
{
float l9_79;
...
#endif
vec3 l9_91=mix(l9_89.xyz,definedBlend(l9_89.xyz,l9_67.xyz).xyz,vec3(l9_66));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_93=vec4(mix(vec3(1.0),l9_67.xyz,vec3(l9_66)),l9_66);
}
#else
{
vec4 l9_94;
